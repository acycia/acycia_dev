...
<tr><td id="nombreusuario"><?php echo $row_usuario['nombre_usuario']; ?></td>
  ...
  <tr>
	...
	<!--<tr>
	  <td colspan="12" id="titulo2" nowrap>DESDE
	    ...
	    HASTA
	    <input name="fecha_fin" type="date" id="fecha_fin" required="required" min="2000-01-02" size="10" onchange="if(form1.fecha_ini.value && form1.fecha_fin.value) { consulta_mano_obra(); }else { alert('Debe seleccionar las dos fechas')}" value="<?php echo $_GET['fecha_fin']; ?>"/> <?php  for ($x=0;$x<=$totalRows_lista_procesos-1;$x++) { ?>          
        </td>
	  </tr>-->
	<tr>
	  <td colspan="10" id="titulo2">&nbsp;</td>
  ...
  <td colspan="6" id="fuente3"><a href="proceso_empleados_listado.php"> <img src="images/mas.gif" alt="ADD EMPLEADO" title="ADD EMPLEADO" border="0" style="cursor:hand;" /></a><a href="javascript:location.reload()"><img src="images/ciclo1.gif" alt="CARGAR LISTADO" title="CARGAR LISTADO" border="0" style="cursor:hand;"/>
