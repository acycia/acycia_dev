...
mysql_select_db($database_conexion1, $conexion1);
$query_ver_sub_menu = sprintf("SELECT * FROM submenu WHERE id_menu_submenu = '3'", $colname_ver_sub_menu);
        ...
        <div class="row">
         ...
         <div class="row">
           <div class="col-md-4">
            ...
            <div class="col-md-4">
                <strong>GESTION DE COMPRAS</strong><br><br>
                <strong>Objetivo: </strong> Garantizar que los requisitos de compras de los productos que afectan la prestacion del servicio y los otros necesarios para el S.G.C. pedidos a proveedores calificados cumplan con los requisitos establecidos.<br><br><strong>Alcance: </strong>Cubre desde la planificacion de los requisitos de compra de los productos que afectan la produccion y prestacion del servicio y los otros necesarios para el S.G.C, la seleccion, evaluacion y seguimiento de los proveedores, la recepcion del producto, su almacenamiento y preservacion.<br><br> 
            </div>
             <div class="col-md-4">
                <strong>Responsable: </strong>Director de Compras - Almacenista - Coordinador de Calidad.<br><br><strong>Participantes: </strong>Gerente de Unidad de Bolsas, Coordinador de Calidad, almacenista y supervisor de produccion.          
                </div>            
             </div>
