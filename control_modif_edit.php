...
$sql2="UPDATE verificacion SET version_ref_verif='$version_ref_verif' WHERE id_verif='$id_verif'";
  $updateSQL = sprintf("UPDATE control_modificaciones SET id_verif_cm=%s, id_ref_cm=%s, fecha_cm=%s, responsable_cm=%s, descripcion_cm=%s, fecha_edit_cm=%s, responsable_edit_cm=%s WHERE id_cm=%s",
  ...
  $updateGoTo = "verificacion_referencia.php?id_ref=" . $_POST['id_ref_cm'] . "&id_verif=" . $_POST['id_verif_cm'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion1, $conexion1);
$query_modificacion_edit = sprintf("SELECT * FROM control_modificaciones WHERE id_cm = %s", $colname_modificacion_edit);
...
mysql_select_db($database_conexion1, $conexion1);
$query_verif_modif = sprintf("SELECT * FROM control_modificaciones, verificacion, Tbl_referencia WHERE control_modificaciones.id_cm = %s AND control_modificaciones.id_verif_cm = verificacion.id_verif AND verificacion.id_ref_verif=Tbl_referencia.id_ref", $colname_verif_modif);
  ...
  <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
    <table id="tabla2">
      ...
      <tr>
        ...
        <td id="dato2"><a href="javascript:eliminar2('id_cm',<?php echo $row_modificacion_edit['id_cm']; ?>,'control_modif_edit.php','id_ref_cm',<?php echo $row_modificacion_edit['id_ref_cm']; ?>)"><img src="images/por.gif" alt="ELIMINAR" title="ELIMINAR" border="0" style="cursor:hand;" ></a><a href="control_modificaciones.php"><img src="images/m.gif" alt="CONTROL MODIFICACIONES" title="CONTROL MODIFICACIONES"border="0" style="cursor:hand;" /></a><a href="verificacion_referencia.php?id_ref=<?php echo $row_verif_modif['id_ref_verif']; ?>"><img src="images/v.gif" alt="VERIFICACION X REF" title="VERIFICACION X REF" border="0" style="cursor:hand;" /></a><a href="verificacion.php"><img src="images/identico.gif" alt="LISTADO DE VERIFICACIONES" title="LISTADO DE VERIFICACIONES" border="0" style="cursor:hand;" /></a></td>
      </tr>
      <tr id="tr1">
      ...
      <tr>
        <td id="dato2"><input name="id_verif_cm" type="hidden" value="<?php echo $row_modificacion_edit['id_verif_cm']; ?>">
          <a href="verificacion_edit.php?id_verif=<?php echo $row_verif_modif['id_verif_cm']; ?>"><?php echo $row_modificacion_edit['id_verif_cm']; ?></a></td>
      ...
      <tr>
        <td id="numero2"><strong>VERSION C.M.</strong><input name="version_ref_verif" type="text" id="version_ref_verif" value="<?php echo $row_verif_modif['version_ref_verif']; ?>" size="2"></td>
        <td id="acceso2">VERSION REF
          <input name="version_ref" type="text" id="version_ref" value="<?php echo $row_verif_modif['version_ref']; ?>" size="2"></td>
        </tr>
      <tr id="tr1">
