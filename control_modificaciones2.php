...
mysql_select_db($database_conexion1, $conexion1);
$query_control_modificaciones = "SELECT * FROM control_modificaciones ORDER BY id_cm DESC";
...
mysql_select_db($database_conexion1, $conexion1);
$query_verificacion = "SELECT * FROM verificacion ORDER BY id_verif DESC";
...
{
$query_modificaciones = "SELECT * FROM control_modificaciones ORDER BY id_cm DESC";
}
//Filtra cm lleno
if($id_cm != '0' && $id_verif == '0' && $id_ref == '0' && $fecha == '0')
{
$query_modificaciones = "SELECT * FROM control_modificaciones WHERE id_cm='$id_cm' ORDER BY id_cm DESC";
}
//Filtra verificacion lleno
if($id_cm == '0' && $id_verif != '0' && $id_ref == '0' && $fecha == '0')
{
$query_modificaciones = "SELECT * FROM control_modificaciones WHERE id_verif_cm='$id_verif' ORDER BY id_cm DESC";
}
//Filtra referencia lleno
if($id_cm == '0' && $id_verif == '0' && $id_ref != '0' && $fecha == '0')
{
$query_modificaciones = "SELECT * FROM control_modificaciones WHERE id_ref_cm='$id_ref' ORDER BY id_cm DESC";
}
//Filtra fecha lleno
if($id_cm == '0' && $id_verif == '0' && $id_ref == '0' && $fecha != '0')
{
...
$fecha2 = $fecha + 1;
$fecha2 = "$fecha2-01-01";
$query_modificaciones = "SELECT * FROM control_modificaciones WHERE fecha_cm >= '$fecha1' and fecha_cm < '$fecha2' ORDER BY id_cm DESC";
}
...
<?php echo $conexion->header('listas'); ?>
	<form action="control_modificaciones2.php" method="get" name="consulta">
...
?>
      ...
      <input type="submit" name="Submit" value="FILTRO" onClick="if(consulta.n_cotiz.value=='0' && consulta.id_c.value=='0' && consulta.fecha.value=='0') { alert('DEBE SELECCIONAR UNA OPCION'); }"/>    
      </td>
  </tr>
</table>
</form>
...
<table class="table table-bordered table-sm">
  <tr>
    <td colspan="2" id="dato1"><input name="borrado" type="hidden" id="borrado" value="6" />
  ...
  if($id == '0') { ?><div id="numero1"> <?php echo "SELECCIONE UN REGISTRO"; ?> </div> <?php }?></td>
    <td colspan="2" id="dato3"><a href="control_modificaciones.php"><img src="images/ciclo1.gif" alt="RESTAURAR" title="RESTAURAR" border="0" style="cursor:hand;"/></a><a href="referencias.php"><img src="images/a.gif" alt="REF'S ACTIVAS" title="REF'S ACTIVAS" border="0" style="cursor:hand;"/></a><a href="referencias_inactivas.php"><img src="images/i.gif" alt="REF'S INACTIVAS" title="REF'S INACTIVAS" border="0" style="cursor:hand;"/></a><a href="revision.php"><img src="images/r.gif" alt="REVISIONES" title="REVISIONES" border="0" style="cursor:hand;" /></a><a href="validacion.php"><img src="images/v.gif" alt="VALIDACIONES" title="VALIDACIONES" border="0" style="cursor:hand;" /></a><a href="ficha_tecnica.php"><img src="images/f.gif" alt="FICHAS TECNICAS" title="FICHAS TECNICAS" border="0" style="cursor:hand;" /></a></td>
    </tr>  
  <tr id="tr1">
  ...
  <?php do { ?>
    <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
      ...
      <td id="dato3"><a href="control_modif_edit.php?id_cm=<?php echo $row_modificaciones['id_cm']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_modificaciones['id_cm']; ?></a></td>
      <td id="dato3"><a href="verificacion_vista.php?id_verif=<?php echo $row_modificaciones['id_verif_cm']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_modificaciones['id_verif_cm']; ?></a></td>
	  ...
	  } ?><a href="referencia_bolsa_vista.php?id_ref=<?php echo $row_modificaciones['id_ref_cm']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $cod_ref; ?></a></td>
      <td id="dato2"><a href="referencia_bolsa_vista.php?id_ref=<?php echo $row_modificaciones['id_ref_cm']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $version_ref; ?></a></td>
      <td id="dato2"><a href="control_modif_edit.php?id_cm=<?php echo $row_modificaciones['id_cm']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_modificaciones['fecha_cm']; ?></a></td>
      <td id="dato1"><a href="control_modif_edit.php?id_cm=<?php echo $row_modificaciones['id_cm']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php $cad=htmlentities ($row_modificaciones['responsable_cm']);echo $cad; ?></a></td>
      <td id="dato2"><a href="control_modif_edit.php?id_cm=<?php echo $row_modificaciones['id_cm']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_modificaciones['fecha_edit_cm']; ?></a></td>
      <td id="dato2"><a href="control_modif_edit.php?id_cm=<?php echo $row_modificaciones['id_cm']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php $cad2=htmlentities ($row_modificaciones['responsable_edit_cm']);echo $cad2; ?></a></td>
      </tr>
