    ...
    <div id="cabecera_formato"><div class="menu_formato"><ul>  
     ...
     <form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1" onSubmit="MM_validateForm('fecha_ingreso_c','','R','fecha_solicitud_c','','R','nombre_c','','R','nit_c','','R','tipo_c','','R','rep_legal_c','','R','telefono_c','','R','direccion_c','','R','pais_c','','R','registrado_c','','R');return document.MM_returnValue">
       <table width="114%" id="tabla_formato2" >
         ...
         <tr>
           <td id="dato_1"><input name="fecha_ingreso_c" type="text" value="<?php echo date("Y/m/d"); ?>" size="10" readonly></td>
           <td id="dato_1">&nbsp;</td>
         ...
         <tr>
           <td id="dato_1">
<input type="text" name="nit_c" value="*" size="30" onBlur="if (form1.nit_c.value) { DatosGestiones('1','nit_c',form1.nit_c.value); } else { alert('Debe digitar el NIT para validar su existencia en la BD'); }" onClick="desapareceClick(this);this.value = ''"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
         ...
         <tr>
           <td id="dato_1">&nbsp;</td>
           <td id="dato_1"><input name="nombre_c" type="text"onKeyUp="conMayusculas(this)" onClick="desapareceClick(this);this.value = ''"value="*" size="30" maxlength="100"autocomplete='off'>		   </td>
           <td id="dato_1"><select name="tipo_c"onClick="ocultarCampo(this)">
             <option value="">*</option>
         ...
         <tr>
           <td colspan="1" id="dato_1"><input name="rep_legal_c" type="text"onKeyUp="conMayusculas(this)" value="" size="50" maxlength="100"autocomplete='off'></td>
...
/*	 //CONSULTA PAIS      	
    ...
    ?>
         ...
         <tr>
           <td id="dato_1"><input name="direccion_c" type="text"onKeyUp="conMayusculas(this)" value="" size="50" maxlength="150"autocomplete='off'></td>
...
/*	 //CONSULTA CIUDADES     	
    ...
    ?>
         ...
         <tr>
           <td id="dato_1"><input id="email"type="text" name="email_comercial_c" value="" size="50"onKeyUp="conMayusculas(this)"onblur="MM_validateForm('email_comercial_c','','NisEmail');return document.MM_returnValue"autocomplete='off'></td>
           ...
           <td colspan="2" id="dato_1"><input name="ciudadexterno"type="text"size="48"value="" id="ciudadexterno" onKeyUp="conMayusculas(this)"onClick="this.value = ''"autocomplete='off'/></td>
         </tr>
         <tr>
           <td id="dato_1">&nbsp;</td>
         ...
         <tr>
           <td colspan="1" id="dato_1"><input name="contacto_c" type="text"onKeyUp="conMayusculas(this)" value="" size="50" maxlength="100"autocomplete='off'></td>
           <td id="dato_1"><input type="text" name="cargo_contacto_c" value="" size="30"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
           <td colspan="2" id="dato_1"><input type="text" name="email_contacto_bodega_c" value="" size="48"onKeyUp="conMayusculas(this)"onblur="MM_validateForm('email_contacto_bodega_c','','NisEmail');return document.MM_returnValue"autocomplete='off'></td>
         </tr>
         <tr>
         ...
         <tr>
           <td id="dato_1"><input name="direccion_envio_factura_c" type="text"onKeyUp="conMayusculas(this)" value="" size="50" maxlength="100"autocomplete='off'></td>
           <td id="detalle_1"><input type="text" name="indicativo3"value= ""id="indicativo3" size="1"onKeyUp="return ValNumero(this)"onClick="this.value = ''">
             <input type="text" name="telefono_envio_factura_c" value="" size="10"onKeyUp="return ValNumero(this)"autocomplete='off'>
           ...
           <td id="detalle_1"><input type="text" name="indicativo12"value= ""id="indicativo12" size="1"onKeyUp="return ValNumero(this)"onClick="this.value = ''">
             <input type="text" name="fax_envio_factura_c" value="" size="20"onKeyUp="return ValNumero(this)"autocomplete='off'>
         ...
         <tr>
           <td id="dato_1"><input type="text" name="celular_contacto_c" value="" size="50"onKeyUp="return ValNumero(this)"autocomplete='off'></td>
           <td id="dato_1">&nbsp;</td>
         ...
         <tr>
           <td colspan="4" id="detalle_1"><textarea name="observ_inf_c" cols="100" rows="2"onKeyUp="conMayusculas(this)"></textarea></td>
         </tr>
...
<td width="241" id="dato_1">RESPONSABLE</td>
...
<td width="244"id="dato_1">CIUDAD</td>
  ...
  <tr>
    <td height="5" colspan="7" id="subtitulo1"><fieldset id="field"></fieldset> </td>
         ...
         <tr>
           <td id="dato_1"><input type="text" name="contacto_dpto_pagos_c" value="" size="50"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
           ...
           <td colspan="2" id="dato_1"><input type="text" name="email_dpto_pagos_c" value="" size="48"onKeyUp="conMayusculas(this)"onblur="MM_validateForm('email_dpto_pagos_c','','NisEmail');return document.MM_returnValue"autocomplete='off'></td>
         </tr>
         <tr>
         ...
         <tr>
           <td id="dato_1"><input type="text" name="direccion_dpto_pagos_c" value="" size="50"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
           ...
           <td colspan="2" id="dato_1"><input type="text" name="cupo_solicitado_c" value="" size="48"onKeyUp="return ValNumero(this)"autocomplete='off'></td>
         </tr>
         <tr>
...
Forma de Pago </td>
           ...
           <input type="text" name="otro_pago_c" value="" size="30"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
           <td id="dato_1">&nbsp;</td>
           <td id="dato_1">&nbsp;</td>          
         </tr>
         <tr>
           <td colspan="4"><table width="100%" id="tabla_formato">
               ...
               <tr>
                 <td id="detalle_1"><input type="text" name="ref_comercial_c" value="" size="30"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
