...
mysql_select_db($database_conexion1, $conexion1);
$query_orden_produccion = "SELECT * FROM Tbl_orden_produccion WHERE b_borrado_op='1' ORDER BY fecha_registro_op DESC";
...
<li><a href="menu.php">EXTRUSION</a></li>
</ul>
</td>
</tr>  
  <tr>
    <td colspan="2" align="center" id="linea1">
<form action="produccion_registro_extrusion_listado.php" method="get" name="form1" >
<table id="tabla1">
<tr>
<td id="titulo2">REGISTRO DE ORDENES DE PRODUCCION</td>
</tr>
<tr>
  <td id="titulo2">O.P
    <input type="text" name="id_op" onBlur="if (form1.id_op.value) { DatosGestiones('10','id_op',form1.id_op.value); } else { alert('Debe digitar el O.P para validar su existencia en la BD'); };"><div id="resultado"></div></td>
  </tr>
<tr>
...
<table id="tabla1">
  ...
  if($id == '0') { ?><div id="numero1"> <?php echo "NO HA SELECCIONADO"; ?> </div> <?php }?></td>
    <td colspan="2" id="dato2"><a href="produccion_op_add.php"><img src="images/mas.gif" alt="ADD O.P" title="ADD O.P" border="0" style="cursor:hand;"/></a><a href="produccion_registro_extrusion_listado_inactivo.php" target="_top"><img src="images/i.gif" alt="O.P. INACTIVAS"title="O.P INACTIVAS" border="0" style="cursor:hand;"/></a><a href="produccion_registro_extrusion_listado.php"><img src="images/ciclo1.gif" alt="RESTAURAR" border="0" style="cursor:hand;"/></a></td>
    </tr>  
  <tr id="tr1">
  ...
  <?php do { ?>
	...
	$sqlop="SELECT * FROM Tbl_orden_produccion WHERE id_op='$id_op' AND b_borrado_op='0'"; 
	$resultop=mysql_query($sqlop); 
	$numop=mysql_num_rows($resultop);
	if($numop >= '1'){
    ...
    if ($estado=='0') 
	{?><a href="produccion_registro_extrusion_add.php?id_op=<?php echo $row_orden_produccion['id_op'];?>" target="_top" style="text-decoration:none; color:#000000"><img src="images/falta.gif" alt="O.P INGRESADA "title="O.P INGRESADA" border="0" style="cursor:hand;"/></a><?php }else if ($estado=='1') 
	{?><a href="produccion_registro_extrusion_vista.php?id_op_rp=<?php echo $row_orden_produccion['id_op'];?>" target="_top" style="text-decoration:none; color:#000000"><img src="images/extruir.gif" width="28" height="18"alt="EXTRUYENDO "title="EXTRUYENDO" border="0" style="cursor:hand;"/><?php }
	else{echo "";}	 
	 ?></a></td>
    </tr>
