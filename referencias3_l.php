...
$row_registros = $conexion->buscarListar("Tbl_referencia","*","ORDER BY n_egp_ref DESC","",$maxRows_registros,$pageNum_registros,"WHERE estado_ref = '1' AND tipo_bolsa_ref='LAMINA'" );
//BOLSA
...
<table id="tabla3">
    ...
    <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF" bordercolor="#ACCFE8">   
      <td class="centrado6"><strong><a href="referencia_lamina_vista.php?cod_ref=<?php echo $row_referencias['cod_ref']; ?>&n_cotiz=<?php echo $row_referencias['n_cotiz_ref']; ?>&id_ref=<?php echo $row_referencias['id_ref']; ?>&tipo=<?php echo $row_usuario['tipo_usuario']; ?>&case=<?php echo "1"; ?>" target="_blank" style="text-decoration:none; color:#000000"><?php echo $row_referencias['cod_ref']; ?></a></strong></td>
      <td class="centrado6"><a href="referencia_lamina_vista.php?cod_ref=<?php echo $row_referencias['cod_ref']; ?>&n_cotiz=<?php echo $row_referencias['n_cotiz_ref']; ?>&id_ref=<?php echo $row_referencias['id_ref']; ?>&tipo=<?php echo $row_usuario['tipo_usuario']; ?>&case=<?php echo "1"; ?>" target="_blank" style="text-decoration:none; color:#000000"><?php echo $row_referencias['version_ref']; ?></a></td>
      <td class="derecha1"><a href="referencia_lamina_vista.php?n_cotiz=<?php echo $row_referencias['n_cotiz_ref']; ?>&cod_ref=<?php echo $row_referencias['cod_ref']; ?>&id_ref=<?php echo $row_referencias['id_ref']; ?>&tipo=<?php echo $row_usuario['tipo_usuario']; ?>&case=<?php echo "2"; ?>" target="_blank" style="text-decoration:none; color:#000000"><?php echo $row_referencias['n_cotiz_ref']; ?></a></td>
      <td class="Estilo4"><a href="referencia_lamina_vista.php?cod_ref=<?php echo $row_referencias['cod_ref']; ?>&n_cotiz=<?php echo $row_referencias['n_cotiz_ref']; ?>&id_ref=<?php echo $row_referencias['id_ref']; ?>&tipo=<?php echo $row_usuario['tipo_usuario']; ?>&case=<?php echo "1"; ?>" target="_blank" style="text-decoration:none; color:#000000"><?php echo $row_referencias['tipo_bolsa_ref']; ?></a></td>
      <td class="Estilo3"><a href="referencia_lamina_vista.php?cod_ref=<?php echo $row_referencias['cod_ref']; ?>&n_cotiz=<?php echo $row_referencias['n_cotiz_ref']; ?>&id_ref=<?php echo $row_referencias['id_ref']; ?>&tipo=<?php echo $row_usuario['tipo_usuario']; ?>&case=<?php echo "1"; ?>" target="_blank" style="text-decoration:none; color:#000000"><?php echo $row_referencias['material_ref']; ?></a></td>
      <td class="centrado6"><?php $ref=$row_referencias['id_ref'];
	  $cod_ref=$row_referencias['cod_ref'];
	  $sqlverif="SELECT * FROM Tbl_verificacion_lamina WHERE id_ref_verif_l='$ref' AND estado_arte_verif_l='2' ORDER BY id_verif_l DESC";
	  $resultverif=mysql_query($sqlverif);
	  $numverif=mysql_num_rows($resultverif);
	  if($numverif >='1')
	  { 
	  $muestra =mysql_result($resultverif, 0, 'userfile_l'); 
	  $fecha =mysql_result($resultverif, 0, 'fecha_aprob_arte_verif_l'); 
	  if($muestra != '') 
      ...
      <td class="centrado6"><?php $ref=$row_referencias['id_ref'];
	  $sqlrevision="SELECT id_rev_l,id_ref_rev_l  FROM Tbl_revision_lamina WHERE id_ref_rev_l='$ref'";
	  $resultrevision= mysql_query($sqlrevision);
	  $row_revision = mysql_fetch_assoc($resultrevision);
	  $numrev= mysql_num_rows($resultrevision);
	  
	  if($numrev >='1')
	  { ?><a href="revision_lamina_vista.php?id_rev_l=<?php echo $row_revision['id_rev_l']; ?>" target="_blank" ><img src="images/r.gif" alt="REVISION"title="REVISION" border="0" style="cursor:hand;"></a><?php } else { ?><a href="revision_lamina_add.php?id_ref=<?php echo $row_referencias['id_ref']; ?>" target="_blank"> - - </a><?php } ?> </td>
      
      <td class="centrado6"><?php $ref=$row_referencias['id_ref'];
	  $sqlverif="SELECT id_ref_verif_l FROM Tbl_verificacion_lamina WHERE id_ref_verif_l='$ref'";
	  $resultverif= mysql_query($sqlverif);
	  $row_verif = mysql_fetch_assoc($resultverif);
	  $numverif= mysql_num_rows($resultverif);
	  if($numverif >='1')
	  { ?> <a href="verificacion_referencia_lamina.php?id_ref=<?php echo $row_referencias['id_ref']; ?>" target="_blank"><img src="images/v.gif" alt="VERIFICACION"title="VERIFICACION" border="0" style="cursor:hand;"></a> <?php } else{ ?> <a href="verificacion_referencia_lamina.php?id_ref=<?php echo $row_referencias['id_ref']; ?>" target="_blank"> - - </a> <?php } ?>
      </td>
      <td class="centrado6"><?php $ref=$row_referencias['id_ref'];
	  $sqlcm="SELECT id_ref_cm FROM Tbl_control_modificaciones_l WHERE id_ref_cm='$ref'";
	  $resultcm= mysql_query($sqlcm);
	  $numcm= mysql_num_rows($resultcm);
	  if($numcm >='1')
	  { ?> <a href="verificacion_referencia_lamina.php?id_ref=<?php echo $row_referencias['id_ref']; ?>" target="_blank"><img src="images/m.gif" alt="VERIFICACION"title="MODIFICACION" border="0" style="cursor:hand;"></a> <?php } else{ ?> <a href="verificacion_referencia_lamina.php?id_ref=<?php echo $row_referencias['id_ref']; ?>" target="_blank"> - - </a> <?php } ?></td>
      <td class="centrado6"><?php $ref=$row_referencias['id_ref'];
	  $sqlval="SELECT id_val_l,id_ref_val_l,version_val_l FROM Tbl_validacion_lamina WHERE id_ref_val_l='$ref'";
	  ...
	  $version=$row_val['version_ref_val_l'];
	  $sqlverif2="SELECT version_ref_verif_l,estado_arte_verif_l FROM Tbl_verificacion_lamina WHERE id_ref_verif_l='$id_ref_val' and version_ref_verif_l='$version' and estado_arte_verif_l != '2'";
	  $resultverif2= mysql_query($sqlverif2);
	  $row_verif2 = mysql_fetch_assoc($resultverif2);
	  $numverif2= mysql_num_rows($resultverif2);	  
	  if($numverif2 >='1')
	  { ?><a href="validacion_lamina_add.php?id_ref=<?php echo $row_referencias['id_ref']; ?>" target="_blank"><img src="images/v_rojo.gif" alt="VALIDACION" title="HAY CAMBIOS RECIENTES EN LA VERSION O EL ARTE NO ESTA APROBADO" border="0" style="cursor:hand;"></a> <?php }else if($numval >='1')
	  { ?> <a href="validacion_lamina_vista.php?id_val_l=<?php echo $row_val['id_val_l']; ?>" target="_blank"><img src="images/v.gif" alt="VALIDACION"title="VALIDACION" border="0" style="cursor:hand;"></a><?php } else if($numrev < '1'){ ?> <a href="verificacion_referencia_lamina.php?id_ref=<?php echo $row_referencias['id_ref']; ?>" target="_blank"> - - </a>
       <?php } else { ?> <a href="validacion_lamina_add.php?id_ref=<?php echo $row_referencias['id_ref']; ?>" target="_blank"> - - </a> <?php } ?>
      </td>
      <td class="centrado6"><?php $ref=$row_referencias['id_ref'];
