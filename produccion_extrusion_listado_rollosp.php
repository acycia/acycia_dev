...
<table id="tabla1">  
  ...
  <?php do { ?>
    <tr onMouseOver="uno(this,'#F5A9A9');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
      <td id="dato2"><a href="produccion_extrusion_stiker_rollo_vista.php?id_r=<?php echo $row_rollo_estrusion['id_r']; ?>&parcial=1" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_rollo_estrusion['rollo_r']; ?></a></td>
      <td id="dato2"><a href="produccion_extrusion_stiker_rollo_vista.php?id_r=<?php echo $row_rollo_estrusion['id_r']; ?>&parcial=1" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_rollo_estrusion['id_op_r']; ?></a></td>
      <td id="dato3"><a href="produccion_extrusion_stiker_rollo_vista.php?id_r=<?php echo $row_rollo_estrusion['id_r']; ?>&parcial=1" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_rollo_estrusion['kilos_r']; $TKILOS+=$row_rollo_estrusion['kilos_r']; ?></a></td>
      <td id="dato2"><a href="produccion_extrusion_stiker_rollo_vista.php?id_r=<?php echo $row_rollo_estrusion['id_r']; ?>&parcial=1" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_rollo_estrusion['metro_r']; $TMETROS+=$row_rollo_estrusion['metro_r']; ?></a></td>
      <td id="dato2"><a href="produccion_extrusion_stiker_rollo_vista.php?id_r=<?php echo $row_rollo_estrusion['id_r']; ?>&parcial=1" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_rollo_estrusion['fechaI_r']; ?></a></td>
      <td id="dato2"><a href="produccion_extrusion_stiker_rollo_vista.php?id_r=<?php echo $row_rollo_estrusion['id_r']; ?>&parcial=1" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_rollo_estrusion['fechaF_r']; ?></a></td>
      <td id="dato2"><a href="produccion_impresion_stiker_rollo_vista.php?id_r=<?php echo $row_rollo_estrusion['id_r']; ?>&parcial=1" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_rollo_estrusion['fechaV_r']; ?></a></td> 
      <td id="dato1"><a href="produccion_extrusion_stiker_rollo_vista.php?id_r=<?php echo $row_rollo_estrusion['id_r']; ?>&parcial=1" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_rollo_estrusion['cod_empleado_r']; ?></a></td>
    </tr>
