  ...
  <tr><td colspan="4" id="dato2">
                 <select name="id_rpp[]" id="id_rpp[]" style="width:200px">
                   <option value="">Referencia MP</option>
                    ...
                    ?>                
                    </select></td><td><input type="number" name="valor_prod_rp[]" id="valor_prod_rp[]" min="0"step="0.01"size="12"  placeholder="Kilos" autofocus/></td></tr>
                 <tr><td colspan="4" id="dato2">
                 <select name="id_rpp[]" id="id_rpp[]" style="width:200px">
                   <option value="">Referencia MP</option>
                     <?php
                 ...
                 <select name="id_rpp[]" id="id_rpp[]" style="width:200px">
                   <option value="">Referencia MP</option>
                    ...
                    ?>                
                    </select></td><td><input type="number" name="valor_prod_rp[]" id="valor_prod_rp[]" min="0"step="0.01"size="12"  placeholder="Kilos" autofocus/></td></tr> </table>                                                                                                                       
                    </div>
