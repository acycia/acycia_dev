...
if($id_c== '0' && $fecha == '0')
{
$query_caracteristicas = "SELECT * FROM Tbl_caracteristicas_valor, Tbl_caracteristicas WHERE Tbl_caracteristicas_valor.id_c_cv= Tbl_caracteristicas.id_c ORDER BY Tbl_caracteristicas_valor.fecha_registro_cv DESC";
}
//Filtra Tbl_caracteristicas lleno
if($id_c != '0' && $fecha == '0')
{
$query_caracteristicas = "SELECT * FROM Tbl_caracteristicas_valor, Tbl_caracteristicas WHERE Tbl_caracteristicas_valor.id_ref_cv='$id_c' AND Tbl_caracteristicas_valor.id_c_cv= Tbl_caracteristicas.id_c ORDER BY Tbl_caracteristicas_valor.cod_ref_cv DESC";
}
//Filtra fecha lleno
if($fecha != '0'  && $id_c == '0'  )
{
...
$fecha2 = $fecha + 1;
$fecha2 = "$fecha2-01-01";
$query_caracteristicas = "SELECT * FROM Tbl_caracteristicas_valor, Tbl_caracteristicas WHERE  Tbl_caracteristicas_valor.id_c_cv= Tbl_caracteristicas.id_c AND Tbl_caracteristicas_valor.fecha_registro_cv >= '$fecha1' and Tbl_caracteristicas_valor.fecha_registro_cv < '$fecha2' ORDER BY Tbl_caracteristicas_valor.cod_ref_cv DESC";
}
//Filtra Tbl_caracteristicas_valor y fecha lleno
if($id_c != '0' && $fecha != '0')
{
$fecha1 = "$fecha-01-01";
$fecha2 = $fecha + 1;
$fecha2 = "$fecha2-01-01";
$query_caracteristicas = "SELECT * FROM Tbl_caracteristicas_valor, Tbl_caracteristicas  WHERE Tbl_caracteristicas_valor.id_ref_cv='$id_c' and  Tbl_caracteristicas_valor.id_c_cv= Tbl_caracteristicas.id_c AND Tbl_caracteristicas_valor.fecha_registro_cv >= '$fecha1' and fecha_registro_cv < '$fecha2' ORDER BY Tbl_caracteristicas_valor.cod_ref_cv DESC";
}
...
mysql_select_db($database_conexion1, $conexion1);
$query_id_cv = "SELECT DISTINCT cod_ref_cv,id_ref_cv FROM Tbl_caracteristicas_valor ORDER BY cod_ref_cv DESC";
...
<tr><td id="nombreusuario"><?php echo $row_usuario['nombre_usuario']; ?></td>
  ...
  <tr>
	...
	<form action="produccion_caracteristicas2.php" method="get" name="consulta">
	<table id="tabla1">
      <tr id="tr1">
	  ...
	  <tr>
	  <td colspan="3" id="subtitulo">LISTADO DE CARACTERISTICAS</td>
	  </tr>
	  <tr>
...
<table id="tabla1">
  <tr>
    <td colspan="8" id="dato3"><a href="referencias.php"><img src="images/mas.gif" alt="ADD MEZCLA Y CARACTERISTICAS" title="ADD MEZCLA Y CARACTERISTICAS" border="0" style="cursor:hand;"/></a><a href="produccion_mezclas.php"><img src="images/m.gif" style="cursor:hand;" alt="LISTADO MEZCLAS" title="LISTADO MEZCLAS" border="0" /></a><a href="produccion_caracteristicas.php"><img src="images/c.gif" style="cursor:hand;" alt="LISTADO CARACTERISTICAS" title="LISTADO CARACTERISTICAS" border="0" /></a><a href="produccion_referencias.php"><img src="images/rp.gif" style="cursor:hand;" alt="LISTADO REF. POR PROCESO" title="LISTADO REF. POR PROCESO" border="0" /></a><a href="produccion_caracteristicas.php"><img src="images/ciclo1.gif" alt="RESTAURAR" title="RESTAURAR" border="0" style="cursor:hand;"/></a></td>
    </tr>
  <tr>
    <td colspan="2" id="dato1"><input name="Input" type="submit" value="Inactivar o Activar"/></td>
    <td colspan="6"><?php $id=$_GET['id'];
...
if($id >= '2') { ?> <div id="acceso1"> <?php echo "ACTIVACION CORRECTA"; ?> </div> <?php }	*/
  ...
  <?php do { ?>
    <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
        <td id="dato2"><?php if($row_caracteristicas['b_borrado_cv']=='0'){?><input name="borrado" type="hidden" id="borrado" value="31" /><input name="borrar[]" type="checkbox" value="<?php echo $row_caracteristicas['id_ref_cv']; ?>" /><?php }?></td>
      ...
      <td id="dato2"><a href="produccion_caract_extrusion_mezcla_vista.php?id_ref=<?php echo $row_caracteristicas['id_ref_cv']; ?>&amp;id_pm=<?php echo $row_caracteristicas['id_pm_cv']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_caracteristicas['fecha_registro_cv']; ?></a></td>
    ...
    <td id="dato2"><?php if($row_caracteristicas['b_borrado_cv']=='0'){echo "ACTIVA";}else?><?php if($row_caracteristicas['b_borrado_cv']=='1'){?><input name="activar" type="hidden" id="activar" value="activar" /><input name="activa[]" type="checkbox" value="<?php echo $row_caracteristicas['id_ref_cv']; ?>" /> ACTIVAR?<?php }?></td>
    </tr>
