...
<frameset rows="110,*" cols="*" frameborder="NO" border="NO">
  <frame src="costos_totales2.php" frameborder="NO" scrolling="NO" noresize marginwidth="0" marginheight="0">
  <frame src="costos_totales3.php" frameborder="NO" scrolling="auto" noresize marginwidth="0" marginheight="0">
</frameset>
<noframes>
