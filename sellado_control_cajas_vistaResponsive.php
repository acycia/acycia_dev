...
<!--         <div class="row">
           <div class="col-md-4">
           <h3>AC & CIA</h3>
           <h4><b>CONTROL DE NUMERACION</b></h4>
...
<!--<div class="row">
           ...
           <h4><b>CONTROL DE NUMERACION</b></h4>
           <hr color="black" size=5>
    <div class="col-sm-3 col-md-6 col-lg-4"><b>CAJA  N&deg;</b> </div>
  ...
  <div class="col-md-6">
           <h5 align="center">AC & CIA <br><b>CONTROL DE NUMERACION</b></h5>
           <hr color="black" size=3>
      <div class="col-md-6">
          <div id="div-1a">
           <p align="right"><FONT SIZE="3">CAJA:</FONT>
             </p>
             <p><?php $caja=$row_vista_paquete['int_caja_tn'];echo $caja; ?> </p>
          
           <!--{vista_paquete.int_caja_tn}-->
          </div>
      ...
      <div class="col-md-6"><b>REF. CLIENTE</b>: 
        <?php if($row_refac_refcl['str_ref_cl_rc']==''){echo "N.A";}else{echo $row_refac_refcl['str_ref_cl_rc'];?>
      </div>
      <div class="col-md-6" id="fuentND"><?php echo $row_refac_refcl['str_descripcion_rc'];}?></div>
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        <b>COD. DEL EMPL:<?php echo $row_vista_paquete['int_cod_empleado_tn']; ?></b> 
      </div>
...
<!-- <div class="row">            
  <ul class="list-group">
  <li class="list-group-item"><h3>AC & CIA</h3>
           <h4><b>CONTROL DE NUMERACION</b></h4>
           <hr color="black" size=5></li>
  <li class="list-group-item"><b>CAJA  N&deg;</b> </li>
