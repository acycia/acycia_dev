...
<li><a href="rollos_busqueda.php" target="_top">FILTRO</a></li>
</ul>
</td>
    </tr>
</table><div id="linea1">
<table id="tabla3">
  <tr id="tr1">
<td id="subtitulo">MATERIA PRIMA ( ROLLOS )</td>
<td id="dato2"><a href="rollos_add.php" target="_top"><img src="images/mas.gif" alt="ADD ROLLO" border="0" style="cursor:hand;"/></a><a href="rollos_oc.php" target="_top"><img src="images/o.gif" alt="O.C. (ROLLOS)" border="0" style="cursor:hand;"/></a><a href="rollos_verificaciones.php" target="_top"><img src="images/v.gif" alt="VERIFICACIONES (ROLLOS)" border="0" style="cursor:hand;" /></a></td>
  </tr>
</table>
</div>
<table id="tabla3">
  <tr>
    <td class="centrado2">CODIGO</td>
    <td class="centrado1">NOMBRE</td>
    <td class="centrado5">REF</td>
    <td class="centrado1">PRESENTACION</td>
    <td class="centrado2">TIPO </td>
    <td class="centrado2">MEDIDA</td>
    <td class="Estilo5">ANCHO</td>
    <td class="Estilo5">CALIBRE</td>
    <td class="Estilo2">TRATAMIENTO</td>
  </tr>
</table>
</div>
</body>
