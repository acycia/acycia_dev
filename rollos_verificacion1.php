...
$fecha = $_GET['fecha'];
/*Filtra todos vacios*/
if($n_vr == '0' && $n_ocr == '0' && $id_p == '0' && $id_rollo == '0' && $id_ref == '0' && $fecha == '0')
{
...
if($n_vr != '0' && $n_ocr == '0' && $id_p == '0' && $id_rollo == '0' && $id_ref == '0' && $fecha == '0')
{
$query_rollos_verificaciones = "SELECT * FROM verificacion_rollos WHERE n_vr='$n_vr'";
}
/*Filtra ocr*/
if($n_vr == '0' && $n_ocr != '0' && $id_p == '0' && $id_rollo == '0' && $id_ref == '0' && $fecha == '0')
{
$query_rollos_verificaciones = "SELECT * FROM verificacion_rollos WHERE n_ocr_vr='$n_ocr' ORDER BY n_vr DESC";
}
/*Filtra proveedor*/
if($n_vr == '0' && $n_ocr == '0' && $id_p != '0' && $id_rollo == '0' && $id_ref == '0' && $fecha == '0')
{
$query_rollos_verificaciones = "SELECT * FROM verificacion_rollos WHERE id_p_vr='$id_p' ORDER BY n_vr DESC";
}
/*FILTRA ROLLO*/
if($n_vr == '0' && $n_ocr == '0' && $id_p == '0' && $id_rollo != '0' && $id_ref == '0' && $fecha == '0')
{
$query_rollos_verificaciones = "SELECT * FROM verificacion_rollos WHERE id_rollo_vr='$id_rollo' ORDER BY n_vr DESC";
}
/*FILTRA REFERENCIA*/
if($n_vr == '0' && $n_ocr == '0' && $id_p == '0' && $id_rollo == '0' && $id_ref != '0' && $fecha == '0')
{
$query_rollos_verificaciones = "SELECT * FROM verificacion_rollos WHERE id_ref_vr='$id_ref' ORDER BY n_vr DESC";
}
//Filtra fecha lleno
if($n_vr == '0' && $n_ocr == '0' && $id_p == '0' && $id_rollo == '0' && $id_ref == '0' && $fecha != '0')
{
...
$fecha2 = $fecha + 1;
$fecha2 = "$fecha2-01-01";
$query_rollos_verificaciones = "SELECT * FROM verificacion_rollos WHERE fecha_recibo_vr >= '$fecha1' AND fecha_recibo_vr < '$fecha2' ORDER BY n_vr DESC";
}
