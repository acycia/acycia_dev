...
<tr><td id="nombreusuario"><?php echo $row_usuario['nombre_usuario']; ?></td>
  ...
  <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
    <table id="tabla2">
      <tr id="tr2">
        <td colspan="4" id="titulo2">REFERENCIA ( LAMINAS ) </td>
        </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="dato1"><input name="N_diametro_max_l" type="text" id="N_diametro_max_l" size="10" value="<?php echo $row_lamina['N_diametro_max']?>"/></td>
      </tr>
      <tr id="tr1">
      ...
      <tr>
        <td id="dato1"><input name="N_peso_max" type="text" id="N_peso_max" size="10" value="<?php echo $row_lamina['N_peso_max'] ?>"/></td>
        <td id="dato1"><input name="N_cantidad_metros_r_l" type="text" id="N_cantidad_metros_r_l" size="10" value="<?php echo $row_lamina['N_cantidad_metros_r']?>"/></td>
        <td id="dato1"><select name="N_embobinado" id="N_embobinado">
          <option value="0"<?php if (!(strcmp("0", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>*</option>
          <option value="A"<?php if (!(strcmp("A", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>A</option>
          <option value="B"<?php if (!(strcmp("B", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>B</option>
          <option value="C"<?php if (!(strcmp("C", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>C</option>
          <option value="D"<?php if (!(strcmp("D", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>D</option>
          <option value="1"<?php if (!(strcmp("1", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>1</option>
          <option value="2"<?php if (!(strcmp("2", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>2</option>
          <option value="3"<?php if (!(strcmp("3", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>3</option>
          <option value="4"<?php if (!(strcmp("4", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>4</option>
          <option value="5"<?php if (!(strcmp("5", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>5</option>
          <option value="6"<?php if (!(strcmp("6", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>6</option>
          <option value="7"<?php if (!(strcmp("7", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>7</option>
          <option value="8"<?php if (!(strcmp("8", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>8</option>
          <option value="9"<?php if (!(strcmp("9", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>9</option>
          <option value="10"<?php if (!(strcmp("10", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>10</option>
          <option value="11"<?php if (!(strcmp("11", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>11</option>
          <option value="12"<?php if (!(strcmp("12", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>12</option>
          <option value="13"<?php if (!(strcmp("13", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>13</option>
          <option value="14"<?php if (!(strcmp("14", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>14</option>
          <option value="15"<?php if (!(strcmp("15", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>15</option>
          <option value="16"<?php if (!(strcmp("16", $row_lamina['N_embobinado']))) {echo "selected=\"selected\"";} ?>>16</option>
        </select>
          <a href="javascript:verFoto('archivosc/EMBOBINADOS.pdf','610','490')" >Ver Cuadro</a></td>
        <td id="dato1">&nbsp;</td>
      </tr>
      <tr id="tr1">
...
<option value="Ldpe coestruido pigmentado"  <?php if (!(strcmp("Ldpe coestruido pigmentado", $row_referencia_editar['material_ref']))) {echo "selected=\"selected\"";} ?>>Ldpe coestruido pigmentado</option>
      ...
      <tr>
        <td colspan="2" id="dato1"><select name="tipo_ext_egp" id="tipo_ext_egp">
  ...
  <option value="Coextrusion" <?php if (!(strcmp("Coextrusion", $row_ver_egp['tipo_ext_egp']))) {echo "selected=\"selected\"";} ?>>Coextrusion</option>
      ...
      <tr id="tr1">
        <td colspan="2" id="fuente1">Colores</td>
        <td id="fuente1">&nbsp;</td>
        <td id="fuente1"></td>
      </tr>
      <tr>
        <td colspan="2" id="dato1"><select name="N_colores_impresion" id="N_colores_impresion"tag="tag" tabindex="1\">
      ...
      <tr>
        <td colspan="2" id="dato1"><input type="text" name="color1_egp" value="<?php echo $row_ver_egp['color1_egp']; ?>" size="20"></td>
      ...
      <tr id="tr1">
        <td colspan="2" id="fuente1">Color 2 </td>
        <td id="fuente1">Pantone</td>
        <td id="fuente1">Ubicaci&oacute;n</td>
      </tr>
      <tr>
        <td colspan="2" id="dato1"><input type="text" name="color2_egp" value="<?php echo $row_ver_egp['color2_egp']; ?>" size="20" /></td>
      ...
      <tr>
        <td colspan="2" id="dato1"><input type="text" name="color3_egp" value="<?php echo $row_ver_egp['color3_egp']; ?>" size="20" /></td>
      ...
      <tr id="tr1">
        <td colspan="2" id="fuente1">Color 4</td>
        <td id="fuente1">Pantone</td>
        <td id="fuente1">Ubicaci&oacute;n</td>
      </tr>
      <tr>
        <td colspan="2" id="dato1"><input type="text" name="color4_egp" value="<?php echo $row_ver_egp['color4_egp']; ?>" size="20" /></td>
      ...
      <tr>
        <td colspan="2" id="dato1"><input type="text" name="color5_egp" value="<?php echo $row_ver_egp['color5_egp']; ?>" size="20" /></td>
      ...
      <tr id="tr1">
        <td colspan="2" id="fuente1">Color 6 </td>
        <td id="fuente1">Pantone</td>
        <td id="fuente1">Ubicaci&oacute;n</td>
      </tr>
      <tr>
        <td colspan="2" id="dato1"><input type="text" name="color6_egp" value="<?php echo $row_ver_egp['color6_egp']; ?>" size="20" /></td>
      ...
      <tr id="tr1">
        <td colspan="2" id="fuente1">Color 7</td>
        <td id="fuente1">Pantone</td>
        <td id="fuente1">Ubicaci&oacute;n</td>
      </tr>
      <tr>
        <td colspan="2" id="dato1"><input type="text" name="color7_egp" value="<?php echo $row_ver_egp['color7_egp']; ?>" size="20" /></td>
      ...
      <tr id="tr1">
        <td colspan="2" id="fuente1">Color 8</td>
        <td id="fuente1">Pantone</td>
        <td id="fuente1">Ubicaci&oacute;n</td>
      </tr>
      <tr>
        <td colspan="2" id="dato1"><input type="text" name="color8_egp" value="<?php echo $row_ver_egp['color8_egp']; ?>" size="20" /></td>
      ...
      <tr>
        <td colspan="2" nowrap="nowrap" id="dato1"><input <?php if (!(strcmp($row_ver_egp['arte_sum_egp'],1))) {echo "checked=\"checked\"";} ?> name="arte_sum_egp" type="checkbox" value="1">
