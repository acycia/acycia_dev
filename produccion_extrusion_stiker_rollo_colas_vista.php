...
<!--<div align="center" id="seleccion" >--><!--onClick="cerrar('seleccion');"-->
  <table id="tabla6" cellspacing="0" cellpadding="0">
    ...
    <td nowrap="nowrap" id="stikersC_fuentN" style=" border-left: 3px solid #000000;">Calibre:</td>
  ...
  <tr>
    ...
    <td id="stikersC_fuentN" style=" border-left: 3px solid #000000;">Tratamie:</td>
  ...
  <tr>
    ...
    <td id="stikers_fuentN" style="border-left: 3px solid #000000;" >&nbsp;</td>
    <td id="stikers_fuentN" >&nbsp;</td>
    </tr>
  <!--<tr>
