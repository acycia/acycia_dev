...
<input type="submit" name="submit" value="FILTRO"/></td>
  ...
  <tr>
    ...
    <td colspan="2" id="dato3"><input type="button" value="Descarga Excel" onclick="window.location = 'consumo_tiempos_ext_excel.php?fecha_ini=<?php echo $fecha1 ?>&fecha_fin=<?php echo $fecha2 ?>&id_op=<?php echo $_GET['id_op']?>'" /></td>
    </tr>
    </table>  
  <table id="tabla1" >    
    <tr id="tr1">
  ...
  <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF" >
    ...
    <td id="dato3"><?php echo $row_costos['int_cod_ref_op'];?></td>
	  ...
	  echo $horaprom=dosDecimalesSinMiles($horasP_ex/60); }
	  else
	  {echo "0";}
	  ?></td>
