...
<tr>
  ...
  <td colspan="7" nowrap="nowrap" id="titulo3">&nbsp;</td>
...
FECHA FIN:
<input name="fecha_fin" type="date" id="fecha_fin" min="2000-01-02" size="10" required="required" value="<?php echo fecha();?>"/><!--onChange="if(form1.fecha_ini.value && form1.fecha_fin.value) { consulta_ref_xproceso_tiempos(); }else { alert('Debe seleccionar las dos fechas')}"-->
O.P
...
<input type="submit" name="submit" value="FILTRO"/></td>
  ...
  <tr>
    <td colspan="17" id="dato1">Nota: Los tiempos muertos y de preparacion estan en minutos y si algun proceso no aprarece debe estar en otra fecha o no procesado</td>
    <td id="dato3">&nbsp;</td>
    <td colspan="4" id="dato3"><a href="produccion_registro_extrusion_listado.php"><img src="images/e.gif" alt="LISTADO EXTRUSION"title="LISTADO EXTRUSION" border="0" style="cursor:hand;" /></a><a href="produccion_registro_impresion_listado.php"><img src="images/i.gif" alt="LISTADO IMPRESION"title="LISTADO IMPRESION" border="0" style="cursor:hand;" /></a><a href="consumo_materias_primas.php"><img src="images/mp.gif" alt="LISTADO DE MATERIAS PRIMAS"title="LISTADO DE MATERIAS PRIMAS" border="0" style="cursor:hand;" /></a><a href="costos_listado_ref_xproceso.php"><img src="images/rp.gif" alt="LISTADO REF KILOS X PROCESO"title="LISTADO REF KILOS X PROCESO" border="0" style="cursor:hand;" /></a><a href="javascript:location.reload()"><img src="images/ciclo1.gif" alt="RESTAURAR" title="RESTAURAR" border="0" style="cursor:hand;"/></a></td>        
  ...
  <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
    <td id="dato1"><?php echo $row_costos['id_op_rp'];?></td>
	  ...
	  if($numex >= '1') 
	  { $kgT_ex=mysql_result($resultex,0,'kgT'); numeros_format($kgT_ex);} if ($kgT_ex==NULL) {echo "0";}
	  echo $kilosExt=$row_costos['int_kilos_prod_rp'];
	  ?></td>       
      <td id="dato3">
      <?php 
	  $ref=$row_costos['id_op_rp'];
