...
<table id="tabla1"><tr>
<td colspan="5" align="center"><img src="images/cabecera.jpg"></td></tr>
      ...
      <td><table id="tablainterna">
        ...
        <table id="tabla3">
          ...
          <tr id="tr3">
            ...
            <td colspan="2" nowrap="nowrap" id="fuente1">&nbsp;</td>
          </tr>
          <tr id="tr3">
          ...
          <tr>
            <td colspan="2" id="fuente3"><!--Editar  los colores de las Unidades en el Egp:-->
              <!--<select name="ref" id="select_sh2" onchange="if(form1.ref.value){ consulta_ref_impresion_add(); } else{ alert('Debe Seleccionar una REFERENCIA'); }"  style="visibility:hidden">
...
?>
            ...
            <td colspan="2" id="dato1"><!--<a href="javascript:verFoto('produccion_caract_impresion_edit_colores.php?id_ref=<?php echo $row_ref['id_ref']; ?>&amp;n_egp=<?php echo $row_ref['cod_ref']; ?>','830','801')"><img src="images/engranaje-12.gif" alt="EDITAR COLORES" width="64" height="47" style="cursor:hand;" title="EDITAR COLORES" border="0" /></a>-->
              <a href="referencia_bolsa_edit.php?id_ref=<?php echo $row_ref['id_ref']; ?>&amp;n_egp=<?php echo $row_ref['cod_ref']; ?>" title="REF-EGP" target="_self"><em>REF-EGP</em></a></td>
          </tr>
          <tr id="tr1">
            <td colspan="5" id="titulo4">UNIDADES DE IMPRESION
          ...
          <tr>
            <td id="fuente1"><table id="tablainterna2">
              <tr>
                ...
                <td colspan="2" nowrap="nowrap"id="fuente6"><?php echo $row_ref['color1_egp'] ?></td>
              </tr>
              <tr>
...
?>
              ...
              <tr>
                ...
                <td nowrap="nowrap" id="fuente4"><input name="id_m[]" type="hidden" id="id_m[]" value="2" />
                  <input name="und[]" type="hidden" id="und[]" value="1" />
                  <select name="id[]" id="id[]" style="width:80px">
...
?>
              ...
              <tr>
                ...
                <td id="fuente4"><input name="id_m[]" type="hidden" id="id_m[]" value="5" />
                  <input name="und[]3" type="hidden" id="und[]3" value="1" />
                  <select name="id[]" id="id[]" style="width:80px">
...
?>
    ...
    <td id="fuente1"><input name="valor[]"  style="width:60px" min="0"step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="%"/></td>
              ...
              <tr>
                <td nowrap="nowrap"id="fuente1">ANILOX/ REF</td>
...
?>
                ...
                <td id="fuente1"><input name="valor[]"  style="width:60px" min="0" max="99" step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="%"/></td>
              </tr>
              <tr>
                <td nowrap="nowrap"id="fuente5">&nbsp;</td>
...
?>
                ...
                <td id="fuente5"><input name="valor[]"  style="width:60px" min="0" max="99" step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="%"/></td>
              </tr>
              <!--<tr>
...
?>
    ...
    <td id="fuente1"><input name="valor[]"  style="width:60px" min="0"step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="%"/></td>
            ...
            <td><table id="tablainterna2">
              ...
              <tr>
                <td nowrap="nowrap" id="fuente4"><input name="id_m[]" type="hidden" id="id_m[]" value="1" />
...
?>
                ...
                <td nowrap="nowrap" id="fuente4"><input name="valor[]5"  style="width:60px" min="0" step="0.01" type="number"  id="valor[]5"  size="3" value="" placeholder="%"/></td>
              </tr>
              <tr>
                <td nowrap="nowrap" id="fuente4"><input name="id_m[]" type="hidden" id="id_m[]" value="2" />
                  <input name="und[]" type="hidden" id="und[]" value="2" />
...
?>
              ...
              <tr>
                <td id="fuente7"><input name="id_m[]" type="hidden" id="id_m[]" value="18" />
                  <input name="und[]" type="hidden" id="und[]" value="2" />
                  <select name="id[]" id="id[]" style="width:80px">
                    <option value="0">ANIX/BCM</option>
                    <?php
...
?>
                ...
                <td id="fuente7"><input name="valor[]"  style="width:60px" min="0" max="99" step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="%"/></td>
              </tr>
              <!--<tr>
    <td id="fuente1"><input name="id_m[]" type="hidden" id="id_m[]" value="14" />
      <input name="und[]" type="hidden" id="und[]" value="2" />
...
?>
              ...
              <tr>
                <td id="fuente8"><input name="id_m[]" type="hidden" id="id_m[]" value="18" />
                  <input name="und[]" type="hidden" id="und[]" value="3" />
                  <select name="id[]" id="id[]" style="width:80px">
                    <option value="0">ANIX/BCM</option>
                    <?php
...
?>
                ...
                <td id="fuente8"><input name="valor[]"  style="width:60px" min="0" max="99" step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="%"/></td>
              </tr>
              <!--<tr>
    <td id="fuente1"><input name="id_m[]" type="hidden" id="id_m[]" value="14" />
      <input name="und[]" type="hidden" id="und[]" value="3" />
...
?>
              ...
              <tr>
                <td id="fuente9"><input name="id_m[]" type="hidden" id="id_m[]" value="18" />
                  <input name="und[]" type="hidden" id="und[]" value="4" />
                  <select name="id[]" id="id[]" style="width:80px">
                    <option value="0">ANIX/BCM</option>
                    <?php
...
?>
                ...
                <td id="fuente9"><input name="valor[]"  style="width:60px" min="0" max="99" step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="%"/></td>
              </tr>
              <!--<tr>
    <td id="fuente1"><input name="id_m[]" type="hidden" id="id_m[]" value="14" />
      <input name="und[]" type="hidden" id="und[]" value="4" />
...
?>
    ...
    <td id="fuente1"><input name="valor[]"  style="width:60px" min="0"step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="%"/></td>
            ...
            <td><table id="tablainterna3">
              <tr>
                <td nowrap="nowrap"id="fuente10"></td>
                <td colspan="2" nowrap="nowrap" id="fuente1"><?php echo $row_ref['color5_egp'] ?></td>
              </tr>
              <tr>
                <td nowrap="nowrap"id="fuente1">COLORES</td>
                <td nowrap="nowrap" id="fuente14"><input name="id_m[]" type="hidden" id="id_m[]" value="1" />
...
?>
                ...
                <td nowrap="nowrap" id="fuente14"><input name="valor[]"  style="width:60px" min="0" step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="%"/></td>
              </tr>
              <tr>
                <td nowrap="nowrap"id="fuente1">MEZCLAS</td>
...
?>
              ...
              <tr>
                <td nowrap="nowrap"id="fuente10">&nbsp;</td>
                <td id="fuente14"><input name="id_m[]" type="hidden" id="id_m[]" value="3" />
                  <input name="und[]" type="hidden" id="und[]" value="5" />
                  <select name="id[]" id="id[]" style="width:80px">
                    <option value="0">MEZCLA 2</option>
                    <?php
...
?>
                ...
                <td id="fuente14"><input name="valor[]"  style="width:60px" min="0"step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="%"/></td>
              </tr>
              <tr>
                <td nowrap="nowrap"id="fuente10">&nbsp;</td>
                <td id="fuente14"><input name="id_m[]" type="hidden" id="id_m[]" value="4" />
                  <input name="und[]" type="hidden" id="und[]" value="5" />
                  <select name="id[]" id="id[]" style="width:80px">
                    <option value="0">MEZCLA 3</option>
                    <?php
...
?>
                ...
                <td id="fuente10"><input name="valor[]"  style="width:60px" min="0"step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="%"/></td>
              </tr>
              <tr>
                <td nowrap="nowrap"id="fuente10">&nbsp;</td>
                <td id="fuente10"><input name="id_m[]" type="hidden" id="id_m[]" value="5" />
                  <input name="und[]" type="hidden" id="und[]" value="5" />
                  <select name="id[]" id="id[]" style="width:80px">
                    <option value="0">MEZCLA 4</option>
                    <?php
...
?>
              ...
              <tr>
                <td nowrap="nowrap"id="fuente1">ALCOHOL</td>
                <td id="fuente10"><input name="id_m[]" type="hidden" id="id_m[]" value="6" />
                  <input name="und[]" type="hidden" id="und[]" value="5" />
                  <select name="id[]" id="id[]" style="width:80px">
                    <option value="0">ALCOHOL</option>
                    <?php
...
?>
              ...
              <tr>
                <td nowrap="nowrap"id="fuente1">ACETATO NPA</td>
                <td id="fuente10"><input name="id_m[]" type="hidden" id="id_m[]" value="7" />
                  <input name="und[]" type="hidden" id="und[]" value="5" />
                  <select name="id[]" id="id[]" style="width:80px">
                    <option value="0">ACETATO</option>
                    <?php
...
?>
    ...
    <td id="fuente1"><input name="valor[]"  style="width:60px" min="0"step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="%"/></td>
              ...
              <tr>
                <td nowrap="nowrap"id="fuente1">METOXIPROPANOL</td>
                <td id="fuente10"><input name="id_m[]" type="hidden" id="id_m[]" value="9" />
                  <input name="und[]" type="hidden" id="und[]" value="5" />
                  <select name="id[]" id="id[]" style="width:80px">
                    <option value="0">METOXI</option>
                    <?php
...
?>
              ...
              <tr>
                <td nowrap="nowrap"id="fuente1">VISCOSIDAD                  </td>
                <td id="fuente10"><input name="id_m[]" type="hidden" id="id_m[]" value="10" />
                  <input name="und[]" type="hidden" id="und[]" value="5" />
                  <input name="id[]" type="hidden" id="id[]" value="1" /></td>
                <td id="fuente14"><input name="valor[]"  style="width:60px" min="0"step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="segundos"/></td>
              </tr>
              <!--<tr>
    <td id="fuente1"><input name="pantone"  type="text"  placeholder="Pant" value="<?php echo $row_ref['pantone5_egp'] ?>" size="3"/></td>
    <td id="fuente1">&nbsp;</td>
  </tr>-->
              <!--<tr>
    <td id="fuente1"><input name="id_m[]" type="hidden" id="id_m[]" value="12" />
...
?>
    ...
    <td id="fuente1"><input name="valor[]"  style="width:60px" min="0"step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="%"/></td>
              ...
              <tr>
                <td nowrap="nowrap"id="fuente1">&nbsp;</td>
                <td colspan="3" nowrap="nowrap"id="fuente1">ANILOX UNIDAD 5</td>
              </tr>
              <tr>
                <td nowrap="nowrap"id="fuente1">ANILOX / REF</td>
                <td id="fuente10"><input name="id_m[]" type="hidden" id="id_m[]" value="13" />
                  <input name="und[]" type="hidden" id="und[]" value="5" />
                  <select name="id[]" id="id[]" style="width:80px">
                    <option value="0">ANIX/REF</option>
                    <?php
...
?>
                ...
                <td id="fuente10"><input name="valor[]"  style="width:60px" min="0" max="99" step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="%"/></td>
              </tr>
              <tr>
                <td nowrap="nowrap"id="fuente1">&nbsp;</td>
...
?>
                ...
                <td id="fuente16"><input name="valor[]"  style="width:60px" min="0" max="99" step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="%"/></td>
              </tr>
              <!--<tr>
    <td id="fuente1"><input name="id_m[]" type="hidden" id="id_m[]" value="14" />
      <input name="und[]" type="hidden" id="und[]" value="5" />
...
?>
              ...
              <!--<tr>
    <td id="fuente1"><input name="pantone"  type="text"  placeholder="Pant" value="<?php echo $row_ref['pantone6_egp'] ?>" size="3"/></td>
    <td id="fuente1">&nbsp;</td>
  </tr>-->
              <!--<tr>
    <td id="fuente1"><input name="id_m[]" type="hidden" id="id_m[]" value="12" />
...
?>
              ...
              <tr>
                <td id="fuente11"><input name="id_m[]" type="hidden" id="id_m[]" value="18" />
                  <input name="und[]" type="hidden" id="und[]" value="6" />
                  <select name="id[]" id="id[]" style="width:80px">
                    <option value="0">ANIX/BCM</option>
                    <?php
...
?>
                ...
                <td id="fuente11"><input name="valor[]"  style="width:60px" min="0" max="99" step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="%"/></td>
              </tr>
              <!--<tr>
    <td id="fuente1"><input name="id_m[]" type="hidden" id="id_m[]" value="14" />
      <input name="und[]" type="hidden" id="und[]" value="6" />
...
?>
              ...
              <!--<tr>
    <td id="fuente1"><input name="pantone"  type="text"  placeholder="Pant" value="<?php echo $row_ref['pantone7_egp'] ?>" size="3"/></td>
    <td id="fuente1">&nbsp;</td>
  </tr>-->
              <!--<tr>
    <td id="fuente1"><input name="id_m[]" type="hidden" id="id_m[]" value="12" />
...
?>
              ...
              <tr>
                <td id="fuente12"><input name="id_m[]" type="hidden" id="id_m[]" value="18" />
                  <input name="und[]" type="hidden" id="und[]" value="7" />
                  <select name="id[]" id="id[]" style="width:80px">
                    <option value="0">ANIX/BCM</option>
                    <?php
...
?>
                ...
                <td id="fuente12"><input name="valor[]"  style="width:60px" min="0" max="99" step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="%"/></td>
              </tr>
              <!--<tr>
    <td id="fuente1"><input name="id_m[]" type="hidden" id="id_m[]" value="14" />
      <input name="und[]" type="hidden" id="und[]" value="7" />
...
?>
              ...
              <!--<tr>
    <td id="fuente1"><input name="pantone"  type="text"  placeholder="Pant" value="<?php echo $row_ref['pantone8_egp'] ?>" size="3"/></td>
    <td id="fuente1">&nbsp;</td>
  </tr>-->
              <!--<tr>
    <td id="fuente1"><input name="id_m[]" type="hidden" id="id_m[]" value="12" />
...
?>
              ...
              <tr>
                <td id="fuente13"><input name="id_m[]" type="hidden" id="id_m[]" value="18" />
                  <input name="und[]" type="hidden" id="und[]" value="8" />
                  <select name="id[]" id="id[]" style="width:80px">
                    <option value="0">ANIX/BCM</option>
                    <?php
...
?>
                ...
                <td id="fuente13"><input name="valor[]"  style="width:60px" min="0" max="99" step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="%"/></td>
              </tr>
              <!--<tr>
    <td id="fuente1"><input name="id_m[]" type="hidden" id="id_m[]" value="14" />
      <input name="und[]" type="hidden" id="und[]" value="8" />
...
?>
    ...
    <td id="fuente1"><input name="valor[]"  style="width:60px" min="0"step="0.01" type="number"  id="valor[]"  size="3" value="" placeholder="%"/></td>
          ...
          <tr>
            <td colspan="5" id="fuente2"><textarea name="observ_pmi" id="observ_pmi" cols="100%" rows="2" placeholder="OBSERVACIONES"onblur="conMayusculas(this)"></textarea></td>
          </tr>
          <tr id="tr1">
            <td colspan="5" id="fuente2"><input type="hidden" name="id_ref" id="id_ref" value="<?php echo $row_ref['id_ref']; ?>"/>
          ...
          <tr>
            <td colspan="5" id="fuente2"><input type="submit" name="Guardar" id="Guardar" value="Guardar " /></td>
          </tr>
        </table>
        <table>
        </table></td>
