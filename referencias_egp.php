...
mysql_select_db($database_conexion1, $conexion1);
$query_ver = "SELECT * FROM referencia ORDER BY n_egp_ref ASC";
    ...
    <td height="51" colspan="2" bordercolor="#FFFFFF" bgcolor="#FFFFFF"><div align="left">
      <table width="730" border="0" cellspacing="3" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
        <tr bgcolor="#CCCCCC">
          ...
          <td width="300" bordercolor="#FFFFFF" bgcolor="#ECF5FF"><div align="center" class="Estilo89"><a href="referencias_cliente.php" class="Estilo41">Cliente</a></div></td>
