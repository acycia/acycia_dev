...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO anilox (id_insumo, codigo_insumo, descripcion_insumo, clase_insumo, medida_insumo, tipo_insumo, valor_unitario_insumo, stok_insumo) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
...
//CODIGO
mysql_select_db($database_conexion1, $conexion1);
$query_ultimo = "SELECT id_insumo  FROM anilox ORDER BY id_insumo DESC";
...
//ID
mysql_select_db($database_conexion1, $conexion1);
$query_ultimo2 = "SELECT codigo_insumo FROM anilox ORDER BY codigo_insumo DESC";
      ...
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>" onSubmit="MM_validateForm('id_p','','R');return document.MM_returnValue">
        <table id="tabla2">
          <tr>
            ...
            <td id="subtitulo">* ADD NUEVO ANILOX</td>
            <td id="dato2"><a href="anilox.php"><img src="images/cat.gif" alt="ANILOX" title="ANILOX" border="0" style="cursor:hand;"></a><img src="images/ciclo1.gif" onClick="window.history.go()" style="cursor:hand;" ></td>
          </tr>
          <tr>
            <td id="fuente1">ID:<input name="id_insumo" type="text" value="<?php echo $row_ultimo['id_insumo']+1; ?>" readonly='readonly' ><br>
              CODIGO DEL ANILOX</td>
            <td id="fuente1">TIPO DE ANILOX</td>
          </tr>
          <tr>
            <td id="fuente1"><input type="number" min="1" step="1" style="width:100px" name="codigo_insumo" value="<?php echo $row_ultimo2['codigo_insumo']+1; ?>" required ></td>
...
?>
            ...
            <td id="dato1"><input type="text" name="valor_unitario_insumo" value="" required size="20"></td>
          </tr>
          <tr>
...
?>
          ...
          <tr>
            <td colspan="3" id="dato2"><input type="submit" value="ADD ANILOX"></td>
            </tr>
        </table>
