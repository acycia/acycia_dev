...
/*mysql_select_db($database_conexion1, $conexion1);
$query_artes = "SELECT * FROM verificacion WHERE userfile <> ' ' ORDER BY userfile ASC";
                        ...
                        <select class="busqueda selectsMini" name="id_verif" id="id_verif">
                         ...
                         <option value="0">ARTE</option>
                            <?php  foreach($row_artes as $row_artes ) { ?>
                             <option value="<?php echo $row_artes['userfile']?>"><?php echo $row_artes['userfile']?></option>
                           <?php } ?>
                         </select>
