...
?>
        ...
        <tr>
          ...
          <td id="fuente1"><input name="ancho_ref" id="ancho_ref" style="width:65px" min="0"step="0.01" type="number" size="5" value="<?php echo $row_ref['ancho_ref'] ?>"/></td>
          <td id="fuente1">Largo</td>
          <td id="fuente1"><input name="largo_ref" id="largo_ref" style="width:65px" min="0"step="0.01" type="number" size="5" value="<?php echo $row_ref['largo_ref'] ?>"/></td>
        ...
        <tr>
          ...
          <td id="fuente1">Bolsillo Portaguia   (Traslape/Resellable )</td>
          ...
          <td colspan="3" id="fuente1">Tama&ntilde;o mm(Forma -  Bolsillo)</td>
...
<tr>
      ...
      <tr>
        ...
        <tr>
          <td colspan="8" id="fuente2"><input type="submit" name="Guardar" class="botonGeneral" id="Guardar" value="Actualizar" /></td>
        </tr>
      </table></td>    
    </table>
