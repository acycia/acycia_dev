...
$query_caracteristicas = "SELECT *
FROM Tbl_caracteristicas_valor, Tbl_caracteristicas WHERE Tbl_caracteristicas_valor.id_c_cv= Tbl_caracteristicas.id_c ORDER BY Tbl_caracteristicas_valor.cod_ref_cv DESC";
...
<tr><td id="nombreusuario"><?php echo $row_usuario['nombre_usuario']; ?></td>
  ...
  <tr>
	...
	<table id="tabla1">
	  ...
	  <tr>
	  <td colspan="7" id="subtitulo">LISTADO DE CARACTERISTICAS</td>
	  </tr>
	  <tr>
	  <td colspan="7" id="fuente2"><select name="id_cv" id="id_cv">
