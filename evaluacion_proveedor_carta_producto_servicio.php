...
<body>
	...
	<div align="center" >
      ...
      <br>
        ...
        <?php echo $row_evaluacion_proveedor['ciudad_p']; ?> - 
      	...
      	<tbody>
      		...
      		<tr>
      			<td><strong>SERVICIO</strong> <br> 
      				...
      				Atención a quejas, reclamos, solicitudes,<br>
      				sugerencias y amabilidad en el servicio.
      			</td>
      			<td id="dato2">25%</td>
      ...
      <?php 
         switch ($row_evaluacion_proveedor['porcentaje_final_ev']) {
         	...
         	case $row_evaluacion_proveedor['porcentaje_final_ev'] > 79 && $row_evaluacion_proveedor['porcentaje_final_ev'] < 95:
         		...
         		break;
         	case $row_evaluacion_proveedor['porcentaje_final_ev'] > 68 && $row_evaluacion_proveedor['porcentaje_final_ev'] < 80:
