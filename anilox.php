...
<frameset rows="135,*" cols="*" frameborder="NO" border="NO">
  <frame src="anilox2.php" frameborder="NO" scrolling="NO" noresize marginwidth="0" marginheight="0">
  <frame src="anilox3.php" frameborder="NO" scrolling="auto" noresize marginwidth="0" marginheight="0">
</frameset>
<noframes>
