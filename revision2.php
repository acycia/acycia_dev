...
if($id_rev != '0' && $id_ref == '0' && $fecha == '0')
{
  $query_revisiones = "SELECT * FROM revision WHERE id_rev='$id_rev' ORDER BY id_rev DESC";
}
//Filtra referencia lleno
if($id_ref != '0' && $id_rev == '0' && $fecha == '0')
{
  $query_revisiones = "SELECT * FROM revision WHERE id_ref_rev='$id_ref' ORDER BY id_rev DESC";
}
//Filtra fecha lleno
if($fecha != '0' && $id_ref == '0' && $id_rev == '0'  )
{
  ...
  $fecha2 = $fecha + 1;
  $fecha2 = "$fecha2-01-01";
  $query_revisiones = "SELECT * FROM revision WHERE fecha_rev >= '$fecha1' and fecha_rev < '$fecha2' ORDER BY id_rev DESC";
}
...
if($fecha != '0' && $id_ref != '0' && $id_rev == '0'  )
{
  ...
  $fecha2 = $fecha + 1;
  $fecha2 = "$fecha2-01-01";
  $query_revisiones = "SELECT * FROM revision WHERE id_ref_rev='$id_ref' and fecha_rev >= '$fecha1' and fecha_rev < '$fecha2' ORDER BY id_rev DESC";
}
...
if($id_rev != '0' && $fecha != '0' && $id_ref == '0')
{
  ...
  $fecha2 = $fecha + 1;
  $fecha2 = "$fecha2-01-01";
  $query_revisiones = "SELECT * FROM revision WHERE id_rev='$id_rev' and fecha_rev >= '$fecha1' and fecha_rev < '$fecha2' ORDER BY id_rev DESC";
}
//Filtra revision y referencia lleno
if($id_rev != '0' && $id_ref != '0' && $fecha == '0')
{
  $query_revisiones = "SELECT * FROM revision WHERE id_rev='$id_rev' and id_ref_rev='$id_ref' ORDER BY id_rev DESC";
}
//Filtra Todos llenos
if($id_rev != '0' && $id_ref != '0' && $fecha != '0')
{
  ...
  $fecha2 = $fecha + 1;
  $fecha2 = "$fecha2-01-01";
  $query_revisiones = "SELECT * FROM revision WHERE id_rev='$id_rev' and id_ref_rev='$id_ref' and fecha_rev >= '$fecha1' and fecha_rev < '$fecha2' ORDER BY id_rev DESC";
}
                     ...
                     <tr>
                       <td colspan="3" id="fuente2">
                        <select class="busqueda selectsMini" name="id_rev" id="id_rev">
                           <option value="0"<?php if (!(strcmp(0, $_GET['id_rev']))) {echo "selected=\"selected\"";} ?>>REVISION</option>
                           <?php  foreach($row_revision as $row_revision ) { ?>
                            <option value="<?php echo $row_revision['id_rev']?>"<?php if (!(strcmp($row_revision['id_rev'], $_GET['id_rev']))) {echo "selected=\"selected\"";} ?>><?php echo $row_revision['id_rev']?></option>
                          <?php } ?>
                        </select>
                        ...
                        <select class="busqueda selectsMini" name="fecha" id="fecha">
                          ...
                          <?php } ?>
                           ...
                           <input type="submit" name="Submit" value="FILTRO" onClick="if(consulta.id_rev.value=='0' && consulta.id_ref.value=='0' && consulta.fecha.value=='0') { alert('DEBE SELECCIONAR UNA OPCION'); }"/></td>
                    </tr>
                  </table>
                </form>
