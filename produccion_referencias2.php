...
if($id_c== '0' && $fecha == '0')
{
$query_caracteristicas = "SELECT * FROM Tbl_caracteristicas_valor, Tbl_caracteristicas WHERE Tbl_caracteristicas_valor.id_c_cv= Tbl_caracteristicas.id_c AND Tbl_caracteristicas_valor.b_borrado_cv='0' AND Tbl_caracteristicas_valor.id_proceso_cv='1' ORDER BY Tbl_caracteristicas_valor.fecha_registro_cv DESC";
}
//Filtra Tbl_caracteristicas lleno
if($id_c != '0' && $fecha == '0')
{
$query_caracteristicas = "SELECT * FROM Tbl_caracteristicas_valor, Tbl_caracteristicas WHERE Tbl_caracteristicas_valor.id_ref_cv='$id_c' AND Tbl_caracteristicas_valor.id_c_cv= Tbl_caracteristicas.id_c AND Tbl_caracteristicas_valor.b_borrado_cv='0' AND Tbl_caracteristicas_valor.id_proceso_cv='1' ORDER BY Tbl_caracteristicas_valor.cod_ref_cv DESC";
}
//Filtra fecha lleno
if($fecha != '0'  && $id_c == '0'  )
{
...
$fecha2 = $fecha + 1;
$fecha2 = "$fecha2-01-01";
$query_caracteristicas = "SELECT * FROM Tbl_caracteristicas_valor, Tbl_caracteristicas WHERE  Tbl_caracteristicas_valor.id_c_cv= Tbl_caracteristicas.id_c AND Tbl_caracteristicas_valor.fecha_registro_cv >= '$fecha1' and Tbl_caracteristicas_valor.fecha_registro_cv < '$fecha2' AND Tbl_caracteristicas_valor.b_borrado_cv='0' AND Tbl_caracteristicas_valor.id_proceso_cv='1' ORDER BY Tbl_caracteristicas_valor.cod_ref_cv DESC";
}
...
$fecha2 = $fecha + 1;
$fecha2 = "$fecha2-01-01";
$query_caracteristicas = "SELECT * FROM Tbl_caracteristicas_valor, Tbl_caracteristicas  WHERE Tbl_caracteristicas_valor.id_ref_cv='$id_c' and  Tbl_caracteristicas_valor.id_c_cv= Tbl_caracteristicas.id_c AND Tbl_caracteristicas_valor.fecha_registro_cv >= '$fecha1' and fecha_registro_cv < '$fecha2' AND Tbl_caracteristicas_valor.b_borrado_cv='0' AND Tbl_caracteristicas_valor.id_proceso_cv='1' ORDER BY Tbl_caracteristicas_valor.cod_ref_cv DESC";
}
...
mysql_select_db($database_conexion1, $conexion1);
$query_id_cv = "SELECT DISTINCT cod_ref_cv,id_ref_cv,b_borrado_cv FROM Tbl_caracteristicas_valor WHERE b_borrado_cv='0' AND id_proceso_cv='1' ORDER BY cod_ref_cv DESC";
