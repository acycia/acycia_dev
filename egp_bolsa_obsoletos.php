...
mysql_select_db($database_conexion1, $conexion1);
$query_egp = "SELECT * FROM egp WHERE estado_egp = 2 ORDER BY n_egp DESC";
...
<tr>
  ...
  <td colspan="3" id="fuente3"><a href="egp_bolsa.php"><img src="images/a.gif" alt="EGP'S ACTIVAS" border="0" style="cursor:hand;"></a><a href="egp_bolsa_add.php"><img src="images/mas.gif" alt="ADD EGP-BOLSA" border="0" style="cursor:hand;"></a><a href="egp_menu.php"><img src="images/opciones.gif" alt="MENU EGP'S" border="0" style="cursor:hand;"></a><a href="egp_bolsa_obsoletos.php"><img src="images/ciclo1.gif" alt="CARGAR LISTADO" border="0" style="cursor:hand;"/></a><a href="cotizacion_bolsa.php"><img src="images/c.gif" style="cursor:hand;" alt="COTIZACIONES" border="0"/></a></td>
  </tr>
<tr id="tr2">
  ...
  <td id="titulo4">REFERENCIA</td>
    ...
    <td id="dato2"><a href="egp_bolsa_vista.php?n_egp= <?php echo $row_egp['n_egp']; ?>&amp;pageNum_egp=<?php echo $_GET['pageNum_egp']; ?>&amp;totalRows_egp=<?php echo $_GET['totalRows_egp'];?>" target="_top" style="text-decoration:none; color:#000000"><?php $estado=$row_egp['estado_egp']; if($estado == '0') { echo "Pendiente"; } if($estado == '1') { echo "Aceptada"; } if($estado == '2') { echo "Obsoleta"; } ?></a></td>
    <td id="dato1">
	<?php
	$n_egp=$row_egp['n_egp'];
