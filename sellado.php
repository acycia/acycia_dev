...
mysql_select_db($database_conexion1, $conexion1);
$query_ver_sub_menu = sprintf("SELECT * FROM submenu,Tbl_submenu_submenu,Tbl_submenu_submenu2 WHERE submenu.id_submenu = '42' AND submenu.id_submenu=Tbl_submenu_submenu.id_sub_menu AND Tbl_submenu_submenu.id_submenu=Tbl_submenu_submenu2.id_submenu", $colname_ver_sub_menu);
           ...
           <div class="col-md-4">
            ...
            <div class="col-md-4">
              <strong>Responsable: </strong>Supervisor de producci&oacute;n - Coordinador de Calidad - Coordinador de Sellado. <br>
               <br>
             <strong>Participantes: </strong>Gerente de Unidad de Bolsas, Operarios, Auxiliares, Supervisor y Coordinador de Calidad.            </div>            
          </div>
