...
if($id_ref != '0')
{
$query_fichas_tecnicas = "SELECT * FROM TblCostoRef WHERE id_ref_cref='$id_ref' ORDER BY codigo_cref ASC";
}
...
<table id="tabla1">
  ...
  if($id == '0') { ?><div id="numero1"> <?php echo "NO HA SELECCIONADO"; ?> </div> <?php }?></td>
    <td id="dato3"><a href="javascript:location.reload()"><img src="images/ciclo1.gif" alt="RESTAURAR"title="RESTAURAR" border="0" style="cursor:hand;"/></a><a href="costo_referencia_add.php"><img src="images/mas.gif" alt="ADD COSTO REFERENCIA" title="ADD COSTO REFERENCIA" border="0" style="cursor:hand;" /></a><a href="ficha_tecnica.php"></a></td>
  </tr>  
  <tr id="tr1">
