...
$guardarCiudad = explode(".","$_POST[ciudad_c]");
//$guardarCiudad[0];
//$guardarCiudad[1];
...
$ciudad_c=$newciudad.' '.$_POST['ciudadexterno'];
//GUARDAR DATOS VALIDADOS SIN PUNTOS NO COMAS ETC
$nit_c = ereg_replace("[^A-Za-z0-9-]", "", $_POST['nit_c']);
...
$directorio = "archivosc/";
$nombre4 = str_replace(' ', '',  $_FILES['referencias_bancarias_c']['name']);
...
$directorio = "archivosc/";
$nombre5 = str_replace(' ', '',  $_FILES['referencias_comerciales_c']['name']);
...
$directorio = "archivosc/";
$nombre6 = str_replace(' ', '',  $_FILES['flujo_caja_proy_c']['name']);
...
$directorio = "archivosc/";
$nombre7 = str_replace(' ', '',  $_FILES['fotocopia_declar_iva_c']['name']);
...
/*					   GetSQLValueString(isset($_POST['bolsa_plastica_c']) ? "true" : "", "defined","1","0"),
                       ...
                       GetSQLValueString($imagen4, "text"),
                       GetSQLValueString($imagen5, "text"),
                       GetSQLValueString($imagen3, "text"),
                       GetSQLValueString($imagen2, "text"),
                       GetSQLValueString($imagen6, "text"),
                       GetSQLValueString($imagen7, "text"),
                       GetSQLValueString($imagen8, "text"),
...
for($n=0,$d=0,$i=0,$t=0,$e=0,$c=0;$n<count($nombre);$n++,$d++,$i++,$t++,$e++,$c++){
  $insertSQL2 = sprintf("UPDATE Tbl_Destinatarios SET nit=%s,nombre_responsable=%s,direccion=%s,indicativo=%s,telefono=%s,extension=%s,ciudad WHERE id_d=%s",                      
...
//INSERT PARA LA TABLA TBL_DESTINATARIOS
  ...
  $insertGoTo = "perfil_cliente_vista.php?id_c=" . $_POST["id_c"] . "&tipo_usuario=" . $_POST["tipo_usuario"] ."&nit_c=" . $_POST["nit_c"];
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div align="center">        
     <form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1" onSubmit="MM_validateForm('fecha_ingreso_c','','R','fecha_solicitud_c','','R','nombre_c','','R','nit_c','','R','tipo_c','','R','rep_legal_c','','R','telefono_c','','R','direccion_c','','R','pais_c','','R','registrado_c','','R');return document.MM_returnValue">
       <table width="114%" id="tabla_formato2">
         ...
         <tr>
           ...
           <td id="dato_1"><a href="listado_clientes.php"><img src="images/cat.gif" alt="LISTADO CLIENTES" border="0" style="cursor:hand;"><img src="images/ciclo1.gif" style="cursor:hand;" alt="RESTAURAR" onClick="window.history.go()" border="0"></a></td>
           <td id="dato_1">Fecha de Solicitud.</td>
         </tr>
         <tr>
           <td id="dato_1"><input name="fecha_ingreso_c" type="text" value="<?php echo $row_cliente['fecha_ingreso_c']; ?>" size="10"></td>
           <td id="dato_1">&nbsp;</td>
           <td id="dato_1"><input type="text" name="fecha_solicitud_c" value="<?php echo $row_cliente['fecha_solicitud_c']; ?>" size="10"></td>
         ...
         <tr>
           <td id="dato_1">
<input type="text" name="nit_c" value="<?php echo $row_cliente['nit_c']; ?>" size="30" onBlur="if (form1.nit_c.value) { DatosGestiones('1','nit_c',form1.nit_c.value); } else { alert('Debe digitar el NIT para validar su existencia en la BD'); }" onClick="desapareceClick(this);this.value = ''"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
           <td colspan="2" id="dato_1"><div id="resultado"></div></td>
         ...
         <tr>
           <td id="dato_1">&nbsp;</td>
           <td id="dato_1"><input name="nombre_c" type="text"onKeyUp="conMayusculas(this)" onClick="desapareceClick(this);this.value = ''"value="<?php echo $row_cliente['nombre_c']; ?>" size="30" maxlength="100"autocomplete='off'>		   </td>
           <td id="dato_1"><select name="tipo_c"onClick="ocultarCampo(this)"tag tabindex="1\" >
             <option value="">*</option>
         ...
         <tr>
           <td colspan="1" id="dato_1"><input name="rep_legal_c" type="text"onKeyUp="conMayusculas(this)" value="<?php echo $row_cliente['rep_legal_c']; ?>" size="50" maxlength="100"autocomplete='off'></td>
           <td colspan="1" id="detalle_1"><input type="text" name="indicativo1"value= ""id="indicativo1" size="1"onKeyUp="return ValNumero(this)"onClick="this.value = ''">
             <input type="text" name="telefono_c" value="<?php echo $row_cliente['telefono_c']; ?>" size="10"onKeyUp="return ValNumero(this)">
           <input type="text" name="extension1" id="extension1" size="1"onKeyUp="return ValNumero(this)" value=""></td>
           <td colspan="2" ><select  class='Estilo7'name="pais_c" id="id_pais">
             <?php
				do {  
				?>
...
/*	 //CONSULTA PAIS      	
    ...
    ?>
         ...
         <tr>
           <td id="dato_1"><input name="direccion_c" type="text"onKeyUp="conMayusculas(this)" value="<?php echo $row_cliente['direccion_c']; ?>" size="50" maxlength="150"autocomplete='off'></td>
...
/*		   mysql_select_db($database_conexion1, $conexion1);		  
		   ...
		   ?></td>
           <td colspan="2" id="dato_4"><select class='Estilo7'name="ciudad_c" id='miCampoDeTexto'onchange='Javascript:document.form1.indicativo1.value=this.value;
	 ...
	 do {  
	 ?>
             <option value="<?php echo $row_n_ciudad['ind_ciudad']?>______.<?php echo $row_n_ciudad['id_ciudad']?>"><?php echo $row_n_ciudad['nombre_ciudad']?></option>
     <?php
...
/*	 //CONSULTA CIUDADES     	
    ...
    ?>
         ...
         <tr>
           <td id="dato_1"><input id="email"type="text" name="email_comercial_c" value="<?php echo $row_cliente['email_comercial_c']; ?>" size="50"onKeyUp="conMayusculas(this)"onblur="MM_validateForm('email_comercial_c','','NisEmail');return document.MM_returnValue"autocomplete='off'></td>
           ...
           <input type="text" name="fax_c" value="<?php echo $row_cliente['fax_c']; ?>" size="10"onKeyUp="return ValNumero(this)">
           <input type="text" name="extension11" id="extension11" size="1"onKeyUp="return ValNumero(this)" value=""></td>
           <td colspan="2" id="dato_1"><input name="ciudadexterno"type="text"size="48"value="<?php echo $row_cliente['ciudad_c']; ?>" id="ciudadexterno" onKeyUp="conMayusculas(this)"onClick="this.value = ''"autocomplete='off'/></td>
         </tr>
         <tr>
           <td id="dato_1">&nbsp;</td>
         ...
         <tr>
           <td colspan="1" id="dato_1"><input name="contacto_c" type="text"onKeyUp="conMayusculas(this)" value="<?php echo $row_cliente['contacto_c']; ?>" size="50" maxlength="100"autocomplete='off'></td>
           <td id="dato_1"><input type="text" name="cargo_contacto_c" value="<?php echo $row_cliente['cargo_contacto_c']; ?>" size="30"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
           <td colspan="2" id="dato_1"><input type="text" name="email_contacto_bodega_c" value="<?php echo $row_cliente['email_contacto_bodega_c']; ?>" size="50"onKeyUp="conMayusculas(this)"onblur="MM_validateForm('email_comercial_c','','NisEmail');return document.MM_returnValue"autocomplete='off'></td>
         </tr>
         <tr>
         ...
         <tr>
           <td id="dato_1"><input name="direccion_envio_factura_c" type="text"onKeyUp="conMayusculas(this)" value="<?php echo $row_cliente['direccion_envio_factura_c']; ?>" size="50" maxlength="100"autocomplete='off'></td>
           <td id="detalle_1"><input type="text" name="indicativo3"value= ""id="indicativo3" size="1"onKeyUp="return ValNumero(this)"onClick="this.value = ''">
             <input type="text" name="telefono_envio_factura_c" value="<?php echo $row_cliente['telefono_envio_factura_c']; ?>" size="10"onKeyUp="return ValNumero(this)"autocomplete='off'>
           <input type="text" name="extension3" id="extension3" size="1"onKeyUp="return ValNumero(this)" value="" ></td>
           <td id="detalle_1"><input type="text" name="indicativo12"value= ""id="indicativo12" size="1"onKeyUp="return ValNumero(this)"onClick="this.value = ''">
             <input type="text" name="fax_envio_factura_c" value="<?php echo $row_cliente['fax_envio_fatura_c']; ?>" size="20"onKeyUp="return ValNumero(this)"autocomplete='off'>
         ...
         <tr>
           <td id="dato_1"><input type="text" name="celular_contacto_c" value="<?php echo $row_cliente['celular_contacto_c']; ?>" size="50"onKeyUp="return ValNumero(this)"autocomplete='off'></td>
           <td id="dato_1">&nbsp;</td>
           <td id="dato_1"><input type="hidden" name="fax_bodega_c" value="" size="30"onKeyUp="return ValNumero(this)">
             ...
             <input type="hidden" name="cargo_contacto_bodega_c" value="" size="20">
           <input type="hidden" name="email_contacto_bodega_c" value="" size="20"onChange="conMayusculas(this)"></td>
           <td id="dato_1">&nbsp;</td>        
         </tr>
         <tr>
         ...
         <tr>
           <td colspan="4" id="detalle_1"><textarea name="observ_inf_c" value=cols="100" rows="2"onKeyUp="conMayusculas(this)"><?php echo $row_cliente['observ_inf_c']; ?></textarea></td>
         </tr>
...
<tr>
 <td colspan="7" id="subtitulo2">INFORMACION DE DESPACHO BODEGAS</td>
  <tr>
    ...
    <td width="160" id="dato_1">&nbsp;</td>
    <td width="108" id="dato_1">&nbsp;</td>
    <td width="150" id="dato_1">&nbsp;</td>
    <td width="103" id="dato_1">&nbsp;</td>
    <td width="254"><input type="button" onClick="crear(this)"value="Agregar Bodegas" ></td>
  </tr>
  <tr>
 
<!--<td width="175" id="subtitulo3">NIT</td>-->
<td width="28" id="dato_1">&nbsp;</td>
<td width="259" id="dato_1">RESPONSABLE</td>
<td  width="160"id="dato_1">DIRECCION</td>
<td  width="108"id="dato_1">INDICATIVO</td>
<td  width="150"id="dato_1">TELEFONO</td>
<td width="103"id="dato_1">EXTENSION</td>
<td width="254"id="dato_1">CIUDAD</td>
  </tr>
  <tr>
    <td height="5" colspan="7" id="subtitulo1"><fieldset id="field"></fieldset> </td>
    </tr>     
</table>           </td> 
         ...
         <tr>
           <td id="dato_1"><input type="text" name="contacto_dpto_pagos_c" value="<?php echo $row_cliente['contacto_dpto_pagos_c']; ?>" size="50"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
           ...
           <input type="text" name="telefono_dpto_pagos_c" value="<?php echo $row_cliente['telefono_dpto_pagos_c']; ?>" size="10"onKeyUp="return ValNumero(this)">
           <input type="text" name="extension4" id="extension4" size="1"onKeyUp="return ValNumero(this)" value=""></td>
           <td colspan="2" id="dato_1"><input type="text" name="email_dpto_pagos_c" value="<?php echo $row_cliente['email_dpto_pagos_c']; ?>" size="50"onKeyUp="conMayusculas(this)"onblur="MM_validateForm('email_dpto_pagos_c','','NisEmail');return document.MM_returnValue"autocomplete='off'></td>
         </tr>
         <tr>
         ...
         <tr>
           <td id="dato_1"><input type="text" name="direccion_dpto_pagos_c" value="<?php echo $row_cliente['direccion_dpto_pagos_c']; ?>" size="50"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
           <td id="detalle_1"><input type="text" name="indicativo13"value= ""id="indicativo13" size="1"onKeyUp="return ValNumero(this)"onClick="this.value = ''">
             <input type="text" name="fax_dpto_pagos_c" value="<?php echo $row_cliente['telefono_dpto_pagos_c']; ?>" size="10"onKeyUp="return ValNumero(this)">
           <input type="text" name="extension13" id="extension13" size="1"onKeyUp="return ValNumero(this)" value=""></td>
           <td id="dato_1"><input type="text" name="cupo_solicitado_c" value="<?php echo $row_cliente['cupo_solicitado_c']; ?>" size="30"onKeyUp="return ValNumero(this)"autocomplete='off'></td>
           <td id="dato_1">&nbsp;</td>           
         </tr>
         <tr>
...
Forma de Pago </td>
           ...
           <input type="text" name="otro_pago_c" value="<?php echo $row_cliente['otro_pago_c']; ?>" size="30"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
           <td id="dato_1">&nbsp;</td>
           <td id="dato_1">&nbsp;</td>          
         </tr>
         <tr>
           <td colspan="4"><table width="100%" id="tabla_formato">
               ...
               <tr>
                 <td id="detalle_1"><input type="text" name="ref_comercial_c" value="<?php echo $row_cliente['1ref_comercial_c']; ?>" size="30"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
                 ...
                 <td id="detalle_1"><input type="text" name="tel_1ref_comercial_c" value="" size="15"onKeyUp="return ValNumero(this)"autocomplete='off'></td>
                 <td id="detalle_1"><input type="text" name="extension5" id="extension5" size="5"onKeyUp="return ValNumero(this)" value="" ></td>
                 <td id="detalle_1"><input type="text" name="cupo_1ref_comercial_c" value="" size="20"autocomplete='off'></td>
               ...
               <tr>
                 <td id="detalle_1"><input type="text" name="ref_comercial_c2" value="" size="30"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
                 ...
                 <td id="detalle_1"><input type="text" name="tel_2ref_comercial_c" value="" size="15"onKeyUp="return ValNumero(this)"autocomplete='off'></td>
                 <td id="detalle_1"><input type="text" name="extension6" id="extension6" size="5"onKeyUp="return ValNumero(this)" value="" ></td>
                 <td id="detalle_1"><input type="text" name="cupo_2ref_comercial_c" value="" size="20"autocomplete='off'></td>
               ...
               <tr>
                 <td id="detalle_1"><input type="text" name="ref_comercial_c3" value="" size="30"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
                 ...
                 <td id="detalle_1"><input type="text" name="tel_3ref_comercial_c" value="" size="15"onKeyUp="return ValNumero(this)"autocomplete='off'></td>
                 <td id="detalle_1"><input type="text" name="extension7" id="extension7" size="5"onKeyUp="return ValNumero(this)" value=""></td>
                 <td id="detalle_1"><input type="text" name="cupo_3ref_comercial_c" value="" size="20"autocomplete='off'></td>
  ...
  <tr>
    <td id="detalle_1"><input type="text" name="ref_bancaria_c" value="" size="30"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
    ...
    <td id="detalle_1"><input type="text" name="telefono_1ref_bancaria_c" value="" size="15"onKeyUp="return ValNumero(this)"autocomplete='off'></td>
    <td id="detalle_1"><input type="text" name="extension8" id="extension8" size="5"onKeyUp="return ValNumero(this)" value="" ></td>
    <td id="detalle_1"><input type="text" name="nombre_1ref_bancaria_c" value="" size="45"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
  </tr>
  <tr>
    <td id="detalle_1"><input type="text" name="ref_bancaria_c2" value="" size="30"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
    ...
    <td id="detalle_1"><input type="text" name="telefono_2ref_bancaria_c" value="" size="15"onKeyUp="return ValNumero(this)"autocomplete='off'></td>
    <td id="detalle_1"><input type="text" name="extension9" id="extension9" size="5"onKeyUp="return ValNumero(this)" value=""></td>
    <td id="detalle_1"><input type="text" name="nombre_2ref_bancaria_c" value="" size="45"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
  </tr>
  <tr>
    <td id="detalle_1"><input type="text" name="ref_bancaria_c3" value="" size="30"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
    ...
    <td id="detalle_1"><input type="text" name="telefono_3ref_bancaria_c" value="" size="15"onKeyUp="return ValNumero(this)"autocomplete='off'></td>
    <td id="detalle_1"><input type="text" name="extension10" id="extension10" size="5"onKeyUp="return ValNumero(this)" value=""></td>
    <td id="detalle_1"><input type="text" name="nombre_3ref_bancaria_c" value="" size="45"onKeyUp="conMayusculas(this)"autocomplete='off'></td>
               </tr>
           </table></td>
         </tr>
  ...
  <tr>
    <td colspan="4" id="detalle_1"><textarea name="observ_inf_finan_c" cols="100" rows="2"onKeyUp="conMayusculas(this)"></textarea></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="4"id="dato_1"onkeyUp="return ValNumero(this)"><input type="text" name="cupo_aprobado_c" value="" size="30"onkeyUp="return ValNumero(this)"autocomplete='off'>
  ...
  <tr>
    <td colspan="4"id="detalle_1"><textarea name="observ_aprob_finan_c" cols="100" rows="3"onKeyUp="conMayusculas(this)"></textarea></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="4" id="detalle_1"><textarea name="observ_asesor_com_c" cols="100" rows="2"onKeyUp="conMayusculas(this)"></textarea></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="4" id="detalle_1"><textarea name="observ_doc_c" cols="100" rows="2"onKeyUp="conMayusculas(this)"></textarea></td>
  </tr>
  <tr>
    <td colspan="4" id="subtitulo2">INFORMACION FINAL DEL FORMATO PERFIL DE CLIENTES </td>
  </tr>
  <tr>
    <td id="dato_1"><input name="tipo_usuario" type="hidden" id="tipo_usuario" value="<?php echo $row_usuario['tipo_usuario']; ?>">
    ...
    <td colspan="3" id="dato_1">Registrado Por
      <input name="registrado_c" type="text" value="<?php echo $row_usuario['nombre_usuario']; ?>" size="20"readonly></td>
  </tr>
  <tr>
