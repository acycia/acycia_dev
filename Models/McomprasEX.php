...
class oComprasEX{
    ...
    { 
        ...
        try 
        {
                ...
                $consulta=$this->db->query("SELECT * FROM $tabla WHERE factura = '". $arrayPHP['factura'] ."' AND proceso= '". $arrayPHP['proceso'] ."' ");
                 while($filas=$consulta->fetch_assoc()){
                    $this->existe[]=$filas;
                 }
                ...
                if(is_null($this->existe)){ 
                  ...
                  $stmt = $this->db->query("INSERT INTO $tabla ($columna) VALUES ( '". $arrayPHP['factura'] ."','". $arrayPHP['proceso'] ."','". $arrayPHP['proveedor'] ."','". $arrayPHP['fecha'] ."', '". $arrayPHP['tipopedido'] ."','". $arrayPHP['bl'] ."','". $arrayPHP['fecha_factura'] ."','". $arrayPHP['dex'] ."','". $arrayPHP['fecha_dex'] ."','". $arrayPHP['pago'] ."','". $arrayPHP['fecha_pago'] ."','". $arrayPHP['fleteseguro'] ."', '". $arrayPHP['comentarios'] ."', '". $arrayPHP['valor_fact'] ."', '". $arrayPHP['adjunto'] ."','". $arrayPHP['usuario'] ."','". $arrayPHP['estado'] ."' );");
                }
    ...
    { 
        ...
        try 
        {
             ...
             for ($d=0,$e=0,$f=0,$g=0,$h=0,$i=0,$j=0,$k=0,$l=0,$n=0;$d<count($cantidad);$d++,$e++,$f++,$g++,$h++,$i++,$j++,$k++,$l++,$n++){
    ...
    public function Eliminar($id)
    {
        try 
        {
            $stm = $this->db->query("DELETE FROM tbl_proceso_compras_detalle WHERE pedido = '$id' ");                      
