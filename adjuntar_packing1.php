...
if (isset($_GET['id_verif_p'])) {
  $colname_ver_nuevo = (get_magic_quotes_gpc()) ? $_GET['id_verif_p'] : addslashes($_GET['id_verif_p']);
}
mysql_select_db($database_conexion1, $conexion1);
$query_ver_nuevo = sprintf("SELECT * FROM Tbl_verificacion_packing WHERE id_verif_p = %s", $colname_ver_nuevo);
...
<li><a href="referencias_p.php">REFERENCIAS</a></li>
</ul>
<div id="nombreusuario"><?php echo $row_usuario_comercial['nombre_usuario']; ?></div>
  ...
  <tr>
    <td align="center">
	<form action="adjuntar_packing2.php" method="post" enctype="multipart/form-data">
	<div align="center">
	<table width="50%">
      <tr id="tr1">
...
- <?php echo $row_referencia['version_ref']; ?></td>
        <td id="dato2"><?php echo $row_ver_nuevo['id_verif_p']; ?>
          <input name="id_verif_p" type="hidden" id="id_verif_p" value="<?php echo $_GET['id_verif_p']; ?>" /></td>
      </tr>
      <tr id="tr1">
      ...
      <tr id="tr3">
        <td id="dato2"><input name="arte" type="hidden" id="arte" value="<?php echo $row_ver_nuevo['userfile_p']; ?>" />
          <?php echo $row_ver_nuevo['userfile_p']; ?></td>
        <td id="dato2"><?php echo $row_ver_nuevo['version_ref_verif_p']; ?></td>
      </tr>
      <tr id="tr1">
      ...
      <tr id="tr3">
        <td id="dato2"><select name="estado_arte_verif_p">
          <option value="0" <?php if (!(strcmp(0, $row_ver_nuevo['estado_arte_verif_p']))) {echo "selected=\"selected\"";} ?>>Pendiente</option>
          <option value="1" <?php if (!(strcmp(1, $row_ver_nuevo['estado_arte_verif_p']))) {echo "selected=\"selected\"";} ?>>Rechazado</option>
          <option value="2" <?php if (!(strcmp(2, $row_ver_nuevo['estado_arte_verif_p']))) {echo "selected=\"selected\"";} ?>>Aceptado</option>
          <option value="3" <?php if (!(strcmp(3, $row_ver_nuevo['estado_arte_verif_p']))) {echo "selected=\"selected\"";} ?>>Anulado</option>
        </select></td>
        <td id="dato2">DD/MM/AA
          <input name="fecha_aprob_arte_verif_p" type="date" value="<?php echo $row_ver_nuevo['fecha_aprob_arte_verif_p']; ?>" size="10" /></td>
      </tr>
      <tr id="tr1">
      ...
      <tr id="tr3">
        <td colspan="2" id="dato2"><input type="hidden" name="MAX_FILE_SIZE" value="10485770" />
          <input name="userfile_p" type="file" size="40" /></td>
        </tr>
      <tr id="tr3">
  ...
  <tr>
    <td id="dato2"><a href="verificacion_packing_vista.php?id_verif_p=<?php echo $row_ver_nuevo['id_verif_p']; ?>"><img src="images/hoja.gif" alt="VISTA IMPRESION" title="IMPRESION" border="0" style="cursor:hand;" /></a><a href="verificacion_packing_edit.php?id_verif_p=<?php echo $row_ver_nuevo['id_verif_p']; ?>"><img src="images/menos.gif" alt="EDITAR VERIFICACION" title="EDITAR VERIFICACION" border="0" style="cursor:hand;" /></a><a href="verificacion_referencia_packing.php?id_ref=<?php echo $row_ver_nuevo['id_ref_verif_p']; ?>"><img src="images/v.gif" alt="VERIFICACION X REF" title="VIRIFICACION X REF" border="0" style="cursor:hand;" /></a><a href="verificacion_p.php"><img src="images/identico.gif" alt="LISTADO DE VERIFICACIONES" title="LISTADO DE VERIFICACIONES" border="0" style="cursor:hand;" /></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
