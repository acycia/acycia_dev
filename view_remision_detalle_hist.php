        ...
        <table id="tabla2">
          ...
          <tr>
            ...
            <td id="dato1"><strong>Facturar:</strong>
              <select name="b_estado_io" id="opciones" disabled="disabled" >
              ...
              <select name="estado_rd" id="estado_rd" disabled="disabled">
      ...
      <?php if (($row_remision_detalle['id_rd']!='')) { ?>
       ...
       <?php do { ?>
                <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF"> 
                  ...
                  <td id="talla2"><?php echo $row_remision_detalle['int_ref_io_rd']; ?>
      </td>
