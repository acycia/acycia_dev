...
mysql_select_db($database_conexion1, $conexion1);
$codigobolsa = $_GET['codigobolsa'];
$nombre_bolsa = $_GET['nombre_bolsa'];
$id_ref_bolsa = $_GET['id_ref_bolsa'];
if($codigobolsa == '0' && $nombre_bolsa == '0' && $id_ref_bolsa == '0')
{
$query_bolsa = "SELECT * FROM material_terminado_bolsas ORDER BY nombre_bolsa ASC";
}
if($codigobolsa != '0' && $nombre_bolsa == '0' && $id_ref_bolsa == '0')
{
$query_bolsa = "SELECT * FROM material_terminado_bolsas WHERE id_bolsa='$codigobolsa'";
}
if($codigobolsa == '0' && $nombre_bolsa != '0' && $id_ref_bolsa == '0')
{
$query_bolsa = "SELECT * FROM material_terminado_bolsas WHERE id_bolsa='$nombre_bolsa'";
}
if($codigobolsa == '0' && $nombre_bolsa == '0' && $id_ref_bolsa != '0')
{
$query_bolsa = "SELECT * FROM material_terminado_bolsas WHERE id_ref_bolsa='$id_ref_bolsa'";
}
