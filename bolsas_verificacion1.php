...
//$query_bolsa_verificacion = "SELECT * FROM verificacion_bolsas ORDER BY n_vb DESC";
}
/*FILTRA OC*/
if($n_ocb != '0' && $id_p == '0' && $id_bolsa == '0' && $id_ref == '0' && $fecha == '0')
{
  $row_bolsa_verificacion = $conexion->buscarListar("verificacion_bolsas","*","ORDER BY n_vb DESC","",$maxRows_bolsa_verificacion,$pageNum_bolsa_verificacion,"WHERE n_ocb_vb='$n_ocb'" );
//$query_bolsa_verificacion = "SELECT * FROM verificacion_bolsas WHERE n_ocb_vb='$n_ocb' ORDER BY n_vb DESC";
}
/*FILTRA PROVEEDOR*/
if($n_ocb == '0' && $id_p != '0' && $id_bolsa == '0' && $id_ref == '0' && $fecha == '0')
{

  $row_bolsa_verificacion = $conexion->buscarListar("verificacion_bolsas","*","ORDER BY n_vb DESC","",$maxRows_bolsa_verificacion,$pageNum_bolsa_verificacion,"WHERE id_p_vb='$id_p'" );
//$query_bolsa_verificacion = "SELECT * FROM verificacion_bolsas WHERE id_p_vb='$id_p' ORDER BY n_vb DESC";
}
/*FILTRA ROLLO*/
if($n_ocb == '0' && $id_p == '0' && $id_bolsa != '0' && $id_ref == '0' && $fecha == '0')
{
  $row_bolsa_verificacion = $conexion->buscarListar("verificacion_bolsas","*","ORDER BY n_vb DESC","",$maxRows_bolsa_verificacion,$pageNum_bolsa_verificacion,"WHERE id_bolsa_vb='$id_bolsa'" );
//$query_bolsa_verificacion = "SELECT * FROM verificacion_bolsas WHERE id_bolsa_vb='$id_bolsa' ORDER BY n_vb DESC";
}
/*FILTRA REFERENCIA*/
if($n_ocb == '0' && $id_p == '0' && $id_bolsa == '0' && $id_ref != '0' && $fecha == '0')
{
  $row_bolsa_verificacion = $conexion->buscarListar("verificacion_bolsas","*","ORDER BY n_vb DESC","",$maxRows_bolsa_verificacion,$pageNum_bolsa_verificacion,"WHERE id_ref_vb='$id_ref'" );
//$query_bolsa_verificacion = "SELECT * FROM verificacion_bolsas WHERE id_ref_vb='$id_ref' ORDER BY n_vb DESC";
}
/*FILTRA FECHA*/
if($n_ocb == '0' && $id_p == '0' && $id_bolsa == '0' && $id_ref == '0' && $fecha != '0')
{
...
$fecha2 = $fecha + 1;
$fecha2 = "$fecha2-01-01";
$row_bolsa_verificacion = $conexion->buscarListar("verificacion_bolsas","*","ORDER BY n_vb DESC","",$maxRows_bolsa_verificacion,$pageNum_bolsa_verificacion,"WHERE fecha_recibido_vb >= '$fecha1' AND fecha_recibido_vb < '$fecha2'" );
//$query_bolsa_verificacion = "SELECT * FROM verificacion_bolsas WHERE fecha_recibido_vb >= '$fecha1' AND fecha_recibido_vb < '$fecha2' ORDER BY n_vb DESC";
}
 
if (isset($_GET['totalRows_bolsa_verificacion'])) {
  $totalRows_bolsa_verificacion = $_GET['totalRows_bolsa_verificacion'];
} else {
  $totalRows_bolsa_verificacion = $conexion->conteo('verificacion_bolsas');
} 
                ...
                <form action="delete_listado.php" method="get" name="seleccion">
                  <table class="table table-bordered table-sm">
                    ...
                    <table border="0" width="50%" align="center">
                       <tr>
                         <td width="23%" id="dato2"><?php if ($pageNum_bolsa_verificacion > 0) { // Show if not first page ?>
                           <a href="<?php printf("%s?pageNum_bolsa_verificacion=%d%s", $currentPage, 0, $queryString_bolsa_verificacion); ?>">Primero</a>
                         <?php } // Show if not first page ?>
                       </td>
                       <td width="31%" id="dato2"><?php if ($pageNum_bolsa_verificacion > 0) { // Show if not first page ?>
                     ...
                     <td width="23%" id="dato2"><?php if ($pageNum_bolsa_verificacion < $totalPages_bolsa_verificacion) { // Show if not last page ?>
