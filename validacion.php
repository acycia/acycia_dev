   ...
   <tr>
     <td colspan="3" id="fuente2">
      <select name="id_val" id="id_val">
        ...
        do {  
          ?>
          <option value="<?php echo $row_validaciones['id_val']?>"><?php echo $row_validaciones['id_val']?></option>
          <?php
  ...
  <table class="table table-bordered table-sm">
    <tr>
      ...
      <?php do { ?>
       ...
       <td id="dato1"><a href="validacion_vista.php?id_val= <?php echo $row_validacion['id_val']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php $cad2 = htmlentities( $row_validacion['actualizado_val']);echo $cad2 ?></a></td>
     </tr>
