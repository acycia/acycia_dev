...
mysql_select_db($database_conexion1, $conexion1);
$query_vista_paquete = sprintf("SELECT int_op_tn, int_caja_tn, int_caja_tn, fecha_ingreso_tn,hora_tn, int_desde_tn, int_undxcaja_tn, int_cod_empleado_tn FROM Tbl_tiquete_numeracion WHERE int_op_tn=%s AND int_caja_tn=%s ORDER BY int_paquete_tn ASC LIMIT 1", $colname_op, $colname_p);
...
echo $caja; ?></p>
                            ...
                            <b>FECHA: </b><?php echo $row_vista_paquete['fecha_ingreso_tn']; ?> /<?php echo $row_vista_paquete['hora_tn']; ?></div>
                        <div class="col-md-6">
