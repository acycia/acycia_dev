...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO TblProcesoAjuste (id_pa, id_proceso_pa, valor_pa, fechaInicial_pa, fechaFinal_pa) VALUES (%s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "proceso_ajuste_listado.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion1, $conexion1);
$query_ultimo = "SELECT * FROM TblProcesoAjuste ORDER BY id_pa DESC";
    ...
    <td colspan="2" align="center" id="linea1">
      <form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="return envioFormAjusteProceso();">
        <table align="center" id="tabla35">
          ...
          <tr>
            <td colspan="2" id="titulo2">ADICIONE EL AJUSTE DE EXPORTACION
            <?php $num1=$row_ultimo['id_pa']; $num2=$num1+1; ?>
              <input name="id_pa" type="hidden" id="id_pa" value="<?php echo $num2 ?>"></td>
            </tr>
          <tr>
          ...
          <tr>
			...
			do {  
			?>
              <option value="<?php echo $row_lista_procesos['id_tipo_proceso']?>"><?php echo $row_lista_procesos['nombre_proceso']?></option>
              <?php
          ...
          <tr>
            ...
            <td id="fuente1"><input name="valor_pa" type="number" id="valor_pa" min="0" step="0.01"  required value="" style="width:150px" onClick="envioFormAjusteProceso();"></td>
          </tr>
          <tr>
            <td id="fuente1">FECHA INICIAL</td>
            <td id="fuente1"><input name="fechaInicial_pa" type="date" required id="fecha1" min="2000-01-02" value="<?php echo fecha();?>" size="10" /></td>
          </tr>
          <tr>
            <td id="fuente1">FECHA FINAL</td>
            <td id="fuente1"><input name="fechaFinal_pa" type="date" required id="fecha2" min="2000-01-02" value="<?php echo sumarMes();?>" size="10" onBlur="validar()"/></td>
          </tr>
          <tr>
            <td colspan="2">&nbsp;</td>
            </tr>
