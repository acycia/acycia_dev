   ...
   <tr>
     <td colspan="3" id="fuente2">
      <select name="id_val_l" id="id_val_l">
        ...
        do {  
          ?>
          <option value="<?php echo $row_validaciones['id_val_l']?>"><?php echo $row_validaciones['id_val_l']?></option>
          <?php
  ...
  <table class="table table-bordered table-sm">
    <tr>
      ...
      <?php do { ?>
       ...
       <td id="dato1"><a href="validacion_lamina_vista.php?id_val_l=<?php echo $row_validacion['id_val_l']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php $cad2 = htmlentities( $row_validacion['responsable_edit_val_l']);echo $cad2 ?></a></td>
     </tr>
