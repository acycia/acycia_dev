...
mysql_select_db($database_conexion1, $conexion1);
$query_ver_sub_menu = "SELECT * FROM submenu WHERE id_menu_submenu = '10'";
        ...
        <div class="row">
         ...
         <div class="row">
           <div class="col-md-4">
            ...
            <div class="col-md-4">
                  <strong>Nombre: </strong>GESTION DE RECURSOS HUMANOS.<br><br>
                  El sistema administrador de gestiones (SISADGE) de ALBERTO CADAVID R & C&Iacute;A S.A. es un desarrollo gen&eacute;rico que especifica el Sistema de Gesti&oacute;n de Calidad en nuestra organizaci&oacute;n. <br>
                  El proposito fundamental de este desarrollo es seguir paso a paso la metodologia del sistema de Gesti&oacute;n de Calidad para la linea comercial, de dise&ntilde;o, producci&oacute;n y comercializaci&oacute;n de bolsas de seguridad para el empaque y transporte de valores.<br><br>
		  <strong> </strong><br><br>
            </div>
            <div class="col-md-4">
			   <strong> </strong><br><br>
