...
if($var1!= '')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM Tbl_reg_produccion WHERE id_op_rp='$var1' AND id_proceso_rp='4' GROUP BY id_op_rp DESC";
}
//FILTRA REF LLENO
if($var2 != '')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM Tbl_reg_produccion WHERE int_cod_ref_rp = '$var2' AND id_proceso_rp='4' GROUP BY id_op_rp DESC";
}
//FILTRA MES LLENO
if($var3 != '')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM Tbl_reg_produccion WHERE MONTH(fecha_ini_rp)='$var3' AND id_proceso_rp='4' GROUP BY id_op_rp DESC";
}*/
//FILTRA OP LLENO
if($var1 != '0' && $var2 == '0' && $var3 == '0' && $anyo == '0')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM tbl_reg_produccion WHERE id_op_rp='$var1' AND id_proceso_rp='4' GROUP BY id_op_rp DESC ORDER BY id_op_rp DESC";
}
//FILTRA OP, AÑO LLENO
if($var1 != '0' && $var2 == '0' && $var3 == '0' && $anyo != '0')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM tbl_reg_produccion WHERE id_op_rp='$var1' AND YEAR(fecha_ini_rp)='$anyo' AND id_proceso_rp='4' GROUP BY id_op_rp DESC ORDER BY id_op_rp DESC";
}
//FILTRA OP, MES LLENO
if($var1 != '0' && $var2 == '0' && $var3 != '0' && $anyo == '0')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM tbl_reg_produccion WHERE id_op_rp='$var1' AND MONTH(fecha_ini_rp)='$var3' AND id_proceso_rp='4' GROUP BY id_op_rp DESC ORDER BY id_op_rp DESC";
}
//FILTRA OP, AÑO, MES LLENO
if($var1 != '0' && $var2 == '0' && $var3 != '0' && $anyo != '0')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM tbl_reg_produccion WHERE id_op_rp='$var1' AND YEAR(fecha_ini_rp)='$anyo' AND MONTH(fecha_ini_rp)='$var3' AND id_proceso_rp='4' GROUP BY id_op_rp DESC ORDER BY id_op_rp DESC";
}
//FILTRA REF LLENO
if($var1 == '0' && $var2 != '0' && $var3 == '0' && $anyo == '0')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM tbl_reg_produccion WHERE int_cod_ref_rp='$var2' AND id_proceso_rp='4' GROUP BY id_op_rp DESC ORDER BY id_op_rp DESC";
}
//FILTRA REF, AÑO LLENO
if($var1 == '0' && $var2 != '0' && $var3 == '0' && $anyo != '0')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM tbl_reg_produccion WHERE int_cod_ref_rp='$var2' AND YEAR(fecha_ini_rp)='$anyo' AND id_proceso_rp='4' GROUP BY id_op_rp DESC ORDER BY id_op_rp DESC";
}
//FILTRA REF, MES LLENO
if($var1 == '0' && $var2 != '0' && $var3 != '0' && $anyo == '0')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM tbl_reg_produccion WHERE int_cod_ref_rp='$var2' AND MONTH(fecha_ini_rp)='$var3' AND id_proceso_rp='4' GROUP BY id_op_rp DESC ORDER BY id_op_rp DESC";
}
//FILTRA REF, AÑO, MES LLENO
if($var1 == '0' && $var2 != '0' && $var3 != '0' && $anyo != '0')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM tbl_reg_produccion WHERE int_cod_ref_rp='$var2' AND YEAR(fecha_ini_rp)='$anyo' AND MONTH(fecha_ini_rp)='$var3' AND id_proceso_rp='4' GROUP BY id_op_rp DESC ORDER BY id_op_rp DESC";
}
//FILTRA AÑO
if($var1 == '0' && $var2 == '0' && $var3 == '0' && $anyo != '0')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM tbl_reg_produccion WHERE YEAR(fecha_ini_rp)='$anyo' AND id_proceso_rp='4' GROUP BY id_op_rp DESC ORDER BY id_op_rp DESC";
}
//FILTRA MES AÑO
if($var1 == '0' && $var2 == '0' && $var3 != '0' && $anyo != '0')
{
$query_orden_produccion = "SELECT *, COUNT(DISTINCT rollo_rp) as rollos, SUM(`int_kilos_prod_rp`) as kilos FROM tbl_reg_produccion WHERE YEAR(fecha_ini_rp)='$anyo' AND MONTH(fecha_ini_rp)='$var3' AND id_proceso_rp='4' GROUP BY id_op_rp DESC ORDER BY id_op_rp DESC";
}
                ...
                <tr>
                  <td colspan="6" id="fuente2">
                    <select name="op" id="op" class="busqueda selectsMini">
                      <option value="0"<?php if (!(strcmp("", $var1))) {echo "selected=\"selected\"";} ?>>O.P.</option>
                      <?php
                      do {  
                        ?>
                        <option value="<?php echo $row_lista_op['id_op']?>"<?php if (!(strcmp($row_lista_op['id_op'], $var1))) {echo "selected=\"selected\"";} ?>><?php echo $row_lista_op['id_op']?></option>
                        <?php
                    ...
                    <select name="id_ref" id="id_ref" class="busqueda selectsMini">
                      <option value="0"<?php if (!(strcmp("", $var2))) {echo "selected=\"selected\"";} ?>>REF</option>
                      <?php
                      do {  
                        ?>
                        <option value="<?php echo $row_ref_op['cod_ref']?>"<?php if (!(strcmp($row_ref_op['cod_ref'], $var2))) {echo "selected=\"selected\"";} ?>>
...
if($cant_kilo_imp!=''){
  ...
  { ?> <div id="numero1"><strong><?php echo $row_orden_produccion['kilos'] ; ?></strong></div><?php }else{ echo $row_orden_produccion['kilos'];}
}else{echo $row_orden_produccion['kilos'];}
?></td>
...
<td id="dato2">
 <?php  
 $op_c=$row_orden_produccion['id_op_rp'];
 $sqlno="SELECT COUNT(DISTINCT rollo_r) AS rols FROM TblSelladoRollo WHERE id_op_r='$op_c'"; 
 $resultno=mysql_query($sqlno); 
 $numno=mysql_num_rows($resultno);
 if($numno > '0') 
  { $rolloS=mysql_result($resultno,0,'rols');}else{ echo '0';}    
...
if($numnE > '0') 
  { $rolloE=mysql_result($resultnE,0,'role');}else{ echo '0';}  
