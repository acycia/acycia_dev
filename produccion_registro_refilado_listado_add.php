...
mysql_select_db($database_conexion1, $conexion1);
$query_orden_produccion = "SELECT * FROM TblRefiladoRollo ORDER BY id_op_r DESC";
...
<tr>
  ...
  <tr>
    <td colspan="3" id="dato1"><p><img src="images/extruir.gif" width="20" height="20" alt="O.P IMPRESA"title="O.P IMPRESA" border="0" style="cursor:hand;"/> significa que la o.p esta en proceso de extrusion</p>
      <p><img src="images/refilado.gif" width="20" height="17" alt="O.P EXTRUIDA"title="O.P EXTRUIDA" border="0" style="cursor:hand;"/> significa que la o.p esta en proceso de Refilado</p>
      <p>&nbsp;</p></td>
