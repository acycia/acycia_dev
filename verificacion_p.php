   ...
   <tr>
     <td colspan="3" id="fuente2">
      <select name="id_verif_p" id="id_verif_p">
        ...
        do {  
          ?>
          <option value="<?php echo $row_verificacion['id_verif_p']?>"><?php echo $row_verificacion['id_verif_p']?></option>
          <?php
      ...
      <select name="arte" id="arte">
       ...
       do {  
        ?>
        <option value="<?php echo $row_artes['userfile_p']?>"><?php echo $row_artes['userfile_p']?></option>
        <?php
...
<form action="delete_listado.php" method="get" name="seleccion">
  <table id="tabla1">
    <tr>
     ...
     if($numcm >='1')
     { 
       $cm = mysql_result($resultcm, 0, 'id_cm'); ?><a href="control_modif_p_edit.php?id_cm=<?php echo $cm; ?>"><img src="images/m.gif" alt="EDIT MODIFICACION" title="MODIFICACION" border="0" style="cursor:hand;"/></a><?php } ?></td>
     </tr>
