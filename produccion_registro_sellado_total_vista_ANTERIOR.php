...
<div align="center">
  <table id="tablainterna">
    ...
    <tr>
      <td colspan="3" rowspan="6" id="fondo"><img src="images/logoacyc.jpg"/></td>
      <td colspan="3" id="fuente3"><a href="produccion_sellado_listado_rollos.php?id_op_r=<?php echo  $_GET['id_op'] ?>"><img src="images/completo.gif" style="cursor:hand;" alt="ESTIQUER" title="ESTIQUER" border="0"/></a><a href="menu.php"><img src="images/impresor.gif" onClick="window.print();" style="cursor:hand;" alt="IMPRIMIR" title="IMPRIMIR" /></a><a href="javascript:location.reload()"><img src="images/ciclo1.gif" alt="RESTAURAR"title="RESTAURAR" border="0" style="cursor:hand;"/></a></td>
      <td colspan="5" id="fuente3"><strong>ESTADO O.P:</strong>
    ...
    <tr>
      <td colspan="5" id="subppal2">RESPONSABLE</td>
      <td colspan="3" id="subppal2">TURNOS</td>
    </tr>
    <tr>
      <td colspan="5"id="fuente2"><?php echo $row_sellado_vista['str_responsable_rp']; ?></td>
      <td nowrap colspan="3"id="fuente2"><a href="javascript:popUp('produccion_sellado_stiker_rollo_add.php?id_op_r=<?php echo $_GET['id_op']; ?>','1000','600')"><em>ver turnos</em></a></td>
    </tr>
    <tr>
    ...
    <tr>
      <?php 	 
	    ...
	    $resultOpmes = mysql_query("SELECT  `rollo_r`,  `cod_empleado_r`,`cod_auxiliar_r`, `turno_r`, DATE_FORMAT(MIN(`fechaI_r`), '%k.%i.%s') AS TIEMPOINI, DATE_FORMAT(MAX(`fechaF_r`),'%k.%i.%s') AS TIEMPOFIN, TIMEDIFF(MAX(`fechaF_r`), MIN(`fechaI_r`)) AS TIEMPODIFE, SUM(`kilos_r`) AS KILOS, SUM(reproceso_r) AS reproceso, SUM(`bolsas_r`) AS BOLSAS FROM `TblSelladoRollo` WHERE `id_op_r`= '$horasOpmes' GROUP BY `fechaI_r`,`cod_empleado_r`,`cod_auxiliar_r` ASC");
    ...
    <tr>
      ...
      <td id="fuente3" ><?php echo $totalreproceso;?></td>
      <td colspan="2" id="detalle3" >Totales:</td>
      <td id="fuente3" ><?php echo $totaltiem;?></td>
      <td id="fuente3" ><?php echo $totalbolsas;?></td>
    </tr>
    <tr>
      <td colspan="9" id="subppal2">Tiempos y Desperdicios</td>
    </tr>
    <tr>
      <td colspan="9" id="fuente2"><table border="0" id="tablainterna">
		...
		?></td>
          ...
          <tr>
           <!-- <td nowrap id="subppal2"><strong>Rollo N&deg;</strong></td>-->
            ...
            <td colspan="4" nowrap id="subppal2"><strong>Cantidad  Utilizados</strong></td>
          </tr>
            <tr>
		...
		{ 
		 echo $descripcion_insumo = mysql_result($resultrkp, 0, 'descripcion_insumo'); }
          ...
          <tr>
            <!--<td id="detalle3">&nbsp;</td>-->
            <td colspan="5" id="detalle3" above><strong>TOTAL</strong></td>
            <td colspan="4" id="fuente2" above><strong><?php echo $totalBols; ?></strong></td>
          </tr>
    ...
    <tr>
      ...
      <td nowrap="nowrap" id="subppal2">Total Horas Trabajadas</td>
...
/*$mtroL=$row_sellado_vista['int_metro_lineal_rp'];
		...
		$totalkh+=$KILOXHORA;
		 ?></td>
        <td id="fuente2"><a href="produccion_registro_sellado_edit.php?id_op=<?php echo $row_sellado_vista['id_op_rp']; ?>&amp;id_rp=<?php echo $row_sellado_vista['id_rp']; ?>">Editar</a>     
        </td>
      </tr>
    ...
    <tr>
      ...
      <td id="fuente2"><strong>
        <?php  
 	 echo redondear_decimal($totalkh/$trollos); 
...
<tr>
    ...
    <tr>
	 ...
	 ?>
      ...
      <td id="fuente2"><strong><?php echo redondear_entero_puntos($metros); ?></strong></td>
    </tr>    
    <tr>
