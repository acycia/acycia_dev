...
<?php echo $conexion->header('listas'); ?>
	...
	<table class="table table-bordered table-sm">
      ...
      <select name="id_cm" id="id_cm">
        <option value="0">C.M.</option>
        <?php
do {  
?>
        <option value="<?php echo $row_control_modificaciones['id_cm']?>"><?php echo $row_control_modificaciones['id_cm']?></option>
        <?php
...
do {  
?>
	    <option value="<?php echo $row_verificacion['id_verif']?>"><?php echo $row_verificacion['id_verif']?></option>
	    <?php
