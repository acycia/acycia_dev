...
if($id_verif != '0' && $arte == '0' && $id_ref == '0' && $fecha == '0')
{
  $query_verificaciones = "SELECT * FROM Tbl_verificacion_lamina WHERE id_verif_l='$id_verif' ORDER BY id_verif_l DESC";
}
//Filtra arte lleno
if($id_verif == '0' && $arte != '0' && $id_ref == '0' && $fecha == '0')
{
  $query_verificaciones = "SELECT * FROM Tbl_verificacion_lamina WHERE userfile_l='$arte' ORDER BY id_verif_l DESC";
}
//Filtra referencia lleno
if($id_verif == '0' && $arte == '0' && $id_ref != '0' && $fecha == '0')
{
  $query_verificaciones = "SELECT * FROM Tbl_verificacion_lamina WHERE id_ref_verif_l='$id_ref' ORDER BY id_verif_l DESC";
}
//Filtra fecha lleno
if($id_verif == '0' && $arte == '0' && id_ref == '0' && $fecha != '0')
{
  ...
  $fecha2 = $fecha + 1;
  $fecha2 = "$fecha2-01-01";
  $query_verificaciones = "SELECT * FROM Tbl_verificacion_lamina WHERE fecha_verif_l >= '$fecha1' and fecha_verif_l < '$fecha2' ORDER BY id_verif_l DESC";
}
   ...
   <tr>
     <td colspan="3" id="fuente2">
      <select name="id_verif_l" id="id_verif_l">
        <option value="0" <?php if (!(strcmp(0, $_GET['id_verif_l']))) {echo "selected=\"selected\"";} ?>>VERIF</option>
        <?php
        do {  
          ?><option value="<?php echo $row_verificacion['id_verif_l']?>"<?php if (!(strcmp($row_verificacion['id_verif_l'], $_GET['id_verif_l']))) {echo "selected=\"selected\"";} ?>><?php echo $row_verificacion['id_verif_l']?></option>
          <?php
      ...
      <select name="arte" id="arte">
       ...
       <?php
       do {  
        ?><option value="<?php echo $row_artes['userfile_l']?>"<?php if (!(strcmp($row_artes['userfile_l'], $_GET['arte']))) {echo "selected=\"selected\"";} ?>><?php echo $row_artes['userfile_l']?></option>
        <?php
  ...
  <table id="tabla1">
    <tr>
      <td colspan="2" id="dato1"><input name="borrado" type="hidden" id="borrado" value="25" />
        ...
        <td colspan="5" id="dato3"><a href="control_modificaciones_l.php"><img src="images/ciclo1.gif" alt="RESTAURAR" border="0" style="cursor:hand;"/></a><a href="referencias.php"><img src="images/a.gif" alt="REF'S ACTIVAS" border="0" style="cursor:hand;"/></a><a href="referencias_inactivas.php"><img src="images/i.gif" alt="REF'S INACTIVAS" border="0" style="cursor:hand;"/></a><a href="revision_l.php"><img src="images/r.gif" alt="REVISIONES" border="0" style="cursor:hand;" /></a><a href="validacion_l.php"><img src="images/v.gif" alt="VALIDACIONES" border="0" style="cursor:hand;" /></a><a href="ficha_tecnica_l.php"><img src="images/f.gif" alt="FICHAS TECNICAS" border="0" style="cursor:hand;" /></a></td>
      </tr>  
      <tr id="tr1">
     ...
     if($numcm >='1')
     { 
       $cm = mysql_result($resultcm, 0, 'id_cm'); ?><a href="control_modif_l_edit.php?id_cm=<?php echo $cm; ?>"><img src="images/m.gif" alt="EDIT MODIFICACION" title="EDIT MODIFICACION" border="0" style="cursor:hand;"/></a><?php } ?></td>
     </tr>
