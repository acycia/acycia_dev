...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO TblCostoExportacionDetalle (n_ce_det, id_ref_det, descripcion_det, medida_det, cantidad_det, precio_unid_det, valor_total_det) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['n_ce_det'], "int"),
                       GetSQLValueString($_POST['id_ref_det'], "int"),
...
<li><a href="costo_exportacion_listado.php">FACTURAS</a></li>
  ...
  <tr>
    <td colspan="2" align="center" id="linea1">
      <form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('id_ref_det','','R','precio_unid_det','','R','cantidad_det','','R','valor_total_det','','R');return document.MM_returnValue" >
        <table id="tabla2">
          <tr>
            <td colspan="4" id="subtitulo">ADD ITEM </td>
            </tr>
          <tr>
            <td colspan="2" id="fuente1">FACTURA N&deg; <strong><?php echo $row_costoExp['n_ce']; ?></strong><input name="n_ce_det" type="hidden" value="<?php echo $row_costoExp['n_ce']; ?>">
              <input name="id_c_ce" type="hidden" id="id_c_ce" value="<?php echo $row_costoExp['id_c_ce']; ?>"></td>
          ...
          <tr>
            <td colspan="4" id="dato1"><select name="id_ref_det" onChange="DatosGestiones('18','id_ref_det',form1.id_ref_det.value);">
          ...
          <tr>
            <td colspan="4" id="dato2"><div id="resultado"></div></td>
            </tr>
          <tr>
