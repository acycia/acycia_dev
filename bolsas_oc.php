...
$query_limit_bolsas_oc = sprintf("%s LIMIT %d, %d", $query_bolsas_oc, $startRow_bolsas_oc, $maxRows_bolsas_oc);
$bolsas_oc = mysql_query($query_limit_bolsas_oc, $conexion1) or die(mysql_error());
$row_bolsas_oc = mysql_fetch_assoc($bolsas_oc);*/

/*mysql_select_db($database_conexion1, $conexion1);
$query_ordenes_compra = "SELECT * FROM orden_compra_bolsas ORDER BY n_ocb DESC";
...
$totalPages_bolsas_oc = ceil($totalRows_bolsas_oc/$maxRows_bolsas_oc)-1; 
?>
<html>
<head>
                        ...
                        <?php foreach($row_bolsas_oc as $row_bolsas_oc) {  ?>
                          <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
                            ...
                            <td id="dato1"><a href="proveedor_vista.php?id_p=<?php echo $row_bolsas_oc['id_p_ocb']; ?>" target="_top" style="text-decoration:none; color:#000000">
                             ...
                             <td id="dato2">
                              <a href="referencia_vista.php?id_ref=<?php echo $row_bolsas_oc['id_ref_bolsa']; ?>" target="_top" style="text-decoration:none; color:#000000">
                               <?php 
