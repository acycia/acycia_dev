...
$insertSQL = sprintf("INSERT INTO control_modificaciones (id_cm, id_verif_cm, id_ref_cm, fecha_cm, responsable_cm, descripcion_cm) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "verificacion_referencia.php?id_ref=" . $_POST['id_ref_cm'] . "&id_verif=" . $_POST['id_verif_cm'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion1, $conexion1);
$query_modificacion_add = "SELECT * FROM control_modificaciones ORDER BY id_cm DESC";
...
if (isset($_GET['id_verif'])) {
  $colname_verif_modif = (get_magic_quotes_gpc()) ? $_GET['id_verif'] : addslashes($_GET['id_verif']);
}
mysql_select_db($database_conexion1, $conexion1);
$query_verif_modif = sprintf("SELECT * FROM verificacion, Tbl_referencia WHERE verificacion.id_verif = %s AND verificacion.id_ref_verif=Tbl_referencia.id_ref", $colname_verif_modif);
  ...
  <tr>
    ...
    <table id="tabla2">
      ...
      <tr>
        ...
        <td colspan="2" id="dato2"><a href="control_modificaciones.php"><img src="images/m.gif" alt="CONTROL MODIFICACIONES" title="CONTROL MODIFICACIONES" border="0" style="cursor:hand;" /></a><a href="verificacion_referencia.php?id_ref=<?php echo $row_verif_modif['id_ref_verif']; ?>"><img src="images/v.gif" alt="VERIFICACION X REF" title="VERIFICACION X REF"border="0" style="cursor:hand;" /></a><a href="verificacion.php"><img src="images/identico.gif" alt="LISTADO DE VERIFICACIONES" title="VERIFICACIONES" border="0" style="cursor:hand;" /></a></td>
      </tr>
      <tr id="tr1">
        <td id="fuente2"><input name="id_verif_cm" type="hidden" value="<?php echo $_GET['id_verif']; ?>">
          VERIFICACION</td>
        <td colspan="2" id="fuente2">FECHA REGISTRO </td>
      </tr>
      <tr>
        <td id="dato2"><a href="verificacion_edit.php?id_verif=<?php echo $row_verif_modif['id_verif']; ?>"><?php echo $row_verif_modif['id_verif']; ?></a></td>
      ...
      <tr>
        <td id="dato2"><input name="id_ref_cm" type="hidden" value="<?php echo $row_verif_modif['id_ref_verif']; ?>">
