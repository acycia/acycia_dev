...
if(isset($_GET['getClientId'])){
	...
	$query_sql = "SELECT id_op_rp, id_ref_rp,COUNT(rollo_rp) as Trollo, rollo_rp AS rollo, SUM(int_metro_lineal_rp) AS metros, SUM(int_total_kilos_rp) AS kilos FROM Tbl_reg_produccion WHERE id_rp ='".$_GET['getClientId']."' ORDER BY rollo_rp ASC";
...
TIMEDIFF(MAX(`fechaF_r`), MIN(`fechaI_r`)) AS TIEMPODIFE FROM TblSelladoRollo WHERE id_op_r='$id_op' AND rollo_r='$ROLLO' GROUP BY rollo_r DESC";
	...
	//echo "formObj.bolsa_rp.value = '".$bolsasaprox."';\n";  
