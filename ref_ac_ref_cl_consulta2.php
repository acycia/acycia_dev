...
if (isset($_GET['int_ref_ac_rc2'])) {
  $colname_referencia_ver = (get_magic_quotes_gpc()) ? $_GET['int_ref_ac_rc2'] : addslashes($_GET['int_ref_ac_rc2']);
}
mysql_select_db($database_conexion1, $conexion1);
...
$id_ref=$_GET["int_ref_ac_rc2"];
if($id_ref!='')
{
	echo $row_referencia_ver["version_ref"]; 
?>
<input name="version_ref[]" type="hidden" id="version_ref2" value="<?php echo $row_referencia_ver["version_ref"];?>" size="20">
<?php
}
