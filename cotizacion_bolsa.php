...
<td nowrap="nowrap" id="titulo2" width="50%">SEGUIMIENTO A COTIZACIONES ( BOLSA ) </td>
<td nowrap="nowrap" id="codigo" width="25%">VERSION : 1</td>
</tr>
<tr>
  <td colspan="3" id="fuente2"><select name="n_cotiz" id="n_cotiz">
    ...
    <?php
do {  
?><option value="<?php echo $row_numero['n_cotiz']?>"><?php echo $row_numero['n_cotiz']?></option>
    <?php
...
<table id="tabla1">
  ...
  <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
      <td id="dato2"><input name="cotiz[]" type="checkbox" value="<?php echo $row_cotizacion['n_cotiz']; ?>" /></td>
      ...
      <td id="dato1"><a href="cotizacion_bolsa_vista.php?n_cotiz= <?php echo $row_cotizacion['n_cotiz']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php $id_c=$row_cotizacion['id_c_cotiz'];
