...
if ($id_op!='')
{
$resultado = mysql_query("SELECT * FROM Tbl_orden_produccion, Tbl_caract_proceso WHERE Tbl_orden_produccion.id_op='$id_op' AND  Tbl_orden_produccion.int_cod_ref_op=Tbl_caract_proceso.id_cod_ref_cp AND Tbl_caract_proceso.id_proceso='1' AND Tbl_orden_produccion.b_borrado_op='0'");
