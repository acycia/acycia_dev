...
mysql_select_db($database_conexion1, $conexion1);
$cod_rollo = $_GET['cod_rollo'];
$nombre_rollo = $_GET['nombre_rollo'];
$id_ref = $_GET['ref_prod_rollo'];
if($cod_rollo == '0' && $nombre_rollo == '0' && $id_ref == '0')
{
$query_rollos = "SELECT * FROM materia_prima_rollos ORDER BY nombre_rollo ASC";
}
if($cod_rollo != '0' && $nombre_rollo == '0' && $id_ref == '0')
{
$query_rollos = "SELECT * FROM materia_prima_rollos WHERE cod_rollo='$cod_rollo'";
}
if($cod_rollo == '0' && $nombre_rollo != '0' && $id_ref == '0')
{
$query_rollos = "SELECT * FROM materia_prima_rollos WHERE nombre_rollo='$nombre_rollo'";
}
if($cod_rollo == '0' && $nombre_rollo == '0' && $id_ref != '0')
{
$query_rollos = "SELECT * FROM materia_prima_rollos WHERE ref_prod_rollo='$id_ref'";
}
...
<tr>
  <td colspan="2" id="fuente2"><select name="cod_rollo" id="cod_rollo">
    <option value="0" <?php if (!(strcmp(0, $_GET['cod_rollo']))) {echo "selected=\"selected\"";} ?>>CODIGO</option>
    <?php
do {  
?><option value="<?php echo $row_codigo['cod_rollo']?>"<?php if (!(strcmp($row_codigo['cod_rollo'], $_GET['cod_rollo']))) {echo "selected=\"selected\"";} ?>><?php echo $row_codigo['cod_rollo']?></option>
    <?php
...
?>
    ...
    <select name="nombre_rollo" id="nombre_rollo">
      <option value="0" <?php if (!(strcmp(0, $_GET['nombre_rollo']))) {echo "selected=\"selected\"";} ?>>ROLLO</option>
      <?php
do {  
?><option value="<?php echo $row_nombre['nombre_rollo']?>"<?php if (!(strcmp($row_nombre['nombre_rollo'], $_GET['nombre_rollo']))) {echo "selected=\"selected\"";} ?>><?php echo $row_nombre['nombre_rollo']?></option>
      <?php
...
?>
    ...
    <select name="ref_prod_rollo" id="ref_prod_rollo">
      <option value="0" <?php if (!(strcmp(0, $_GET['ref_prod_rollo']))) {echo "selected=\"selected\"";} ?>>REF</option>
      <?php
do {  
?><option value="<?php echo $row_referencia['id_ref']?>"<?php if (!(strcmp($row_referencia['id_ref'], $_GET['ref_prod_rollo']))) {echo "selected=\"selected\"";} ?>><?php echo $row_referencia['cod_ref']?></option>
        <?php
