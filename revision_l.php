...
<body>
  ...
  <form action="revision2_l.php" method="get" name="consulta">
   <table id="tabla1">
    <tr id="tr1">
   ...
   <tr>
     <td colspan="3" id="fuente2">
      <select name="id_rev_l" id="id_rev_l">
        <option value="0">REVISION</option>
        <?php
        do {  
          ?>
          <option value="<?php echo $row_revision['id_rev_l']?>"><?php echo $row_revision['id_rev_l']?></option>
          <?php
      ...
      <input type="submit" name="Submit" value="FILTRO" onClick="if(consulta.id_rev_l.value=='0' && consulta.id_ref.value=='0' && consulta.fecha.value=='0') { alert('DEBE SELECCIONAR UNA OPCION'); }"/>    
    </td>
  </tr>
</table>
</form>
  ...
  <table id="tabla1">
    <tr>
      <td colspan="2" id="dato1"><input name="borrado" type="hidden" id="borrado" value="24" />
        ...
        <td id="dato3"><a href="revision_l.php"><img src="images/ciclo1.gif" alt="RESTAURAR" title="RESTAURAR" border="0" style="cursor:hand;"/></a><a href="referencias.php"><img src="images/a.gif" alt="REF'S ACTIVAS" title="REF'S ACTIVAS" border="0" style="cursor:hand;"/></a><a href="referencias_inactivas.php"><img src="images/i.gif" alt="REF'S INACTIVAS" title="REF'S INACTIVAS" border="0" style="cursor:hand;"/></a><a href="verificacion_l.php"><img src="images/v.gif" alt="VERIFICACIONES" title="VERIFICACION" border="0" style="cursor:hand;" /></a><a href="validacion_l.php"><img src="images/v.gif" alt="VALIDACIONES" title="VALIDACION" border="0" style="cursor:hand;" /></a><a href="ficha_tecnica_l.php"><img src="images/f.gif" alt="FICHAS TECNICAS" title="FICHA TECNICA" border="0" style="cursor:hand;" /></a></td>
      </tr>  
      <tr id="tr1">
