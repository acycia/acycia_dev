...
$ver_cotizaciones = mysql_query($query_ver_cotizaciones, $conexion1) or die(mysql_error());
$row_cotizaciones = mysql_fetch_assoc($ver_cotizaciones);
$totalRows_ver_cotizaciones = mysql_num_rows($ver_cotizaciones);
...
Nit
          ...
          <input name="Submit" type="submit" class="Estilo67" value="Buscar" /><a href="listado_cotizaciones.php" class="Estilo3">Ver todas</a>
        </form></td>
  ...
  <tr>
    ...
    <table width="730" border="0" align="center" cellspacing="3" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
      <tr>
        <td width="104" bordercolor="#FFFFFF" bgcolor="#ECF5FF"><div align="center" class="Estilo6">Cotización Nº</div></td>
      ...
      <?php do { 
	   	 ...
	   	 switch ($row_cotizaciones['Str_tipo']) {
    case "BOLSA":
	...
	case "LAMINA":
	  ...
	  $i++;		  ?>>
          <td width="104"><div align="center" class="Estilo8"><?php echo $row_cotizaciones['N_cotizacion']; ?></div></td>
          <td width="128"><div align="center"><span class="Estilo8"><?php echo $row_cotizaciones['Str_tipo']; ?></span></div></td>
          <td width="250"><div align="center"><span class="Estilo8"><?php echo $row_cotizaciones['nombre_c']; ?></span></div></td>
          <td width="100"><div align="center"><span class="Estilo8"><?php echo $row_cotizaciones['nit_c']; ?></span></div></td>
          <td width="51"><div align="center"><a href="<?php echo $LINCK;?>N_cotizaciones=<?php echo $row_cotizaciones['N_cotizacion']; ?>&cod_ref=<?php echo $row_cotizaciones['N_referencia_c']; ?>&Str_nit=<?php echo $row_cotizaciones['Str_nit']; ?>&tipo=<?php echo $row_usuario['tipo_usuario']; ?>&case=<?php echo "6"; ?>" target="new" style="text-decoration:none; color:#000000"><img src="images/hoja.gif" alt="Ver" width="18" height="18" border="0" /></a></div></td>
           
          <td width="54"><div align="center">
                    <a href="javascript:eliminar1('id_cotiz',<?php echo $row_cotizaciones['id_cotiz'];?>,'listado_cotizaciones.php')"><img src="images/por.gif" alt="ELIMINAR COTIZ." title="ELIMINAR COTIZ." border="0" style="cursor:hand;"/></a></div></td>
        </tr>
        <?php } while ($row_cotizaciones = mysql_fetch_assoc($ver_cotizaciones)); ?>
    </table>
    </div>
    </td>
  </tr>
