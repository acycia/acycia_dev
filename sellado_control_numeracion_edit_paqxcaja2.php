...
if($hastamenos!='i'){ //EL RANGO HASTA NO DEBE SER MANOR AL DESDE 
if($desdemenos!='e'){//EL RANGO DESDE NO DEBE SER MAYOR AL HASTA	  
  $insertSQL = sprintf("INSERT INTO Tbl_tiquete_numeracion ( int_op_tn, fecha_ingreso_tn, hora_tn, int_bolsas_tn, int_undxpaq_tn, int_undxcaja_tn,  int_desde_tn, int_hasta_tn, int_cod_empleado_tn, int_cod_rev_tn, int_paquete_tn, int_caja_tn,pesot,ref_tn) VALUES ( %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       /*GetSQLValueString($_POST['id_tn'], "int"),*/
					   GetSQLValueString($_POST['int_op_tn'], "int"),
                       GetSQLValueString($_POST['fecha_ingreso_tn'], "date"),
					   GetSQLValueString($_POST['hora_tn'], "text"),
...
<tr><td id="nombreusuario"><?php echo $row_usuario['nombre_usuario']; ?></td>
  ...
  <tr>
    <td colspan="2" align="center" id="linea1">
      <form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="return validacion_select();">
        <table align="center" id="tabla35">
          ...
          <tr>
            <td id="dato1"><strong>PAQ N:</strong>
			<?php $num=$row_tiquete_num['int_paquete_tn']+1; //echo $num;?>
              <input name="int_paquete_tn" style="width:50px;" type="number" <?php if ($row_usuario['tipo_usuario']!='1'|| $row_usuario['tipo_usuario']!='14') {echo "readonly='readonly'";}?> id="int_paquete_tn" value="<?php echo $num; ?>" maxlength="5">
              <span class="rojo_inteso"> DE </span><input name="NumeroPaqxCaja" min="1" <?php if ($row_usuario['tipo_usuario']!='1' && $row_usuario['tipo_usuario']!='14') {echo "readonly";}?> type="number" style="width:50px" maxlength="5" value="<?php $paqxcaj=($_GET['NumeroPaqxCaja']); echo $paqxcaj;?>">
            ...
            <td id="dato3"><strong>CAJA N : <span class="rojo_inteso">
                ...
                <input name="int_caja_tn" style="width:50px;" type="number" <?php if ($row_usuario['tipo_usuario']!='1'|| $row_usuario['tipo_usuario']!='14') {echo "readonly='readonly'";}?> id="int_caja_tn" value="<?php echo $num2; //}?>" maxlength="5">
                </span></strong></td>
            <td id="dato1">
                      <?php if($num == $paqxcaj){?>
          ...
          <tr>
            ...
            <td colspan="2" ><input type="number" name="int_undxcaja_tn" <?php if ($row_usuario['tipo_usuario']!='1'|| $row_usuario['tipo_usuario']!='14') {echo "readonly='readonly'";}?> id="pswd" min="0" value="<?php echo $row_control_paquete['int_undxcaja_op'];?>"></td> 
          </tr>
          <tr>
            <td id="fuente1">UNIDADES  X PAQ.</td>
            <td colspan="2" ><input type="number" name="int_undxpaq_tn" id="pswd" min="0" value="<?php echo $row_control_paquete['int_undxpaq_op'];?>"></td>
            </tr>
          <tr>
...
/*			  $numero = "";
	       ...
	       ?>	           
          <input type="text" <?php if ($row_usuario['tipo_usuario']!='1' && $row_usuario['tipo_usuario']!='14') {echo "readonly";}?> name="int_desde_tn" autofocus id="pswd" value="<?php echo $cadena; ?>" min="0" onChange="conMayusculas(this),sumaPaqSelladoAdd(this);" required></td>
          </tr>
          <tr>
            <td id="fuente1"><strong>HASTA</strong></td>
            <td colspan="2" ><input type="text" <?php if ($row_usuario['tipo_usuario']!='1' && $row_usuario['tipo_usuario']!='14') {echo "readonly";}?> name="int_hasta_tn" id="pswd" readonly required value="" min="0"></td>
          </tr>
          <tr>
...
?>
          ...
          <tr>
            ...
            <td colspan="2" id="fuente1"><strong><?php echo $num. " de " . $paqxcaj;?></strong></td>
          </tr>
          <tr>
            <td colspan="3">           
             </td>
          ...
          <tr>
            ...
            <?php  do { ?>
            <p><a href="javascript:popUp('sellado_control_numeracion_vista.php?id_op=<?php echo $row_tiquete_num['int_op_tn']; ?>&int_paquete_tn=<?php echo $row_tiquete_num['int_paquete_tn']; ?>&int_caja_tn=<?php echo $row_tiquete_num['int_caja_tn']; ?>','700','300')" target="_top"><?php echo "PAQUETE #: ".$row_tiquete_num['int_paquete_tn']. " DESDE: ".  $row_tiquete_num['int_desde_tn']. " HASTA: ".$row_tiquete_num['int_hasta_tn'];?></a>-----<a href="javascript:eliminar_sppxc('id_tnpxc',<?php echo $row_tiquete_num['id_tn'];?>,'sellado_control_numeracion_edit_paqxcaja.php')">
