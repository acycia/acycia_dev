                     ...
                     <td id="fuente2">
                      <select class="selectsMedio busqueda" name="n_vi" id="n_vi">
                       <option value="0">VERIF</option>
                          ...
                          <option value="<?php echo $row_lista['n_vi']?>"><?php echo $row_lista['n_vi'];?></option>
                      ...
                      <select class="selectsMedio busqueda" name="n_oc" id="n_oc">
                       <option value="0">O.C.</option>
                          ...
                          <option value="<?php echo $row_lista_oc['n_oc']?>"><?php echo $row_lista_oc['n_oc'];?></option>
                        </option>
                      <?php } ?>
                      </select>
                      ...
                      <select class="selectsGrande busqueda" name="id_p" id="id_p">
                       <option value="0">PROVEEDOR</option>
                          ...
                          <option value="<?php echo $row_lista_p['id_p']?>"><?php echo $row_lista_p['proveedor_p'];?></option>
                   ...
                   <tr>
                     <td id="fuente2">
                      <select class="selectsGrande busqueda" name="id_insumo" id="id_insumo">
                       <option value="0">INSUMO</option>
                          ...
                          <option value="<?php echo $row_lista_insumo['id_insumo']?>"><?php echo $row_lista_insumo['descripcion_insumo'];?></option>
                    ...
                    <select class="selectsMedio busqueda" name="fecha" id="fecha">
                       <option value="0">AÑO</option>
                        ...
                        <option value="<?php echo $row_lista_ano['anual']?>"><?php echo $row_lista_ano['anual']?></option>
