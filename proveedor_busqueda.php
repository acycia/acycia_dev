...
do {  
?>
    <option value="<?php echo $row_lista['id_p']?>"><?php echo $row_lista['proveedor_p']?></option>
    <?php
...
?>
    ...
    <input type="submit" name="Submit" value="FILTRO" onClick="if(consulta.id_p.value=='0' && consulta.tipo_p.value=='0' && consulta.estado_p.value=='0') { alert('DEBE SELECCIONAR UNA OPCION'); }"/></td>
  </tr>
</table>
</div>
</form>
