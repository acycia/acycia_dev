...
<frameset rows="211,*" cols="*" frameborder="NO" border="NO">
  <frame src="costos_producto_terminado2.php" frameborder="NO" scrolling="NO" noresize marginwidth="0" marginheight="0">
  <frame src="costos_producto_terminado3.php" frameborder="NO" scrolling="auto" noresize marginwidth="0" marginheight="0">
</frameset>
<noframes>
