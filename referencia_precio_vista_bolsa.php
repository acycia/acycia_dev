...
Tbl_cotiza_bolsa.N_referencia_c='%s' and Tbl_cotiza_bolsa.Str_nit='%s' and
Tbl_cotiza_bolsa.Str_nit=cliente.nit_c and
Tbl_cotiza_bolsa.B_generica='0' and
Tbl_cotiza_bolsa.B_estado<>'2' ORDER BY Tbl_cotiza_bolsa.fecha_creacion DESC", $colname_ver_nueva,$colname_cotizacion_ref,$colname_cotizacion_nit );//desaparece las rechazadas de la vista
...
Tbl_cotiza_bolsa.Str_nit=cliente.nit_c and
Tbl_cotiza_bolsa.B_generica='1' ORDER BY Tbl_cotiza_bolsa.fecha_creacion DESC", $colname_ver_existente,$colname_cotizacion_ref,$colname_cotizacion_nit);
...
{ ?>
      <table id="tablainterna" >
        <tr>
          <td width="139" colspan="<?php echo $num2+1; ?>" nowrap  id="subppal2"><strong>REFERENCIAS EXISTENTES 
...
<table id="tablainterna" align="center">
  <tr>
    <td id="noprint" align="center"><?php if($_GET['tipo']=='1' || $_GET['tipo']=='2') { ?>
