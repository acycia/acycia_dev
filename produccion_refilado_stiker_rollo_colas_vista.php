...
if (isset($_GET['id_op_r'])) {
  $colname_rollo_refilado = (get_magic_quotes_gpc()) ? $_GET['id_op_r'] : addslashes($_GET['id_op_r']);
}
mysql_select_db($database_conexion1, $conexion1);
$query_rollo_refilado = sprintf("SELECT * FROM TblRefiladoRollo WHERE TblRefiladoRollo.id_op_r=%s",$colname_rollo_refilado);
...
<div align="center" id="seleccion" ><!--onClick="cerrar('seleccion');"-->
  <table id="tabla6" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td colspan="2" nowrap="nowrap" id="fuentND" style="border-bottom: 3px solid #000000;"><a href="produccion_refilado_stiker_rollo_edit.php?id_r=<?php echo $row_rollo_refilado['id_r']; ?>&rollo_r=<?php echo $row_rollo_refilado['rollo_r']; ?>"><img src="images/menos.gif" alt="EDITAR" title="EDITAR" border="0" style="cursor:hand;" /></a><a href="produccion_refilado_listado_rollos.php?id_op_r=<?php echo $row_rollo_refilado['id_op_r']; ?>&rollo_r=<?php echo $row_rollo_refilado['rollo_r']; ?>"><img src="images/opciones.gif" alt="LISTADO ROLLOS"title="LISTADO ROLLO" border="0" style="cursor:hand;"/></a><img src="images/impresor.gif" onClick="window.print();" style="cursor:hand;" alt="REFILADO" title="REFILADO" /></td>
        </tr>
       <tr>
        <td nowrap="nowrap" id="stikersC_fuentN">ORDEN P:</td>
        <td colspan="2" nowrap="nowrap" id="stikers_fuentN"><?php echo $row_rollo_refilado['id_op_r']; ?></td>
      ...
      <tr>
        ...
        <td colspan="2" nowrap="nowrap" id="stikers_fuentN"><?php echo $row_rollo_refilado['fechaV_r']; ?></td>
...
mysql_free_result($rollo_refiladoa);
?>
