          ...
          <div class="container-fluid">  
            ...
            <table class="table table-striped">
              ...
              <tbody >
                ...
                <tr>
                  <td>
                    <?php if($_SESSION['acceso']): ?><em> LIQUIDACIÓN VALORES</em>&nbsp;&nbsp;&nbsp;&nbsp;<a target="_blank"  href="view_index.php?c=comprasLQ&a=Liquidacion">LIQUIDACIÓN.. >>></a>
                    <?php endif;?>
                  </td>
                  <td> </td>
                </tr>
                <tr>
                  <td>
                    <?php if($_SESSION['acceso']): ?> <em> CONTROL DE OPERACIÓNES</em>&nbsp;&nbsp;&nbsp;&nbsp;<a target="_blank"  href="view_index.php?c=comprasCO&a=Control">CONTROL DE OPERACIÓNES >>></a> 
                    <?php endif;?>
                   </td>
                  <td> </td>
                </tr>
                <tr>
                  <td>
                    <?php if($_SESSION['acceso']): ?><em>ADJUNTO</em>&nbsp;&nbsp;&nbsp;&nbsp;<a target="_blank"  href="view_index.php?c=comprasLQU&a=Liquidacion">ADJUNTO >>></a>
                    <?php endif;?>
                  </td>
                  <td> </td>
                </tr>
