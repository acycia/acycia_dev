...
$version_ref_verif=$_POST['version_ref_verif_l'];
$id_verif=$_POST['id_verif_cm'];
$sql1="UPDATE Tbl_referencia SET version_ref='$version_ref' WHERE id_ref='$id_ref'";
$sql2="UPDATE Tbl_verificacion_lamina SET version_ref_verif_l='$version_ref_verif' WHERE id_verif_l='$id_verif'";
  $updateSQL = sprintf("UPDATE Tbl_control_modificaciones_lamina SET id_verif_cm=%s, id_ref_cm=%s, fecha_cm=%s, responsable_cm=%s, descripcion_cm=%s, fecha_edit_cm=%s, responsable_edit_cm=%s WHERE id_cm=%s",
  ...
  $updateGoTo = "verificacion_referencia_lamina.php?id_ref=" . $_POST['id_ref_cm'] . "&id_verif_l=" . $_POST['id_verif_cm'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion1, $conexion1);
$query_modificacion_edit = sprintf("SELECT * FROM Tbl_control_modificaciones_l WHERE id_cm = %s", $colname_modificacion_edit);
...
mysql_select_db($database_conexion1, $conexion1);
$query_verif_modif = sprintf("SELECT * FROM Tbl_control_modificaciones_l, Tbl_verificacion_lamina, Tbl_referencia WHERE Tbl_control_modificaciones_l.id_cm = %s AND Tbl_control_modificaciones_l.id_verif_cm = Tbl_verificacion_lamina.id_verif_l AND Tbl_verificacion_lamina.id_ref_verif_l=Tbl_referencia.id_ref", $colname_verif_modif);
  ...
  <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
    <table id="tabla2">
      ...
      <tr>
        ...
        <td id="dato2"><a href="javascript:eliminar2('id_cm_l',<?php echo $row_modificacion_edit['id_cm']; ?>,'control_modif_l_edit.php','id_ref_cm',<?php echo $row_modificacion_edit['id_ref_cm']; ?>)"><img src="images/por.gif" alt="ELIMINAR" title="ELIMINAR" border="0" style="cursor:hand;" ></a><a href="control_modificaciones_l.php"><img src="images/m.gif" alt="CONTROL MODIFICACIONES" title="CONTROL MODIFICACIONES"border="0" style="cursor:hand;" /></a><a href="verificacion_referencia_lamina.php?id_ref=<?php echo $row_verif_modif['id_ref_verif_l']; ?>"><img src="images/v.gif" alt="VERIFICACION X REF" title="VERIFICACION X REF" border="0" style="cursor:hand;" /></a><a href="verificacion_l.php"><img src="images/identico.gif" alt="LISTADO DE VERIFICACIONES" title="LISTADO DE VERIFICACIONES" border="0" style="cursor:hand;" /></a></td>
      </tr>
      <tr id="tr1">
      ...
      <tr>
        <td id="dato2"><input name="id_verif_cm" type="hidden" value="<?php echo $row_modificacion_edit['id_verif_cm']; ?>">
          <a href="verificacion_lamina_edit.php?id_verif_l=<?php echo $row_verif_modif['id_verif_cm']; ?>"><?php echo $row_modificacion_edit['id_verif_cm']; ?></a></td>
      ...
      <tr>
        <td id="numero2"><strong>VERSION C.M.</strong><input name="version_ref_verif" type="text" id="version_ref_verif" value="<?php echo $row_verif_modif['version_ref_verif_l']; ?>" size="2"></td>
