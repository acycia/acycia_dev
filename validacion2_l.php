...
mysql_select_db($database_conexion1, $conexion1);
$query_validaciones = "SELECT * FROM Tbl_validacion_lamina ORDER BY id_val_l DESC";
...
mysql_select_db($database_conexion1, $conexion1);
$id_val = $_GET['id_val_l'];
$id_ref = $_GET['id_ref'];
$fecha = $_GET['fecha'];
//Filtra todos vacios
if($id_val== '0' && $id_ref == '0' && $fecha == '0')
{
  $query_validacion = "SELECT * FROM Tbl_validacion_lamina ORDER BY id_val_l DESC";
}
//Filtra revision lleno
if($id_val!= '0' && $id_ref == '0' && $fecha == '0')
{
  $query_validacion = "SELECT * FROM Tbl_validacion_lamina WHERE id_val_l='$id_val' ORDER BY id_val_l DESC";
}
//Filtra referencia lleno
if($id_val == '0' && $id_ref != '0' && $fecha == '0')
{
  $query_validacion = "SELECT * FROM Tbl_validacion_lamina WHERE id_ref_val_l='$id_ref' ORDER BY id_val_l DESC";
}
//Filtra fecha lleno
if($id_val == '0' && $id_ref == '0' && $fecha != '0')
{
  ...
  $fecha2 = $fecha + 1;
  $fecha2 = "$fecha2-01-01";
  $query_validacion = "SELECT * FROM Tbl_validacion_lamina WHERE fecha_val_l >= '$fecha1' and fecha_val_l < '$fecha2' ORDER BY id_val_l DESC";
}
...
<body>
  ...
  <form action="validacion2_l.php" method="get" name="consulta">
   ...
   <tr>
     <td colspan="3" id="fuente2">
      <select name="id_val_l" id="id_val_l">
        <option value="0" <?php if (!(strcmp(0, $_GET['id_val_l']))) {echo "selected=\"selected\"";} ?>>VALIDACION</option>
        <?php
        do {  
          ?><option value="<?php echo $row_validaciones['id_val_l']?>"<?php if (!(strcmp($row_validaciones['id_val_l'], $_GET['id_val_l']))) {echo "selected=\"selected\"";} ?>><?php echo $row_validaciones['id_val_l']?></option>
          <?php
      ...
      <input type="submit" name="Submit" value="FILTRO" onClick="if(consulta.id_val_l.value=='0' && consulta.id_ref.value=='0' && consulta.fecha.value=='0') { alert('DEBE SELECCIONAR UNA OPCION'); }"/>    
    </td>
  </tr>
</table>
</form>
<form action="delete_listado.php" method="get" name="seleccion">
  <table class="table table-bordered table-sm">
    <tr>
      <td colspan="2" id="dato1"><input name="borrado" type="hidden" id="borrado" value="26" />
        ...
        <td id="dato3"><a href="validacion_l.php"><img src="images/ciclo1.gif" alt="RESTAURAR" title="RESTAURAR" border="0" style="cursor:hand;"/></a><a href="referencias.php"><img src="images/a.gif" alt="REF'S ACTIVAS" title="REF'S ACTIVAS" border="0" style="cursor:hand;"/></a><a href="referencias_inactivas.php"><img src="images/i.gif" alt="REF'S INACTIVAS" title="REF'S INACTIVAS" border="0" style="cursor:hand;"/></a><a href="revision_l.php"><img src="images/r.gif" alt="REVISIONES" title="REVISIONES" border="0" style="cursor:hand;" /></a><a href="verificacion_l.php"><img src="images/v.gif" alt="VERIFICACIONES" title="VERIFICACIONES" border="0" style="cursor:hand;" /></a><a href="ficha_tecnica_l.php"><img src="images/f.gif" alt="FICHAS TECNICAS" title="FICHAS TECNICAS" border="0" style="cursor:hand;" /></a></td>
      </tr>  
      <tr id="tr1">
      ...
      <?php do { ?>
        <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
          <td id="dato2"><input name="borrar[]" type="checkbox" value="<?php echo $row_validacion['id_val_l']; ?>" /></td>
          <td id="dato3"><a href="validacion_lamina_vista.php?id_val_l= <?php echo $row_validacion['id_val_l']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_validacion['id_val_l']; ?></a></td>
          <td id="dato2"><?php $id_ref=$row_validacion['id_ref_val_l'];
       ...
       } ?><a href="validacion_lamina_vista.php?id_val_l=<?php echo $row_validacion['id_val_l']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $cod_ref; ?></a></td>
       <td id="dato2"><a href="validacion_lamina_vista.php?id_val_l=<?php echo $row_validacion['id_val_l']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $version_ref; ?></a></td>
       <td id="dato2"><a href="validacion_lamina_vista.php?id_val_l=<?php echo $row_validacion['id_val_l']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_validacion['fecha_val_l']; ?></a></td>
       <td id="dato1"><a href="validacion_lamina_vista.php?id_val_l=<?php echo $row_validacion['id_val_l']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php $cad = htmlentities( $row_validacion['responsable_val_l']);echo $cad; ?></a></td>
       <td id="dato1"><a href="validacion_lamina_vista.php?id_val_l=<?php echo $row_validacion['id_val_l']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php $cad2 = htmlentities ($row_validacion['responsable_edit_val_l']);echo $cad; ?></a></td>
     </tr>
