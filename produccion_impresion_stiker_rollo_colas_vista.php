...
mysql_select_db($database_conexion1, $conexion1);
$query_rollo_impresion = sprintf("SELECT * FROM TblImpresionRollo WHERE TblImpresionRollo.id_op_r=%s",$colname_rollo_impresion);
...
<!--<div align="center" id="seleccion" >--><!--onClick="cerrar('seleccion');"-->
  <table id="tabla6" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td colspan="5" id="stikers_fuent2"><?php $id_c=$row_rollo_impresion['id_c_r']; 
  ...
  <tr>
    <td nowrap="nowrap" id="stikersC_fuentN" >Rasquetas:</td>
    ...
    <td id="stikersC_fuentN" style="border-left: 3px solid #000000;">TOTAL:</td>
