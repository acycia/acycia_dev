...
{
  $colname_ver_bolsa2 = (get_magic_quotes_gpc()) ? $_GET['N_cotiz'] : addslashes($_GET['N_cotiz']);
}
mysql_select_db($database_conexion1, $conexion1);
$query_bolsa = sprintf("SELECT * FROM Tbl_referencia WHERE cod_ref='%s'",$colname_ver_bolsa2);
...
<li><a href="cotizacion_general_menu.php">Menu Cotizaciones</a></li>
        ...
        <td id="cabezamenu"><ul id="menuhorizontal">
  <li><a href="referencia_bolsa_add.php?N_cotizacion=<?php echo $row_cotizacion['N_cotizacion']?>">Crear Referencia</a></li>
</ul></td>
        <td colspan="2" id="fuente1">&nbsp;</td>
        </tr>
      <tr id="tr1">
      ...
      <tr>
        <td id="dato1"><input name="N_ancho" type="text" id="N_ancho" value="<?php echo $row_bolsa['ancho_ref']?>" size="3" onKeyUp="return ValNumero(this)"/></td>
        <td colspan="2" id="dato1"><input name="N_alto" type="text" id="N_alto" value="<?php echo $row_bolsa['largo_ref']?>" size="3" onKeyUp="return ValNumero(this)"/></td>
        <td id="dato1">
          <input name="N_solapa" type="text" id="N_solapa" value="<?php echo $row_bolsa['solapa_ref']?>" size="3" onKeyUp="return ValNumero(this)"/>
        </td>
        <td id="dato1"><input name="B_fuelle" type="text" id="B_fuelle" value="<?php echo $row_bolsa['N_fuelle']?>" size="3" onKeyUp="return ValNumero(this)"/></td>
      </tr>
      <tr>
      ...
      <tr>
        <td id="dato1"><input name="N_calibre" type="text" id="N_calibre" value="<?php echo $row_bolsa['calibre_ref']?>" size="3"onKeyUp="return ValNumero(this)" /></td>
        <td colspan="2" id="dato1">
          <select name="B_troquel" id="B_troquel">
            <option value=""<?php if (!(strcmp("*", $row_bolsa['B_troquel']))) {echo "selected=\"selected\"";} ?>>*</option>
        ...
        <td id="dato1"><select name="B_bolsillo" id="B_bolsillo"onclick="mostrarBolsillo(this)">
          <option value="*"<?php if (!(strcmp("*", $row_bolsa['bolsillo_guia_ref']))) {echo "selected=\"selected\"";} ?>>*</option>
          <option value="1"<?php if (!(strcmp("1", $row_bolsa['bolsillo_guia_ref']))) {echo "selected=\"selected\"";} ?>>SI</option>
          <option value="0"<?php if (!(strcmp("0",$row_bolsa['bolsillo_guia_ref']))) {echo "selected=\"selected\"";} ?>>NO</option>
          </select></td>
        <td id="dato1"><input name="N_tamano_bolsillo" type="text" value="<?php echo $row_bolsa['bolsillo_guia_ref']?>" id="N_tamano_bolsillo" size="3" onclick="mostrarBolsillo(this);this.value = ''"onKeyUp="return ValNumero(this)"/></td>
      </tr>
      <tr>
      ...
      <tr>
        <td id="fuente1"><select name="Str_tipo_coextrusion" id="Str_tipo_coextrusion"onclick="mostrarCapa(this)">
          <option>*</option>
          <option value="PIGMENTADO"<?php if (!(strcmp("PIGMENTADO", $row_bolsa['material_ref']))) {echo "selected=\"selected\"";} ?>>PIGMENTADO</option>
          <option value="NATURAL"<?php if (!(strcmp("NATURAL", $row_bolsa['material_ref']))) {echo "selected=\"selected\"";} ?>>NATURAL</option>
        </select></td>
      ...
      <tr>
        <td colspan="3" id="fuente1">Impresion:
          <select name="B_impresion" id="B_impresion"onclick="mostrarColor(this)">
          ...
          <select name="N_colores_impresion" id="N_colores_impresion"tag="tag" tabindex="1\">
        ...
        <td width="219" id="fuente1"><select name="B_cyreles" id="B_cyreles"onclick="mostrarColor(this)">
      ...
      <tr>
        ...
        <td id="fuente1"><select name="B_fondo" id="B_fondo">
          <option value=""<?php if (!(strcmp("*", $row_bolsa['B_fondo']))) {echo "selected=\"selected\"";} ?>>*</option>
      ...
      <tr>
        ...
        <td colspan="2" id="fuente1"><select name="B_numeracion" id="B_numeracion">
          <option value=""<?php if (!(strcmp("*", $row_bolsa['B_numeracion']))) {echo "selected=\"selected\"";} ?>>*</option>
        ...
        <td id="fuente1"><select name="B_codigo_b" id="B_codigo_b">
          <option value=""<?php if (!(strcmp("*", $row_bolsa['B_codigo_b']))) {echo "selected=\"selected\"";} ?>>*</option>
      ...
      <tr>
        ...
        <td id="fuente1"> Cantidad Solicitada  (und)</td>
      </tr>
      <tr>
        <td colspan="2" id="fuente5"><select name="Str_moneda" id="Str_moneda">
          ...
          </select>          <input name="N_precio" type="text" id="N_precio" size="15" value="<?php echo $row_bolsa['N_precio']?>"onKeyUp="return ValNumero(this)"/></td>
        ...
        <td id="fuente1">
          <input name="N_cant_impresion" type="text" id="N_cant_impresion" value="<?php echo $row_bolsa['N_cant_impresion'];?>" size="10" />
       </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan="2" id="fuente1"><select name="Str_usuario" id="Str_usuario">
...
?>
      ...
      <tr>
        <td colspan="5" id="dato1"><textarea name="nota_b" cols="78" rows="2" id="nota_b"onKeyUp="conMayusculas(this)"><?php echo $row_obs['texto'] ?></textarea></td>
      </tr>
      <tr>
        <td colspan="5" id="dato1">&nbsp;</td>
      </tr>
      <tr>
        <td colspan="5" id="fuente2"><input type="hidden" name="Str_tipo" id="Str_tipo" value="BOLSA" /><input name="responsable_modificacion" type="hidden" value="" />
          ...
          <input name="valor" type="hidden" value="3" />
        <input name="submit" type="submit"value="GUARDAR COTIZACION BOLSA" /></td>
      </tr>
    </table>
