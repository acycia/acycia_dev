...
if($str_numero_oc == '0' && $id_c == '0' && $nit_c == '0'&& $estado_oc == '0' && $pendiente != '0')
{
$query_ordenes_compra = "SELECT *,SUM(Tbl_items_ordenc.int_cantidad_rest_io) AS restante FROM Tbl_orden_compra,Tbl_items_ordenc WHERE Tbl_items_ordenc.int_cantidad_rest_io $pendiente '0.00' AND Tbl_orden_compra.id_pedido=Tbl_items_ordenc.id_pedido_io AND Tbl_orden_compra.b_borrado_oc='1' GROUP BY Tbl_orden_compra.str_numero_oc ORDER BY Tbl_orden_compra.b_estado_oc, Tbl_orden_compra.fecha_ingreso_oc DESC";
}
//Filtra cliente y pendientes lleno
if($str_numero_oc == '0' && $id_c != '0' && $nit_c == '0'&& $estado_oc == '0' && $pendiente != '0')
{
$query_ordenes_compra = "SELECT *,SUM(Tbl_items_ordenc.int_cantidad_rest_io) AS restante FROM Tbl_orden_compra,Tbl_items_ordenc WHERE Tbl_orden_compra.id_c_oc='$id_c' AND Tbl_items_ordenc.int_cantidad_rest_io $pendiente '0.00' AND Tbl_orden_compra.id_pedido=Tbl_items_ordenc.id_pedido_io AND Tbl_orden_compra.b_borrado_oc='1' GROUP BY Tbl_orden_compra.str_numero_oc ORDER BY Tbl_orden_compra.b_estado_oc, Tbl_orden_compra.fecha_ingreso_oc DESC";
}
//Filtra nit y pendientes lleno
if($str_numero_oc == '0' && $id_c == '0' && $nit_c != '0'&& $estado_oc == '0' && $pendiente != '0')
{
$query_ordenes_compra = "SELECT *,SUM(Tbl_items_ordenc.int_cantidad_rest_io) AS restante FROM Tbl_orden_compra,Tbl_items_ordenc WHERE Tbl_orden_compra.str_nit_oc='$nit_c' AND Tbl_items_ordenc.int_cantidad_rest_io $pendiente '0.00' AND Tbl_orden_compra.id_pedido=Tbl_items_ordenc.id_pedido_io AND Tbl_orden_compra.b_borrado_oc='1' GROUP BY Tbl_orden_compra.str_numero_oc ORDER BY Tbl_orden_compra.b_estado_oc, Tbl_orden_compra.fecha_ingreso_oc DESC";
}
//Filtra O.C y pendientes lleno
if($str_numero_oc != '0' && $id_c == '0' && $nit_c == '0'&& $estado_oc == '0' && $pendiente != '0')
{
$query_ordenes_compra = "SELECT *,SUM(Tbl_items_ordenc.int_cantidad_rest_io) AS restante FROM Tbl_orden_compra,Tbl_items_ordenc WHERE Tbl_orden_compra.str_numero_oc='$str_numero_oc' AND Tbl_items_ordenc.int_cantidad_rest_io $pendiente '0.00' AND Tbl_orden_compra.id_pedido=Tbl_items_ordenc.id_pedido_io AND Tbl_orden_compra.b_borrado_oc='1' GROUP BY Tbl_orden_compra.str_numero_oc ORDER BY Tbl_orden_compra.b_estado_oc, Tbl_orden_compra.fecha_ingreso_oc DESC";
}
//Filtra estado y pendientes lleno
if($str_numero_oc == '0' && $id_c == '0' && $nit_c == '0'&& $estado_oc != '0' && $pendiente != '0')
{
$query_ordenes_compra = "SELECT *,SUM(Tbl_items_ordenc.int_cantidad_rest_io) AS restante FROM Tbl_orden_compra,Tbl_items_ordenc WHERE Tbl_orden_compra.b_estado_oc='$estado_oc' AND Tbl_items_ordenc.int_cantidad_rest_io $pendiente '0.00' AND Tbl_orden_compra.id_pedido=Tbl_items_ordenc.id_pedido_io AND Tbl_orden_compra.b_borrado_oc='1' GROUP BY Tbl_orden_compra.str_numero_oc ORDER BY Tbl_orden_compra.b_estado_oc, Tbl_orden_compra.fecha_ingreso_oc DESC";
}
//Filtra todos SIN NIT lleno
if($str_numero_oc != '0' && $id_c != '0' && $nit_c == '0'&& $estado_oc != '0' && $pendiente != '0')
{
$query_ordenes_compra = "SELECT *,SUM(Tbl_items_ordenc.int_cantidad_rest_io) AS restante FROM Tbl_orden_compra,Tbl_items_ordenc WHERE Tbl_orden_compra.id_c_oc='$id_c' AND Tbl_orden_compra.str_numero_oc='$str_numero_oc' AND Tbl_orden_compra.b_estado_oc='$estado_oc'Tbl_items_ordenc.int_cantidad_rest_io $pendiente '0.00' AND Tbl_orden_compra.id_pedido=Tbl_items_ordenc.id_pedido_io AND Tbl_orden_compra.b_borrado_oc='1' GROUP BY Tbl_orden_compra.str_numero_oc ORDER BY Tbl_orden_compra.b_estado_oc, Tbl_orden_compra.fecha_ingreso_oc DESC";
}
...
mysql_select_db($database_conexion1, $conexion1);
$query_lista = "SELECT * FROM Tbl_orden_compra WHERE b_borrado_oc='1' ORDER BY str_numero_oc ASC";
...
do {  
?>
      <option value="<?php echo $row_proveedores['id_c']?>"<?php if (!(strcmp($row_proveedores['id_c'], $_GET['id_c']))) {echo "selected=\"selected\"";} ?>>
...
<table id="tabla1">
  ...
  <?php do { ?>
    <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
      ...
      <td id="dato2" nowrap><a href="orden_compra_cl_vista.php?str_numero_oc=<?php echo $row_ordenes_compra['str_numero_oc']; ?>&id_oc=<?php echo $row_ordenes_compra['id_c_oc']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_ordenes_compra['fecha_ingreso_oc']; ?></a></td>
