...
mysql_select_db($database_conexion1, $conexion1);
$query_control_modificaciones = "SELECT * FROM Tbl_control_modificaciones_l ORDER BY id_cm DESC";
...
{
$query_modificaciones = "SELECT * FROM Tbl_control_modificaciones_l ORDER BY id_cm DESC";
}
//Filtra cm lleno
if($id_cm != '0' && $id_verif == '0' && $id_ref == '0' && $fecha == '0')
{
$query_modificaciones = "SELECT * FROM Tbl_control_modificaciones_l WHERE id_cm='$id_cm' ORDER BY id_cm DESC";
}
//Filtra verificacion lleno
if($id_cm == '0' && $id_verif != '0' && $id_ref == '0' && $fecha == '0')
{
$query_modificaciones = "SELECT * FROM Tbl_control_modificaciones_l WHERE id_verif_cm='$id_verif' ORDER BY id_cm DESC";
}
//Filtra referencia lleno
if($id_cm == '0' && $id_verif == '0' && $id_ref != '0' && $fecha == '0')
{
$query_modificaciones = "SELECT * FROM Tbl_control_modificaciones_l WHERE id_ref_cm='$id_ref' ORDER BY id_cm DESC";
}
//Filtra fecha lleno
if($id_cm == '0' && $id_verif == '0' && $id_ref == '0' && $fecha != '0')
{
...
$fecha2 = $fecha + 1;
$fecha2 = "$fecha2-01-01";
$query_modificaciones = "SELECT * FROM Tbl_control_modificaciones_l WHERE fecha_cm >= '$fecha1' and fecha_cm < '$fecha2' ORDER BY id_cm DESC";
}
...
<?php echo $conexion->header('listas'); ?>
	<form action="control_modificaciones2_l.php" method="get" name="consulta">
	<table id="tabla1">
      <tr id="tr1">
...
<table id="tabla1">
  ...
  <?php do { ?>
    <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
      ...
      <td id="dato3"><a href="control_modif_l_edit.php?id_cm=<?php echo $row_modificaciones['id_cm']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_modificaciones['id_cm']; ?></a></td>
      <td id="dato3"><a href="verificacion_lamina_vista.php?id_verif_l=<?php echo $row_modificaciones['id_verif_cm']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_modificaciones['id_verif_cm']; ?></a></td>
	  ...
	  } ?><a href="referencia_lamina_vista.php?id_ref=<?php echo $row_modificaciones['id_ref_cm']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $cod_ref; ?></a></td>
      <td id="dato2"><a href="referencia_lamina_vista.php?id_ref=<?php echo $row_modificaciones['id_ref_cm']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $version_ref; ?></a></td>
      <td id="dato2"><a href="control_modif_l_edit.php?id_cm=<?php echo $row_modificaciones['id_cm']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_modificaciones['fecha_cm']; ?></a></td>
      <td id="dato1"><a href="control_modif_l_edit.php?id_cm=<?php echo $row_modificaciones['id_cm']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php $cad=htmlentities ($row_modificaciones['responsable_cm']);echo $cad; ?></a></td>
      <td id="dato2"><a href="control_modif_l_edit.php?id_cm=<?php echo $row_modificaciones['id_cm']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_modificaciones['fecha_edit_cm']; ?></a></td>
      <td id="dato2"><a href="control_modif_l_edit.php?id_cm=<?php echo $row_modificaciones['id_cm']; ?>&amp;tipo=<?php echo $row_usuario['tipo_usuario']; ?>" target="_top" style="text-decoration:none; color:#000000"><?php $cad2=htmlentities ($row_modificaciones['responsable_edit_cm']);echo $cad2; ?></a></td>
      </tr>
