...
mysql_select_db($database_conexion1, $conexion1);
$query_ver_ref = sprintf("SELECT * FROM Tbl_cliente_referencia,Tbl_cotiza_bolsa WHERE Tbl_cliente_referencia.N_cotizacion='%s' and Tbl_cliente_referencia.N_referencia=Tbl_cotiza_bolsa.N_referencia_c", $colname_ver_ref);
...
<input name="registro1_ref" type="text" value="<?php echo $row_usuario['nombre_usuario']; ?>" size="27" /></td>
      ...
      <tr id="tr3">
        ...
        <td id="dato2"><a href="javascript:verFoto('archivo/<?php echo $row_ver_egp['userfile'];?>','610','490')"> <?php echo $row_ver_egp['userfile']; ?> </a> </td>
      </tr>
      <tr id="tr1">
      ...
      <tr>
        ...
        <td id="dato2"><select name="B_generica" id="B_generica">
          ...
          <option value="1" <?php if (!(strcmp(1, $row_referencia_editar['B_generica']))) {echo "selected=\"selected\"";} ?>>SI</option><option value="0" <?php if (!(strcmp(0, $row_referencia_editar['B_generica']))) {echo "selected=\"selected\"";} ?>>NO</option>
        </select></td>
        <td id="dato2"><?php echo $row_ver_egp['fecha_aprob_arte_verif']; ?></td>
      </tr>
      <tr id="tr1">
      ...
      <tr>
        <td id="dato1"><input name="ancho_ref" type="text" value="<?php echo $row_referencia_editar['ancho_ref']; ?>" size="10" onKeyUp="return ValNumero(this)"/></td>
        <td id="dato1"><input name="largo_ref" type="text" value="<?php echo $row_referencia_editar['largo_ref']; ?>" size="10" onKeyUp="return ValNumero(this)"/></td>
        <td id="dato1"><input name="solapa_ref" type="text" value="<?php echo $row_referencia_editar['solapa_ref']; ?>" size="10" onKeyUp="return ValNumero(this)"/></td>
        <td id="dato1"><input name="bolsillo_guia_ref" type="text" value="<?php echo $row_referencia_editar['bolsillo_guia_ref']; ?>" size="10" onKeyUp="return ValNumero(this)"/></td>
      </tr>
      <tr id="tr1">
      ...
      <tr>
        <td id="dato1"><input type="text" name="calibre_ref" value="<?php echo $row_referencia_editar['calibre_ref']; ?>" size="10" onKeyUp="return ValNumero(this)"onBlur="calcular_pesom()"/></td>
        <td id="dato1"><input type="text" name="peso_millar_ref" value="<?php echo $row_referencia_editar['peso_millar_ref']; ?>" size="10" onKeyUp="return ValNumero(this)" readonly="readonly"/></td>
        <td id="dato1"><input name="N_fuelle" type="text" id="B_fuelle" value="<?php echo $row_referencia_editar['N_fuelle']?>" size="10" onKeyUp="return ValNumero(this)"/></td>
...
<td nowrap="nowrap" id="detalle1"><input <?php if (!(strcmp($row_ver_egp['arte_sum_egp'],1))) {echo "checked=\"checked\"";} ?> name="arte_sum_egp" type="checkbox" value="1" />
      ...
      <tr id="tr1">
        <td colspan="2" id="fuente1">Ultima Modificaci&oacute;n : 
          ...
          <input name="tipo_usuario" type="hidden" id="tipo_usuario" value="<?php echo $row_usuario['tipo_usuario']; ?>" /></td>
        <td id="dato2"><input name="submit" type="submit" value="AGREGAR NUEVO CLIENTE A LA REFERENCIA" /></td>
      </tr>
    </table>
