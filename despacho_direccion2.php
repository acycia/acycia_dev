...
$row_op = $conexion->llenaSelect('Tbl_orden_produccion'," ","ORDER BY id_op DESC");  
...
mysql_select_db($database_conexion1, $conexion1);
$query_caja_num = sprintf("SELECT DISTINCT int_caja_tn,int_op_tn FROM Tbl_tiquete_numeracion WHERE int_op_tn=%s ORDER BY int_caja_tn  DESC",$colname_caja_rm);
...
if($id_op== '')
{
$query_numeracion = "SELECT int_op_tn,id_tn,fecha_ingreso_tn,int_caja_tn,int_paquete_tn,int_undxpaq_tn,int_undxcaja_tn,int_desde_tn,int_hasta_tn FROM Tbl_tiquete_numeracion ORDER BY int_op_tn, int_caja_tn, int_paquete_tn  DESC";
}
//Filtra id_op lleno
if($id_op != '')
{
$query_numeracion = "SELECT int_op_tn,id_tn,fecha_ingreso_tn,int_caja_tn,int_paquete_tn,int_undxpaq_tn,int_undxcaja_tn,int_desde_tn,int_hasta_tn,ref_tn,imprime FROM Tbl_tiquete_numeracion WHERE int_op_tn='$id_op' AND id_despacho IS NULL ORDER BY int_op_tn, int_caja_tn, int_paquete_tn  DESC";
}
...
<table class="table">
<tr>
<td colspan="5" id="titulo2">CREACION DE DESPACHO</td>
</tr>
<tr>
...
--> <td nowrap="nowrap"id="titulo4">N&deg; O.P </td>
  ...
  <!-- si lleva faltantes se ve rojo -->
   ...
   <?php endif; ?>  
      ...
      <td id="dato2"><a href="despacho_direccion2.php?id_op=<?php echo $row_numeracion['int_op_tn'];?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_numeracion['int_desde_tn']; ?><?php echo $row_info_op['charfin'];?></a></td>
      <td id="dato2"><a href="despacho_direccion2.php?id_op=<?php echo $row_numeracion['int_op_tn'];?>" target="_top" style="text-decoration:none; color:#000000"><?php echo $row_numeracion['int_hasta_tn']; ?><?php echo $row_info_op['charfin'];?></a></td>
