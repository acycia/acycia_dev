...
mysql_select_db($database_conexion1, $conexion1);
//TODOS VACIOS
if($fecha1=='' && $fecha2=='' && $op=='0' && $ref=='0' && $cliente=='0')
{
$query_costos = "SELECT * FROM Tbl_orden_produccion WHERE b_estado_op > 0 ORDER BY id_op DESC";
}
//POR FECHAS
if($fecha1!='' && $fecha2!='' && $op=='0' && $ref=='0' && $cliente=='0')
{
$query_costos = "SELECT * FROM Tbl_orden_produccion WHERE b_estado_op > 0 AND fecha_registro_op BETWEEN '$fecha1' AND '$fecha2' ORDER BY id_op DESC";
}
//POR OP
if($fecha1=='' && $fecha2=='' && $op!='0' && $ref=='0' && $cliente=='0')
{
$query_costos = "SELECT * FROM Tbl_orden_produccion WHERE b_estado_op > 0 AND id_op='$op'  ORDER BY id_op DESC";
}
//POR REF
if($fecha1=='' && $fecha2=='' && $op=='0' && $ref!='0' && $cliente=='0')
{
$query_costos = "SELECT * FROM Tbl_orden_produccion WHERE b_estado_op > 0 AND int_cod_ref_op='$ref' ORDER BY id_op DESC";
}
//POR CLIENTE
if($fecha1=='' && $fecha2=='' && $op=='0' && $ref=='0' && $cliente!='0')
{
$query_costos = "SELECT * FROM Tbl_orden_produccion WHERE b_estado_op > 0 AND str_nit_op='$cliente' ORDER BY id_op DESC";
}
//POR FECHAS Y O.P
if($fecha1!='' && $fecha2!='' && $op!='0' && $ref=='0' && $cliente=='0')
{
$query_costos = "SELECT * FROM Tbl_orden_produccion WHERE b_estado_op > 0 AND id_op='$op' AND fecha_registro_op BETWEEN '$fecha1' AND '$fecha2' ORDER BY id_op DESC";
}
//POR FECHAS Y REF
if($fecha1!='' && $fecha2!='' && $op=='0' && $ref!='0' && $cliente=='0')
{
$query_costos = "SELECT * FROM Tbl_orden_produccion WHERE b_estado_op > 0 AND int_cod_ref_op='$ref' AND fecha_registro_op BETWEEN '$fecha1' AND '$fecha2' ORDER BY id_op DESC";
}
//POR FECHAS Y NIT
if($fecha1!='' && $fecha2!='' && $op=='0' && $ref=='0' && $cliente!='0')
{
$query_costos = "SELECT * FROM Tbl_orden_produccion WHERE b_estado_op > 0  AND str_nit_op='$cliente' AND fecha_registro_op BETWEEN '$fecha1' AND '$fecha2' ORDER BY id_op DESC";
}
                      ...
                      <tr>
                        <td colspan="10" nowrap id="fuente2">FECHA INICIO:
                          ...
                          <select name="op" id="op">
                            <option value="0"<?php if (!(strcmp(0, $_GET['op']))) {echo "selected=\"selected\"";} ?>>OP</option>
                            <?php
do {  
?>
                            <option value="<?php echo $row_orden_produccion['id_op']?>"<?php if (!(strcmp($row_orden_produccion['id_op'], $_GET['op']))) {echo "selected=\"selected\"";} ?>><?php echo $row_orden_produccion['id_op']?></option>
                            <?php
...
?>
                          ...
                          <select name="ref" id="ref">
                            <option value="0"<?php if (!(strcmp(0, $_GET['ref']))) {echo "selected=\"selected\"";} ?>>REF</option>
                            <?php
do {  
?>
...
?>
                          ...
                          <option value="0" <?php if (!(strcmp(0, $_GET['proceso']))) {echo "selected=\"selected\"";} ?>>TODOS</option>
  <?php
                    do {  
                    ?>
  ...
  <?php
	  ...
	  { $rollo=mysql_result($resultrollo,0,'rollos');
		...
		echo $rollo; }?></a></td>
                        <td id="dato1"><a href="costos_op_add.php?id_op=<?php echo $row_costos['id_op']; ?>&amp;fechafin=<?php echo $fecha2; ?>" target="new" style="text-decoration:none; color:#000000"><?php echo redondear_entero_puntos($metros);?></a><a href="costos_op_add.php?id_op=<?php echo $row_costos['id_op']; ?>&amp;fechafin=<?php echo $fecha2; ?>" target="new" style="text-decoration:none; color:#000000"></a></td>
                        <td id="dato1"><a href="costos_op_add.php?id_op=<?php echo $row_costos['id_op']; ?>&amp;fechafin=<?php echo $fecha2; ?>" target="new" style="text-decoration:none; color:#000000"><?php echo numeros_format($kilos);?></a><a href="costos_op_add.php?id_op=<?php echo $row_costos['id_op']; ?>&amp;fechafin=<?php echo $fecha2; ?>" target="new" style="text-decoration:none; color:#000000"></a></td>
                        <td id="dato1"><a href="costos_op_add.php?id_op=<?php echo $row_costos['id_op']; ?>&amp;fechafin=<?php echo $fecha2; ?>" target="new" style="text-decoration:none; color:#000000">
                          <?php 
	  $id_op=$row_costos['id_op'];
	  ...
	  ?>
                        </a><a href="costos_op_add.php?id_op=<?php echo $row_costos['id_op']; ?>&amp;fechafin=<?php echo $fecha2; ?>" target="new" style="text-decoration:none; color:#000000"></a></td>
                        <td id="dato1"><a href="costos_op_add.php?id_op=<?php echo $row_costos['id_op']; ?>&amp;fechafin=<?php echo $fecha2; ?>" target="new" style="text-decoration:none; color:#000000">
                          <?php 
	  $id_op=$row_costos['id_op'];
	  ...
	  ?>
                        ...
                        <td id="dato1" nowrap><?php echo $row_costos['fecha_registro_op']; ?></td>
