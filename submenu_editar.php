...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE submenu SET id_menu_submenu=%s, nombre_submenu=%s, url=%s, ver_url=%s  WHERE id_submenu=%s",
  ...
  $updateGoTo = "menu_nuevo2.php?id_menu=" . $row_ver_submenu['id_menu_submenu'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div align="center">
      <table id="tabla2">          
          ...
          <tr>
            <td colspan="2" id="fuente1">* Nombre del Submenu N&deg; 
              <input name="id_submenu" type="text" id="id_submenu" value="<?php echo $row_ver_submenu['id_submenu']; ?>" size="2" /></td>
          </tr>
          <tr>
            <td colspan="2" id="dato1"><input type="text" name="nombre_submenu" value="<?php echo $row_ver_submenu['nombre_submenu']; ?>" size="50" /></td>
          </tr>
          <tr>
            <td colspan="2" id="fuente1">* Direcci&oacute;n, URL, Pagina del Submenu </td>
          </tr>
          <tr>
            <td colspan="2" id="dato1"><input type="text" name="url" value="<?php echo $row_ver_submenu['url']; ?>" size="50" /></td>
          </tr>
          <tr>
            <td colspan="2" id="fuente1">Menu <strong><?php echo $row_menu['nombre_menu']; ?></strong> N&deg; 
                <input name="id_menu_submenu" type="text" value="<?php echo $row_ver_submenu['id_menu_submenu']; ?>" size="5" />
                Habilitar Submenu? si:
                <input <?php if (!(strcmp($row_ver_submenu['ver_url'],1))) {echo "checked=\"checked\"";} ?> name="habilitar" type="checkbox" id="habilitar" value="1" /></td>
          </tr>
		  <tr>
