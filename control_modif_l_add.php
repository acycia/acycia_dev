...
$sql2="UPDATE Tbl_verificacion_lamina SET version_ref_verif_l='$version_ref_verif_l' WHERE id_verif_l='$id_verif'"; 

$insertSQL = sprintf("INSERT INTO Tbl_control_modificaciones_l (id_cm, id_verif_cm, id_ref_cm, fecha_cm, responsable_cm, descripcion_cm) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "verificacion_referencia_lamina.php?id_ref=" . $_POST['id_ref_cm'] . "&id_verif_l=" . $_POST['id_verif_cm'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion1, $conexion1);
$query_modificacion_add = "SELECT * FROM Tbl_control_modificaciones_l ORDER BY id_cm DESC";
...
if (isset($_GET['id_verif_l'])) {
  $colname_verif_modif = (get_magic_quotes_gpc()) ? $_GET['id_verif_l'] : addslashes($_GET['id_verif_l']);
}
mysql_select_db($database_conexion1, $conexion1);
$query_verif_modif = sprintf("SELECT * FROM Tbl_verificacion_lamina, Tbl_referencia WHERE Tbl_verificacion_lamina.id_verif_l = %s AND Tbl_verificacion_lamina.id_ref_verif_l=Tbl_referencia.id_ref", $colname_verif_modif);
  ...
  <tr>
    ...
    <table id="tabla2">
      ...
      <tr>
        ...
        <td colspan="2" id="dato2"><a href="control_modificaciones_l.php"><img src="images/m.gif" alt="CONTROL MODIFICACIONES" title="CONTROL MODIFICACIONES" border="0" style="cursor:hand;" /></a><a href="verificacion_referencia.php?id_ref=<?php echo $row_verif_modif['id_ref_verif_l']; ?>"><img src="images/v.gif" alt="VERIFICACION X REF" title="VERIFICACION X REF"border="0" style="cursor:hand;" /></a><a href="verificacion_l.php"><img src="images/identico.gif" alt="LISTADO DE VERIFICACIONES" title="VERIFICACIONES" border="0" style="cursor:hand;" /></a></td>
      </tr>
      <tr id="tr1">
        <td id="fuente2"><input name="id_verif_cm" type="hidden" value="<?php echo $_GET['id_verif_l']; ?>">
          VERIFICACION</td>
        <td colspan="2" id="fuente2">FECHA REGISTRO </td>
      </tr>
      <tr>
        <td id="dato2"><a href="verificacion_lamina_edit.php?id_verif_l=<?php echo $row_verif_modif['id_verif_l']; ?>"><?php echo $row_verif_modif['id_verif_l']; ?></a></td>
      ...
      <tr>
        <td id="dato2"><input name="id_ref_cm" type="hidden" value="<?php echo $row_verif_modif['id_ref_verif_l']; ?>">
      ...
      <tr>
        <td id="numero2"><strong>VERSION C.M.</strong><input name="version_ref_verif_l" type="text" id="version_ref_verif_l" value="<?php echo $row_verif_modif['version_ref_verif_l']; ?>" size="2"></td>
        ...
        <td id="numero1">Recuerde, la version es autoincrementable</td>
      </tr>
      <tr id="tr1">
