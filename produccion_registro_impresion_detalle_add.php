...
mysql_select_db($database_conexion1, $conexion1);
$query_tiempo_muertos = "SELECT * FROM Tbl_reg_tipo_desperdicio WHERE Tbl_reg_tipo_desperdicio.id_proceso_rtd='2' AND Tbl_reg_tipo_desperdicio.codigo_rtp='1'";
...
mysql_select_db($database_conexion1, $conexion1);
$query_tiempo_preparacion = "SELECT * FROM Tbl_reg_tipo_desperdicio WHERE Tbl_reg_tipo_desperdicio.id_proceso_rtd='2' AND Tbl_reg_tipo_desperdicio.codigo_rtp='2'";
...
mysql_select_db($database_conexion1, $conexion1);
$query_desperdicios = "SELECT * FROM Tbl_reg_tipo_desperdicio WHERE Tbl_reg_tipo_desperdicio.id_proceso_rtd='2' AND Tbl_reg_tipo_desperdicio.codigo_rtp='3'";
...
<li><a href="compras.php">GESTION COMPRAS</a></li>
  ...
  <tr>
    <td colspan="2" align="center" id="linea1">
      <form action="<?php echo $editFormAction; ?>" method="post" name="form2"  onsubmit="return checkSubmit();">
        <table id="tabla2">
          <tr>
            <td colspan="3"  nowrap="nowrap" id="subtitulo">AGREGAR TIEMPOS Y DESPERDICIOS</td>
            </tr>
          <tr>
            <td id="dato1">&nbsp;</td>
            <td nowrap="nowrap" id="dato1">Rollo n° 
              <input name="rollo_rp" id="rollo_rp" type="number" style="width:60px" required="required"  value="<?php echo $_GET['rollo']; ?>" readonly="readonly"/></td>
            <td nowrap="nowrap" id="dato3">Fecha y Hora:
              <input name="fecha_ini_rp" type="datetime" min="2000-01-02" size="19" required="required" value="<?php echo $_GET['fecha']; ?>" readonly="readonly"/>
            </td>
            </tr>
          <tr>
            <td id="dato1">&nbsp;</td>
          ...
          <tr id="tr1">
            ...
            <td nowrap="nowrap" id="dato1">Tiempos Preparacion</td>
            <td nowrap="nowrap" id="dato1">Desperdicios del Rollo</td>
          </tr>
          <tr id="tr1">
            <td id="dato1"><input type="button" name="button" id="button" value="Crear otra fila" onclick="tiemposM()" style="width:193px"/></td>
            <td nowrap="nowrap" id="dato1"><input type="button" name="button2" id="button2" value="Crear otra fila" onclick="tiemposP()" style="width:193px"/></td>
            <td nowrap="nowrap" id="dato1"><input type="button" name="button3" id="button3" value="Crear otra fila" onclick="tiemposD()" style="width:193px"/></td>
          </tr>
          <tr>
            <td nowrap="nowrap" id="dato1"><div id="moreUploads" ></div></td>
            <td nowrap="nowrap" id="dato1"><div id="moreUploads2"></div></td>
            <td nowrap="nowrap" id="dato1"><div id="moreUploads3"></div></td>
          </tr>
          <tr>
            <td id="dato1">&nbsp;</td>
            <td nowrap="nowrap" id="dato1">&nbsp;</td>
          ...
          <tr>
            <td id="dato2">&nbsp;</td>
            <td id="dato1"><input type="submit" value="ADD A IMPRESION" style="width:193px"/></td>
            <td id="dato2">&nbsp;</td>
            </tr>
        </table>
        <input name="id_op_rp" type="hidden" id="id_op_rp" value="<?php echo $id_op; ?>" />
        <input name="id_proceso" type="hidden" id="id_proceso" value="2" />
