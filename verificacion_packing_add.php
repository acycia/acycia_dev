...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO Tbl_verificacion_packing (id_verif_p,id_ref_verif_p,version_ref_verif_p,fecha_verif_p,responsable_verif_p,ancho_verif_p,
observ_ancho_verif_p,largo_verif_p,
observ_largo_verif_p,calibre_verif_p,observ_calibre_verif_p,b_presentacion_verif_p,observ_presentacion_verif_p,revi_ortog_verif_p,observ_revi_ortog_verif_p,rev_textos_verif_p,observ_rev_textos_verif_p,color_material_verif_p,observ_color_material_verif_p,color_ext_verif_p,observ_color_ext_verif_p,color_int_verif_p,observ_int_verif_p,
b_boca_entr_verif_p,observ_boca_entr_verif_p,b_entrada_verif_p,observ_entrada_verif_p,b_lamina1_verif_p,observ_lamina1_verif_p,b_lamina2_verif_p,observ_lamina2_verif_p,b_rodillo_verif_p,observ_rodillo_verif_p,b_repeticion_verif_p,observ_repeticion_verif_p,b_numerop_p, observ_numerop_p,1color_verif_p,observ_1color_verif_p,2color_verif_p,observ_2color_verif_p,3color_verif_p,observ_3color_verif_p,4color_verif_p,observ_4color_verif_p,5color_verif_p,observ_5color_verif_p,6color_verif_p,observ_6color_verif_p,7color_verif_p,observ_7color_verif_p,8color_verif_p,observ_8color_verif_p,marca_foto_verif_p,observ_marca_foto_verif_p,ref_verif_p,observ_ref_verif_p,num_paginaw_verif_p,observ_num_paginaw_verif_p,str_obs_general_p,userfile_p,estado_arte_verif_p,fecha_aprob_arte_verif_p,fecha_edit_verif_p,responsable_edit_verif_p) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
//ADICIONADA LA UPDATE POR SI SE LES OLVIDA ACTUALIZAR LA VERSION MANUALMENTE
  ...
  $Result2 = mysql_query($sql1, $conexion1) or die(mysql_error());
   ...
   $Codigo_nuevo=$_POST['cod_ref'].'-'.$version_ref_verif_p;
  ...
  $insertGoTo = "adjuntar_packing1.php?id_verif_p=" . $_POST['id_verif_p'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion1, $conexion1);
$query_ultimo = "SELECT * FROM Tbl_verificacion_packing ORDER BY id_verif_p DESC";
...
mysql_select_db($database_conexion1, $conexion1);
$query_verificacion = sprintf("SELECT * FROM Tbl_verificacion_packing WHERE  id_ref_verif_p = '%s' ORDER BY version_ref_verif_p DESC", $colname_verificacion);
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>" enctype="multipart/form-data">
      <table id="tabla2">
        ...
        <tr>
          <td id="dato2"><input name="fecha_verif_p" type="text" value="<?php echo date("Y-m-d"); ?>" size="10" /></td>
          <td colspan="2" id="dato2"><input name="responsable_verif_p" type="text" value="<?php echo $row_usuario['nombre_usuario']; ?>" size="30" readonly /></td>
          </tr>
        <tr id="tr1">
        ...
        <tr>
          <td id="dato2"><input name="id_ref_verif_p" type="hidden" value="<?php echo $row_referencia_revision['id_ref']; ?>" /><strong>
            <input name="cod_ref" type="hidden" id="cod_ref" value="<?php echo $row_referencia_revision['cod_ref']; ?>">
            <input name="version_ref" type="hidden" id="version_ref" value="<?php if($row_verificacion['version_ref_verif_p']!=''){echo $row_verificacion['version_ref_verif_p'];}else{echo '00';} ?>" size="2" readonly>
<?php echo $row_referencia_revision['cod_ref']; ?> - <?php echo $row_referencia_revision['version_ref']; ?></strong></td>
          <td id="dato2">- - </td>
          <td id="dato2"><strong>
            <input name="version_ref_verif_p" type="text" value="<?php echo $row_referencia_revision['version_ref']; ?>" size="2" />
          </strong></td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="4" align="center"><table id="tabla1">
            ...
            <tr>
              ...
              <td id="detalle1"><input type="checkbox" name="ancho_verif_p" value="1" />
                Ancho</td>
              <td id="detalle2"><input type="text" name="observ_ancho_verif_p" value="<?php if($row_verificacion['observ_ancho_verif_p']!=''){echo "Verificacion dice: ";echo $row_verificacion['observ_ancho_verif_p'];} ?>" size="50" /></td>
            </tr>
            <tr>
              <td id="detalle1">Largo: <?php echo $row_referencia_revision['largo_ref']; ?></td>
              <td id="detalle1"><input type="checkbox" name="largo_verif_p" value="1">
                Largo</td>
              <td id="detalle2"><input type="text" name="observ_largo_verif_p" value="<?php if($row_verificacion['observ_largo_verif_p']!=''){echo "Verificacion dice: ";echo $row_verificacion['observ_largo_verif_p'];} ?>" size="50" /></td>
            </tr>
            <tr>
              <td id="detalle1">Calibre: <?php echo $row_referencia_revision['calibre_ref']; ?></td>
              <td id="detalle1"><input type="checkbox" name="calibre_verif_p" value="1">
                Calibre</td>
              <td id="detalle2"><input type="text" name="observ_calibre_verif_p" value="<?php if($row_verificacion['observ_calibre_verif_p']!=''){echo "Verificacion dice: ";echo $row_verificacion['observ_calibre_verif_p'];} ?>" size="50" /></td>
            </tr>            
            <tr>
              <td id="detalle1">Presentacion: <?php echo $row_referencia_revision['Str_presentacion']; ?></td>
              <td id="detalle1"><input type="checkbox" name="b_presentacion_verif_p" value="1">
                Presentacion</td>
              <td id="detalle2"><input type="text" name="observ_presentacion_verif_p" value="<?php if($row_verificacion['observ_presentacion_verif_p']!=''){echo "Verificacion dice: ";echo $row_verificacion['observ_presentacion_verif_p'];} ?>" size="50" /></td>
            </tr>
            <tr>
              <td id="detalle1">Revisi&oacute;n Ortografica</td>
              <td id="detalle1"><input type="checkbox" name="revi_ortog_verif_p" value="1">
Revisi&oacute;n Ortografica</td>
              <td id="detalle2"><input type="text" name="observ_revi_ortog_verif_p" value="<?php if($row_verificacion['observ_revi_ortog_verif_p']!=''){echo "Verificacion dice: ";echo $row_verificacion['observ_revi_ortog_verif_p'];} ?>" size="50" /></td>
            </tr>
            <tr>
              <td id="detalle1">Revisi&oacute;n Textos</td>
              <td id="detalle1"><input type="checkbox" name="rev_textos_verif_p" value="1">
Revisi&oacute;n Textos</td>
              <td id="detalle2"><input type="text" name="observ_rev_textos_verif_p" value="<?php if($row_verificacion['observ_rev_textos_verif_p']!=''){echo "Verificacion dice: ";echo $row_verificacion['observ_rev_textos_verif_p'];} ?>" size="50" /></td>
            </tr>
<tr>
              <td id="detalle1">Pigmento Exterior: <?php echo $row_referencia_revision['Str_lamina1_p']; ?></td>
              <td id="detalle1"><input type="checkbox" name="color_ext_verif_p" value="1">Color Extrusi&oacute;n Exterior </td>
              <td id="detalle2"><input type="text" name="observ_color_ext_verif_p" value="<?php if($row_verificacion['observ_color_ext_verif_p']!=''){echo "Verificacion dice: ";echo $row_verificacion['observ_color_ext_verif_p'];} ?>" size="50" /></td>
            </tr>
            <tr>
              <td id="detalle1">Pigmento Interior: <?php echo $row_referencia_revision['Str_lamina2_p']; ?></td>
              <td id="detalle1"><input type="checkbox" name="color_int_verif_p" value="1">Color Extrusi&oacute;n Interior</td>
              <td id="detalle2"><input type="text" name="observ_int_verif_p" value="<?php if($row_verificacion['observ_int_verif_p']!=''){echo "Verificacion dice: ";echo $row_verificacion['observ_int_verif_p'];} ?>" size="50" /></td>
            </tr>            
            <tr>
              <td id="detalle1">Color Material Adhesivos</td>
              <td id="detalle1"><input name="color_material_verif_p" type="checkbox" id="color_material_verif_p" value="1">
                Color Material Adhesivos</td>
              <td id="detalle2"><input type="text" name="observ_color_material_verif_p" value="<?php if($row_verificacion['observ_color_material_verif_p']!=''){echo "Verificacion dice: ";echo $row_verificacion['observ_color_material_verif_p'];} ?>" size="50" /></td>
            </tr>
            <tr>
              <td id="detalle1">Boca de Entrada: <?php echo $row_referencia_revision['Str_boca_entr_p']; ?></td>
              <td id="detalle1"><input type="checkbox" name="b_boca_entr_verif_p" value="1">
                Boca de Entrada</td>
              <td id="detalle2"><input type="text" name="observ_boca_entr_verif_p" value="<?php if($row_verificacion['observ_boca_entr_verif_p']!=''){echo "Verificacion dice: ";echo $row_verificacion['observ_boca_entr_verif_p'];} ?>" size="50" /></td>
            </tr>
            <tr>
              <td id="detalle1">Ubicacion de la Entrada: <?php echo $row_referencia_revision['Str_entrada_p']; ?></td>
              <td id="detalle1"><input type="checkbox" name="b_entrada_verif_p" value="1">
                Ubicacion de la Entrada</td>
              <td id="detalle2"><input type="text" name="observ_entrada_verif_p" value="<?php if($row_verificacion['observ_entrada_verif_p']!=''){echo "Verificacion dice: ";echo $row_verificacion['observ_entrada_verif_p'];} ?>" size="50" /></td>
            </tr>
            <tr>
              <td id="detalle1">Lamina 1: <?php echo $row_referencia['Str_lamina1_p']; ?></td>
              <td id="detalle1"><input type="checkbox" name="b_lamina1_verif_p" value="1">
                Color Extrusi&oacute;n Interior</td>
              <td id="detalle2"><input type="text" name="observ_lamina1_verif_p" value="<?php if($row_verificacion['observ_lamina1_verif_p']!=''){echo "Verificacion dice: ";echo $row_verificacion['observ_lamina1_verif_p'];} ?>" size="50" /></td>
            </tr>
            <tr>
              <td id="detalle1">Lamina 2: <?php echo $row_referencia['Str_lamina2_p']; ?></td>
              <td id="detalle1"><input type="checkbox" name="b_lamina2_verif_p" value="1">
Color Extrusi&oacute;n Interior</td>
              <td id="detalle2"><input type="text" name="observ_lamina2_verif_p" value="<?php if($row_verificacion['observ_lamina2_verif_p']!=''){echo "Verificacion dice: ";echo $row_verificacion['observ_lamina2_verif_p'];} ?>" size="50" /></td>
            </tr>
            <tr>
              <td id="detalle1">Rodillo: <?php echo $row_referencia_revision['int_rodillo_p']; ?></td>
              <td id="detalle1"><input type="checkbox" name="b_rodillo_verif_p" value="1">
                Rodillo</td>
              <td id="detalle2"><input type="text" name="observ_rodillo_verif_p" value="<?php if($row_verificacion['observ_rodillo_verif_p']!=''){echo "Verificacion dice: ";echo $row_verificacion['observ_rodillo_verif_p'];} ?>" size="50" /></td>
            </tr>
            <tr>
              <td id="detalle1">Repeticion: <?php echo $row_referencia_revision['int_repeticion_p']; ?></td>
              <td id="detalle1"><input type="checkbox" name="b_repeticion_verif_p" value="1">
                Repeticion</td>
              <td id="detalle2"><input type="text" name="observ_repeticion_verif_p" value="<?php if($row_referencia_revision['observ_repeticion_verif_p']!=''){echo "Verificacion dice: ";echo $row_referencia_revision['observ_repeticion_verif_p'];} ?>" size="50" /></td>
            </tr>
            <tr>
              <td id="detalle1">Numero de Pistas: <?php echo $row_referencia_revision['int_numerop_p']; ?></td>
              <td id="detalle1"><input type="checkbox" name="b_numerop_p" value="1">
                Numero de Pistas</td>
              <td id="detalle2"><input type="text" name="observ_numerop_p" value="<?php if($row_referencia_revision['observ_numerop_p']!=''){echo "Verificacion dice: ";echo $row_referencia_revision['observ_numerop_p'];} ?>" size="50" /></td>
            </tr>
            </table></td>
          </tr>
        <tr id="tr1">
        ...
        <tr>
          <td colspan="4" align="center"><table id="tabla1">
            ...
            <tr>
              ...
              <td id="detalle2"><input name="1color_verif_p" type="checkbox" id="1color_verif_p" value="1" /></td>
              <td id="detalle2"><input type="text" name="observ_1color_verif_p" value="" size="60" /></td>
            </tr>
            <tr>
              <td id="detalle1"><strong>2 </strong>: <?php echo $row_ref_egp['color2_egp']; ?></td>
              <td id="detalle1">- <?php echo $row_ref_egp['pantone2_egp']; ?></td>
              <td id="detalle2"><input name="2color_verif_p" type="checkbox" id="2color_verif_p" value="1" /></td>
              <td id="detalle2"><input type="text" name="observ_2color_verif_p" value="" size="60" /></td>
            </tr>
            <tr>
              <td id="detalle1"><strong>3 </strong>: <?php echo $row_ref_egp['color3_egp']; ?></td>
              <td id="detalle1">- <?php echo $row_ref_egp['pantone3_egp']; ?></td>
              <td id="detalle2"><input name="3color_verif_p" type="checkbox" id="3color_verif_p" value="1"></td>
              <td id="detalle2"><input type="text" name="observ_3color_verif_p" value="" size="60" /></td>
            </tr>
            <tr>
              <td id="detalle1"><strong>4 </strong>: <?php echo $row_ref_egp['color4_egp']; ?></td>
              <td id="detalle1">- <?php echo $row_ref_egp['pantone4_egp']; ?></td>
              <td id="detalle2"><input name="4color_verif_p" type="checkbox" id="4color_verif_p" value="1"></td>
              <td id="detalle2"><input type="text" name="observ_4color_verif_p" value="" size="60" /></td>
            </tr>
            <tr>
              <td id="detalle1"><strong>5 </strong>: <?php echo $row_ref_egp['color5_egp']; ?></td>
              <td id="detalle1">- <?php echo $row_ref_egp['pantone5_egp']; ?></td>
              <td id="detalle2"><input name="5color_verif_p" type="checkbox" id="5color_verif_p" value="1"></td>
              <td id="detalle2"><input type="text" name="observ_5color_verif_p" value="" size="60" /></td>
            </tr>
            <tr>
              <td id="detalle1"><strong>6 </strong>: <?php echo $row_ref_egp['color6_egp']; ?></td>
              <td id="detalle1">- <?php echo $row_ref_egp['pantone6_egp']; ?></td>
              <td id="detalle2"><input name="6color_verif_p" type="checkbox" id="6color_verif_p" value="1"></td>
              <td id="detalle2"><input type="text" name="observ_6color_verif_p" value="" size="60" /></td>
            </tr>
            <tr>
              <td id="detalle1"><strong>7 </strong>: <?php echo $row_ref_egp['color7_egp']; ?></td>
              <td id="detalle1">- <?php echo $row_ref_egp['pantone7_egp']; ?></td>
              <td id="detalle2"><input name="7color_verif_p" type="checkbox" id="7color_verif_p" value="1"></td>
              <td id="detalle2"><input type="text" name="observ_7color_verif_p" value="" size="60" /></td>
            </tr>
            <tr>
              <td id="detalle1"><strong>8 </strong>: <?php echo $row_ref_egp['color8_egp']; ?></td>
              <td id="detalle1">- <?php echo $row_ref_egp['pantone8_egp']; ?></td>
              <td id="detalle2"><input name="8color_verif_p" type="checkbox" id="8color_verif_p" value="1"></td>
              <td id="detalle2"><input type="text" name="observ_8color_verif_p" value="" size="60" /></td>
            </tr>
                                    
            <tr>
              <td colspan="2" id="detalle1">MARCA DE FOTOCELDA</td>
              <td id="detalle2"><input type="checkbox" name="marca_foto_verif_p" value="1"></td>
              <td id="detalle2"><input type="text" name="observ_marca_foto_verif_p" value="" size="60" /></td>
            </tr>
            <tr>
              <td colspan="2" id="detalle1">REFERENCIA </td>
              <td id="detalle2"><input type="checkbox" name="ref_verif_p" value="1"></td>
              <td id="detalle2"><input type="text" name="observ_ref_verif_p" value="" size="60" /></td>
            </tr>
              <tr>
              <td colspan="2"id="detalle1">PAGINA WEB</td>
              <td id="detalle2"><input type="checkbox" name="num_paginaw_verif_p" value="1"></td>
              <td id="detalle2"><input type="text" name="observ_num_paginaw_verif_p" value="" size="60" /></td>
            </tr>                       
          </table></td>
        </tr>
        ...
        <tr>
          <td colspan="4" id="dato2"><textarea name="str_obs_general_p" cols="80" rows="2"><?php if($row_referencia_revision['str_obs_general_p']!=''){echo "Revision dice: "; echo $row_referencia_revision['str_obs_general_p'];} ?><?php echo "Obs ref: ". $row_ref_egp['observacion5_egp']; ?></textarea>
            <input name="userfile_p" type="hidden" value="" />
            <input name="estado_arte_verif_p" type="hidden" id="estado_arte_verif_p" value="0" />
            <input name="fecha_aprob_arte_verif_p" type="hidden" value="0000-00-00" /> 
            <input name="fecha_edit_verif_p" type="hidden" value="" />
            <input name="responsable_edit_verif_p" type="hidden" value="" /></td>
        </tr>
