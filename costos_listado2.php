...
if($op!=0 && $id_ref==0)
{
$query_costos = "SELECT * FROM Tbl_reg_produccion,Tbl_orden_produccion WHERE Tbl_reg_produccion.id_op_rp=Tbl_orden_produccion.id_op AND Tbl_orden_produccion.b_estado_op > '0' AND Tbl_orden_produccion.b_borrado_op='0' AND Tbl_reg_produccion.id_op_rp=$op  
GROUP BY Tbl_reg_produccion.id_op_rp DESC";	
}
//REF LLENO
if($op==0 && $id_ref!=0)
{
$query_costos = "SELECT * FROM Tbl_reg_produccion,Tbl_orden_produccion WHERE Tbl_reg_produccion.id_op_rp=Tbl_orden_produccion.id_op AND Tbl_orden_produccion.b_estado_op > '0' AND Tbl_orden_produccion.b_borrado_op='0' AND Tbl_reg_produccion.int_cod_ref_rp=$id_ref   
GROUP BY Tbl_reg_produccion.id_op_rp DESC";	
}
//TODOS LLENO
if($op!=0 && $id_ref!=0)
{
$query_costos = "SELECT * FROM Tbl_reg_produccion,Tbl_orden_produccion WHERE Tbl_reg_produccion.id_op_rp=Tbl_orden_produccion.id_op AND Tbl_orden_produccion.b_estado_op > '0' AND Tbl_orden_produccion.b_borrado_op='0' AND Tbl_reg_produccion.id_op_rp=$op AND Tbl_reg_produccion.int_cod_ref_rp=$id_ref   
GROUP BY Tbl_reg_produccion.id_op_rp DESC";	
}
      ...
      <td><div> <b class="spiffy"> <b class="spiffy1"><b></b></b> <b class="spiffy2"><b></b></b> <b class="spiffy3"></b> <b class="spiffy4"></b> <b class="spiffy5"></b></b>
          <div class="spiffy_content">
            <table id="tabla1">
              ...
              <tr>
                <td colspan="2" align="center" id="linea1"><form action="costos_listado2.php" method="get" name="form1">
                    <table id="tabla1">
                      <tr>
                      ...
                      <tr>
                        <td colspan="5" id="fuente2"><select name="op" id="op" onchange="ListadoProduccion('costos_listado2.php',this.name,this.value)">
                            <option value="0"<?php if (!(strcmp('', $_GET['op']))) {echo "selected=\"selected\"";} ?>>O.P.</option>
                            <?php
do {  
?>
                            <option value="<?php echo $row_lista_op['id_op']?>"<?php if (!(strcmp($row_lista_op['id_op'], $_GET['op']))) {echo "selected=\"selected\"";} ?>><?php echo $row_lista_op['id_op']?></option>
                            <?php
...
?>
                          ...
                          <select name="id_ref" id="id_ref" onchange="ListadoProduccion('costos_listado2.php',this.name,this.value)">
                            <option value="0"<?php if (!(strcmp('', $_GET['id_ref']))) {echo "selected=\"selected\"";} ?>>REF</option>
                            <?php
do {  
?>
                            <option value="<?php echo $row_ref_op['cod_ref']?>"<?php if (!(strcmp($row_ref_op['cod_ref'], $_GET['id_ref']))) {echo "selected=\"selected\"";} ?>>
...
?>
                      ...
                      <tr>
                        <td colspan="5" id="dato3"><a href="costos_listado.php"><img src="images/ciclo1.gif" alt="RESTAURAR" title="RESTAURAR" border="0" style="cursor:hand;"/></a></td>
                      </tr>
                      <tr id="tr1">
