...
FECHA FIN:
<input name="fecha_fin" type="date" id="fecha_fin" required="required" min="2000-01-02" size="10" onChange="if(form1.fecha_ini.value && form1.fecha_fin.value) { consulta_ref_xproceso(); }else { alert('Debe seleccionar las dos fechas')}" value="<?php echo $_GET['fecha_fin']; ?>"/>
...
?>
</select><input type="submit" name="submit" id="submit" value="Consultar" /></td>
  </tr>
  <tr>
    <td id="dato3">&nbsp;</td>
    <td id="dato3">&nbsp;</td>
  ...
  <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
    <td id="dato2"><?php echo $row_costos['id_op_rp'] ?></td>
	  ...
	  switch ($proceso) {
	  case 1: $BD="SELECT COUNT(rollo_r) AS rollo FROM TblExtruderRollo WHERE id_op_r='$op'";
	  $procesoEx=1;$procesoIm=2;$procesoRe=3;$procesoSe=4;break;
	  case 2: $BD="SELECT COUNT(rollo_r) AS rollo FROM TblImpresionRollo WHERE id_op_r='$op'";
	  $procesoEx=1;$procesoIm=2;$procesoRe=3;$procesoSe=4;break;
	  case 3: $BD="SELECT COUNT(rollo_r) AS rollo FROM TblRefiladoRollo WHERE id_op_r='$op'";
	  $procesoEx=1;$procesoIm=2;$procesoRe=3;$procesoSe=4;break;
	  case 4: $BD="SELECT (rollo_r) AS rollo FROM TblSelladoRollo WHERE id_op_r='$op' GROUP BY `rollo_r`";
	  ...
	  $procesoEx=1;
	  $op=$row_costos['id_op_rp'];
	  $sqlex="SELECT SUM(valor_prod_rp) AS kge FROM Tbl_reg_kilo_producido WHERE op_rp='$op' AND id_proceso_rkp='$procesoEx'"; 
      ...
      <?php 
	  $op=$row_costos['id_op_rp'];
	  $sqlexd="SELECT SUM(valor_desp_rd) AS kgDespe FROM Tbl_reg_desperdicio WHERE op_rd='$op' AND id_proceso_rd='$procesoEx'"; 
	  ...
	  $procesoIm=2;
	  $op=$row_costos['id_op_rp'];
	  $sqlim="SELECT SUM(int_kilos_prod_rp) AS kgi FROM Tbl_reg_produccion WHERE id_op_rp='$op' AND id_proceso_rp='$procesoIm'"; 
      ...
      <td id="dato2"><?php 
	  $op=$row_costos['id_op_rp'];
	  $sqlimd="SELECT SUM(int_kilos_desp_rp) AS kgDespi FROM Tbl_reg_produccion WHERE id_op_rp='$op' AND id_proceso_rp='$procesoIm'";
	  ...
	  $procesoRe=3;
	  $op=$row_costos['id_op_rp'];
	  $sqlre="SELECT SUM(int_kilos_prod_rp) AS kgi FROM Tbl_reg_produccion WHERE id_op_rp='$op' AND id_proceso_rp='$procesoRe'"; 
      ...
      <td id="dato2"><?php 
	  $op=$row_costos['id_op_rp'];
	  $sqlred="SELECT SUM(int_kilos_desp_rp) AS kgDespi FROM Tbl_reg_produccion WHERE id_op_rp='$op' AND id_proceso_rp='$procesoRe'";
	  ...
	  $procesoSe=4;
	  $op=$row_costos['id_op_rp'];
	  $sqlse="SELECT SUM(int_kilos_prod_rp) AS kgs FROM Tbl_reg_produccion WHERE id_op_rp='$op' AND id_proceso_rp='$procesoSe'";  
      ...
      <?php 
	  $op=$row_costos['id_op_rp'];
	  $sqlexd="SELECT SUM(int_kilos_desp_rp) AS kgDesps FROM Tbl_reg_produccion WHERE id_op_rp='$op' AND id_proceso_rp='$procesoSe'";
	  $resultexd=mysql_query($sqlexd); 
	  $numexd=mysql_num_rows($resultexd); 
	  if($numexd >= '1') 
