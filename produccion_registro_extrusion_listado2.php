...
<body onload = "JavaScript: AutoRefresh (100000);">
      ...
      <tr>
        <!-- <td id="fuente3" colspan="2">
          ...
          <td id="fuente2" colspan="9">
            <input name="retorno_mensaje" type="hidden" ></div>
         ...
         <select class='busqueda selectsMini' name="mes" id="mes">
          ...
          do {  
            ?>
            <option value="<?php echo $row_mensual['id_mensual']?>"<?php if (!(strcmp($row_mensual['mes'], $_GET['mes']))) {echo "selected=\"selected\"";} ?>><?php  echo $row_mensual['mensual']?>
            </option>
            <?php
                  ...
                  <?php do { ?>
                    <tr onMouseOver="uno(this,'CBCBE4');" onMouseOut="dos(this,'#FFFFFF');" bgcolor="#FFFFFF">
                      ...
                      <td nowrap="nowrap" id="dato1"><a href="produccion_op_vista.php?id_op=<?php echo $row_prioridad['id_op'];?>" target="new"  style="text-decoration:none; color:#000000">
                        ...
                        if($numnp >= '1') 
                         { $nombre_cliente_cp=mysql_result($resultnp,0,'nombre_c'); echo $nombre_cliente_cp; }
                       else { echo ""; 
                     }?></a>
                   </td>
  ...
  <fieldset> <legend id="dato1">LISTADO ORDENES DE PRODUCCION</legend>
    <table class="table table-bordered table-sm">
      <tr>
        <td colspan="2" id="dato1">&nbsp;
        </td>
      ...
      <?php do { ?>
       ...
       <td id="dato2"><a href="produccion_op_vista.php?id_op=<?php echo $row_orden_produccion['id_op'];?>" target="new"  style="text-decoration:none; color:#000000"><?php if ($row_orden_produccion['b_borrado_op']=='0'){echo "ACTIVA";}else{echo "INACTIVA";} ?></a></td>      
       <td id="dato2">      <?php 
       $op_c=$row_orden_produccion['id_op'];
       $sqlno="SELECT COUNT(rollo_r) as Rollos, SUM(kilos_r) AS kilos FROM TblExtruderRollo WHERE id_op_r='$op_c'"; 
       $resultno = mysql_query($sqlno); 
